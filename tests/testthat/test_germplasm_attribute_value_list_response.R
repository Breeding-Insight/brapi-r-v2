...
context("Test GermplasmAttributeValueListResponse")

model.instance <- GermplasmAttributeValueListResponse$new()
...
test_that("result", {
  # tests for the property `result` (GermplasmAttributeValueListResponseResult)
