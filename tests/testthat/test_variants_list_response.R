...
context("Test VariantsListResponse")

model.instance <- VariantsListResponse$new()
...
test_that("metadata", {
  # tests for the property `metadata` (MetadataTokenPagination)
...
test_that("result", {
  # tests for the property `result` (VariantsListResponseResult)
