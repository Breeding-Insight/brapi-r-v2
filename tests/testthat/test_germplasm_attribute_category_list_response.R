...
context("Test GermplasmAttributeCategoryListResponse")

model.instance <- GermplasmAttributeCategoryListResponse$new()
...
test_that("result", {
  # tests for the property `result` (GermplasmAttributeCategoryListResponseResult)
