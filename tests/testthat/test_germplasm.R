...
context("Test Germplasm")

model.instance <- Germplasm$new()
...
test_that("biologicalStatusOfAccessionDescription", {
  # tests for the property `biologicalStatusOfAccessionDescription` (character)
  # Supplemental text description for &#39;biologicalStatusOfAccessionCode&#39;

  # uncomment below to test the property 
  #expect_equal(model.instance$`biologicalStatusOfAccessionDescription`, "EXPECTED_RESULT")
})
...
test_that("countryOfOriginCode", {
  # tests for the property `countryOfOriginCode` (character)
  ...
  # uncomment below to test the property 
  #expect_equal(model.instance$`countryOfOriginCode`, "EXPECTED_RESULT")
})

test_that("defaultDisplayName", {
  # tests for the property `defaultDisplayName` (character)
  # Human readable name used for display purposes

  # uncomment below to test the property 
  #expect_equal(model.instance$`defaultDisplayName`, "EXPECTED_RESULT")
})
...
test_that("donors", {
  # tests for the property `donors` (array[GermplasmNewRequestDonors])
...
test_that("germplasmOrigin", {
  # tests for the property `germplasmOrigin` (array[GermplasmOrigin])
  ...
  # uncomment below to test the property 
  #expect_equal(model.instance$`germplasmOrigin`, "EXPECTED_RESULT")
})
...
test_that("germplasmPreprocessing", {
  # tests for the property `germplasmPreprocessing` (character)
  ...
  # uncomment below to test the property 
  #expect_equal(model.instance$`germplasmPreprocessing`, "EXPECTED_RESULT")
})
...
test_that("seedSource", {
  # tests for the property `seedSource` (character)
  # The source of the seed 

  # uncomment below to test the property 
  #expect_equal(model.instance$`seedSource`, "EXPECTED_RESULT")
})

test_that("seedSourceDescription", {
  # tests for the property `seedSourceDescription` (character)
  # Description of the material source  MIAPPE V1.1 (DM-56) Material source description - Description of the material source

  # uncomment below to test the property 
  #expect_equal(model.instance$`seedSourceDescription`, "EXPECTED_RESULT")
})
...
test_that("storageTypes", {
  # tests for the property `storageTypes` (array[GermplasmNewRequestStorageTypes])
  # The type of storage this germplasm is kept in at a genebank.

  # uncomment below to test the property 
  #expect_equal(model.instance$`storageTypes`, "EXPECTED_RESULT")
})

test_that("subtaxa", {
  # tests for the property `subtaxa` (character)
  ...
  # uncomment below to test the property 
  #expect_equal(model.instance$`subtaxa`, "EXPECTED_RESULT")
})

test_that("subtaxaAuthority", {
  # tests for the property `subtaxaAuthority` (character)
  ...
  # uncomment below to test the property 
  #expect_equal(model.instance$`subtaxaAuthority`, "EXPECTED_RESULT")
})

test_that("synonyms", {
  # tests for the property `synonyms` (array[GermplasmNewRequestSynonyms])
...
test_that("taxonIds", {
  # tests for the property `taxonIds` (array[TaxonID])
  ...
  # uncomment below to test the property 
  #expect_equal(model.instance$`taxonIds`, "EXPECTED_RESULT")
})
