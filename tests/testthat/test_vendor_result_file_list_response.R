...
context("Test VendorResultFileListResponse")

model.instance <- VendorResultFileListResponse$new()
...
test_that("result", {
  # tests for the property `result` (VendorResultFileListResponseResult)
