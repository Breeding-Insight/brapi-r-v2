...
context("Test CrossingProjectsListResponse")

model.instance <- CrossingProjectsListResponse$new()
...
test_that("result", {
  # tests for the property `result` (CrossingProjectsListResponseResult)
