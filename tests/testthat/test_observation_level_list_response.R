...
context("Test ObservationLevelListResponse")

model.instance <- ObservationLevelListResponse$new()
...
test_that("result", {
  # tests for the property `result` (ObservationLevelListResponseResult)
