...
context("Test ObservationVariableListResponse")

model.instance <- ObservationVariableListResponse$new()
...
test_that("result", {
  # tests for the property `result` (ObservationVariableListResponseResult)
