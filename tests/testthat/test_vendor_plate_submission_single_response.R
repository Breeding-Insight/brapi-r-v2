...
context("Test VendorPlateSubmissionSingleResponse")

model.instance <- VendorPlateSubmissionSingleResponse$new()
...
test_that("result", {
  # tests for the property `result` (VendorPlateSubmission)
