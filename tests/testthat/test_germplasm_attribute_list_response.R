...
context("Test GermplasmAttributeListResponse")

model.instance <- GermplasmAttributeListResponse$new()
...
test_that("result", {
  # tests for the property `result` (GermplasmAttributeListResponseResult)
