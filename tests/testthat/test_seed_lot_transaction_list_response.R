...
context("Test SeedLotTransactionListResponse")

model.instance <- SeedLotTransactionListResponse$new()
...
test_that("result", {
  # tests for the property `result` (SeedLotTransactionListResponseResult)
