...
context("Test VendorOrderSubmissionSingleResponse")

model.instance <- VendorOrderSubmissionSingleResponse$new()
...
test_that("result", {
  # tests for the property `result` (VendorOrderSubmission)
