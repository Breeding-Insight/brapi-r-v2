...
context("Test GermplasmAttributeValueSingleResponse")

model.instance <- GermplasmAttributeValueSingleResponse$new()
...
test_that("result", {
  # tests for the property `result` (GermplasmAttributeValue)
