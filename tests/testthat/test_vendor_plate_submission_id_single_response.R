...
context("Test VendorPlateSubmissionIdSingleResponse")

model.instance <- VendorPlateSubmissionIdSingleResponse$new()
...
test_that("result", {
  # tests for the property `result` (VendorPlateSubmissionId)
