...
#'
#' @description ObservationUnitLevelRelationship Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field levelName  character [optional]
#'
#' @field levelOrder  integer [optional]
#'
#' @field levelCode  character [optional]
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationUnitLevelRelationship <- R6::R6Class(
  ...
  public = list(
    ...
    `levelCode` = NULL,
    initialize = function(
        `levelName`=NULL, `levelOrder`=NULL, `levelCode`=NULL, ...
    ) {
      local.optional.var <- list(...)
      if (!is.null(`levelName`)) {
        stopifnot(is.character(`levelName`), length(`levelName`) == 1)
        self$`levelName` <- `levelName`
      }
      if (!is.null(`levelOrder`)) {
        stopifnot(is.numeric(`levelOrder`), length(`levelOrder`) == 1)
        self$`levelOrder` <- `levelOrder`
      }
      if (!is.null(`levelCode`)) {
        stopifnot(is.character(`levelCode`), length(`levelCode`) == 1)
        self$`levelCode` <- `levelCode`
      }
    },
    toJSON = function() {
      ObservationUnitLevelRelationshipObject <- list()
      if (!is.null(self$`levelName`)) {
        ObservationUnitLevelRelationshipObject[['levelName']] <-
          self$`levelName`
      }
      if (!is.null(self$`levelOrder`)) {
        ObservationUnitLevelRelationshipObject[['levelOrder']] <-
          self$`levelOrder`
      }
      if (!is.null(self$`levelCode`)) {
        ObservationUnitLevelRelationshipObject[['levelCode']] <-
          self$`levelCode`
      }

      ObservationUnitLevelRelationshipObject
    },
    fromJSON = function(ObservationUnitLevelRelationshipJson) {
      ObservationUnitLevelRelationshipObject <- jsonlite::fromJSON(ObservationUnitLevelRelationshipJson)
      if (!is.null(ObservationUnitLevelRelationshipObject$`levelName`)) {
        self$`levelName` <- ObservationUnitLevelRelationshipObject$`levelName`
      }
      if (!is.null(ObservationUnitLevelRelationshipObject$`levelOrder`)) {
        self$`levelOrder` <- ObservationUnitLevelRelationshipObject$`levelOrder`
      }
      if (!is.null(ObservationUnitLevelRelationshipObject$`levelCode`)) {
        self$`levelCode` <- ObservationUnitLevelRelationshipObject$`levelCode`
      }
      self
    },
    ...
    fromJSONString = function(ObservationUnitLevelRelationshipJson) {
      ObservationUnitLevelRelationshipObject <- jsonlite::fromJSON(ObservationUnitLevelRelationshipJson)
      self$`levelName` <- ObservationUnitLevelRelationshipObject$`levelName`
      self$`levelOrder` <- ObservationUnitLevelRelationshipObject$`levelOrder`
      self$`levelCode` <- ObservationUnitLevelRelationshipObject$`levelCode`
