...
#'
#' @field methodDbId  character [optional]
#'
...
Method <- R6::R6Class(
  ...
  public = list(
    ...
    `methodDbId` = NULL,
    initialize = function(
        `additionalInfo`=NULL, `bibliographicalReference`=NULL, `description`=NULL, `externalReferences`=NULL, `formula`=NULL, `methodClass`=NULL, `methodName`=NULL, `ontologyReference`=NULL, `methodDbId`=NULL, ...
    ) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`additionalInfo`)) {
        MethodObject[['additionalInfo']] <-
          self$`additionalInfo`
      }
      if (!is.null(self$`bibliographicalReference`)) {
        MethodObject[['bibliographicalReference']] <-
      ...
      if (!is.null(self$`externalReferences`)) {
        MethodObject[['externalReferences']] <-
          self$`externalReferences`
      }
      if (!is.null(self$`formula`)) {
        MethodObject[['formula']] <-
          self$`formula`
      }
    ...
    fromJSON = function(MethodJson) {
      ...
      if (!is.null(MethodObject$`additionalInfo`)) {
        self$`additionalInfo` <- ApiClient$new()$deserializeObj(MethodObject$`additionalInfo`, "map(character)", loadNamespace("openapi"))
      }
      if (!is.null(MethodObject$`bibliographicalReference`)) {
        self$`bibliographicalReference` <- MethodObject$`bibliographicalReference`
      }
      if (!is.null(MethodObject$`description`)) {
        self$`description` <- MethodObject$`description`
      }
      if (!is.null(MethodObject$`externalReferences`)) {
        self$`externalReferences` <- ApiClient$new()$deserializeObj(MethodObject$`externalReferences`, "array[object]", loadNamespace("openapi"))
      }
      if (!is.null(MethodObject$`formula`)) {
        self$`formula` <- MethodObject$`formula`
      }
      if (!is.null(MethodObject$`methodClass`)) {
        self$`methodClass` <- MethodObject$`methodClass`
      }
      ...
      if (!is.null(MethodObject$`ontologyReference`)) {
        ...
        ontologyReferenceObject$fromJSON(jsonlite::toJSON(MethodObject$ontologyReference, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(MethodJson) {
      ...
      self$`methodClass` <- MethodObject$`methodClass`
      self$`methodName` <- MethodObject$`methodName`
      self$`ontologyReference` <- OntologyReference$new()$fromJSON(jsonlite::toJSON(MethodObject$ontologyReference, auto_unbox = TRUE, digits = NA))
      self$`methodDbId` <- MethodObject$`methodDbId`
      self
    }
  )
