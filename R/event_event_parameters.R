...
#' @docType class
#' @title EventEventParameters
#'
#' @description EventEventParameters Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field key  character [optional]
#'
#' @field rdfValue  character [optional]
#'
...
#' @export
EventEventParameters <- R6::R6Class(
  ...
  public = list(
    ...
    `value` = NULL,
    initialize = function(
        `key`=NULL, `rdfValue`=NULL, `value`=NULL, ...
    ) {
      ...
      if (!is.null(`rdfValue`)) {
        stopifnot(is.character(`rdfValue`), length(`rdfValue`) == 1)
    ...
    toJSON = function() {
      EventEventParametersObject <- list()
      if (!is.null(self$`key`)) {
        EventEventParametersObject[['key']] <-
          self$`key`
      }
      if (!is.null(self$`rdfValue`)) {
        EventEventParametersObject[['rdfValue']] <-
          self$`rdfValue`
      }
      if (!is.null(self$`value`)) {
        EventEventParametersObject[['value']] <-
          self$`value`
      }

      EventEventParametersObject
    },
    fromJSON = function(EventEventParametersJson) {
      EventEventParametersObject <- jsonlite::fromJSON(EventEventParametersJson)
      if (!is.null(EventEventParametersObject$`key`)) {
        self$`key` <- EventEventParametersObject$`key`
      }
      if (!is.null(EventEventParametersObject$`rdfValue`)) {
        self$`rdfValue` <- EventEventParametersObject$`rdfValue`
      }
      if (!is.null(EventEventParametersObject$`value`)) {
        self$`value` <- EventEventParametersObject$`value`
      }
      self
    },
    ...
    fromJSONString = function(EventEventParametersJson) {
      EventEventParametersObject <- jsonlite::fromJSON(EventEventParametersJson)
      self$`key` <- EventEventParametersObject$`key`
      self$`rdfValue` <- EventEventParametersObject$`rdfValue`
      self$`value` <- EventEventParametersObject$`value`
