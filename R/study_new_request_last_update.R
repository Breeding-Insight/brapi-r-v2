...
#' @docType class
#' @title StudyNewRequestLastUpdate
#'
#' @description StudyNewRequestLastUpdate Class
#'
...
#' @export
StudyNewRequestLastUpdate <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      StudyNewRequestLastUpdateObject <- list()
      if (!is.null(self$`timestamp`)) {
        StudyNewRequestLastUpdateObject[['timestamp']] <-
          self$`timestamp`
      }
      if (!is.null(self$`version`)) {
        StudyNewRequestLastUpdateObject[['version']] <-
          self$`version`
      }

      StudyNewRequestLastUpdateObject
    },
    fromJSON = function(StudyNewRequestLastUpdateJson) {
      StudyNewRequestLastUpdateObject <- jsonlite::fromJSON(StudyNewRequestLastUpdateJson)
      if (!is.null(StudyNewRequestLastUpdateObject$`timestamp`)) {
        self$`timestamp` <- StudyNewRequestLastUpdateObject$`timestamp`
      }
      if (!is.null(StudyNewRequestLastUpdateObject$`version`)) {
        self$`version` <- StudyNewRequestLastUpdateObject$`version`
      }
      self
    },
    ...
    fromJSONString = function(StudyNewRequestLastUpdateJson) {
      StudyNewRequestLastUpdateObject <- jsonlite::fromJSON(StudyNewRequestLastUpdateJson)
      self$`timestamp` <- StudyNewRequestLastUpdateObject$`timestamp`
      self$`version` <- StudyNewRequestLastUpdateObject$`version`
      self
