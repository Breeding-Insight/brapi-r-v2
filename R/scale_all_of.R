...
ScaleAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ScaleAllOfObject <- list()
      if (!is.null(self$`scaleDbId`)) {
        ScaleAllOfObject[['scaleDbId']] <-
          self$`scaleDbId`
      }

      ScaleAllOfObject
    },
    fromJSON = function(ScaleAllOfJson) {
      ScaleAllOfObject <- jsonlite::fromJSON(ScaleAllOfJson)
      if (!is.null(ScaleAllOfObject$`scaleDbId`)) {
        self$`scaleDbId` <- ScaleAllOfObject$`scaleDbId`
      }
      self
    },
    ...
    fromJSONString = function(ScaleAllOfJson) {
      ScaleAllOfObject <- jsonlite::fromJSON(ScaleAllOfJson)
      self$`scaleDbId` <- ScaleAllOfObject$`scaleDbId`
      self
    }
