...
#' @docType class
#' @title ObservationVariableListResponseResult
#'
#' @description ObservationVariableListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{ObservationVariable} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationVariableListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationVariableListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        ObservationVariableListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      ObservationVariableListResponseResultObject
    },
    fromJSON = function(ObservationVariableListResponseResultJson) {
      ObservationVariableListResponseResultObject <- jsonlite::fromJSON(ObservationVariableListResponseResultJson)
      if (!is.null(ObservationVariableListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ObservationVariableListResponseResultObject$`data`, "array[ObservationVariable]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ObservationVariableListResponseResultJson) {
      ObservationVariableListResponseResultObject <- jsonlite::fromJSON(ObservationVariableListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(ObservationVariableListResponseResultObject$`data`, "array[ObservationVariable]", loadNamespace("openapi"))
      self
    }
