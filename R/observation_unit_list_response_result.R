...
#' @docType class
#' @title ObservationUnitListResponseResult
#'
#' @description ObservationUnitListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{ObservationUnit} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationUnitListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationUnitListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        ObservationUnitListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      ObservationUnitListResponseResultObject
    },
    fromJSON = function(ObservationUnitListResponseResultJson) {
      ObservationUnitListResponseResultObject <- jsonlite::fromJSON(ObservationUnitListResponseResultJson)
      if (!is.null(ObservationUnitListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ObservationUnitListResponseResultObject$`data`, "array[ObservationUnit]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ObservationUnitListResponseResultJson) {
      ObservationUnitListResponseResultObject <- jsonlite::fromJSON(ObservationUnitListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(ObservationUnitListResponseResultObject$`data`, "array[ObservationUnit]", loadNamespace("openapi"))
      self
    }
