...
#'
#' @description BasePagination Class
#'
...
BasePagination <- R6::R6Class(
  ...
  public = list(
    ...
    `totalPages` = NULL,
    initialize = function(
        `pageSize`, `totalCount`=NULL, `totalPages`=NULL, ...
    ) {
    ...
    toJSON = function() {
      BasePaginationObject <- list()
      if (!is.null(self$`pageSize`)) {
        BasePaginationObject[['pageSize']] <-
          self$`pageSize`
      }
      if (!is.null(self$`totalCount`)) {
        BasePaginationObject[['totalCount']] <-
          self$`totalCount`
      }
      if (!is.null(self$`totalPages`)) {
        BasePaginationObject[['totalPages']] <-
          self$`totalPages`
      }

      BasePaginationObject
    },
    fromJSON = function(BasePaginationJson) {
      BasePaginationObject <- jsonlite::fromJSON(BasePaginationJson)
      if (!is.null(BasePaginationObject$`pageSize`)) {
        self$`pageSize` <- BasePaginationObject$`pageSize`
      }
      if (!is.null(BasePaginationObject$`totalCount`)) {
        self$`totalCount` <- BasePaginationObject$`totalCount`
      }
      if (!is.null(BasePaginationObject$`totalPages`)) {
        self$`totalPages` <- BasePaginationObject$`totalPages`
      }
      self
    },
    ...
    fromJSONString = function(BasePaginationJson) {
      BasePaginationObject <- jsonlite::fromJSON(BasePaginationJson)
      self$`pageSize` <- BasePaginationObject$`pageSize`
      self$`totalCount` <- BasePaginationObject$`totalCount`
      self$`totalPages` <- BasePaginationObject$`totalPages`
