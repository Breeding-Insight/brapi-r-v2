...
#' @docType class
#' @title GermplasmAttributeAllOf
#'
#' @description GermplasmAttributeAllOf Class
#'
...
#' @export
GermplasmAttributeAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmAttributeAllOfObject <- list()
      if (!is.null(self$`attributeDbId`)) {
        GermplasmAttributeAllOfObject[['attributeDbId']] <-
          self$`attributeDbId`
      }

      GermplasmAttributeAllOfObject
    },
    fromJSON = function(GermplasmAttributeAllOfJson) {
      GermplasmAttributeAllOfObject <- jsonlite::fromJSON(GermplasmAttributeAllOfJson)
      if (!is.null(GermplasmAttributeAllOfObject$`attributeDbId`)) {
        self$`attributeDbId` <- GermplasmAttributeAllOfObject$`attributeDbId`
      }
      self
    },
    ...
    fromJSONString = function(GermplasmAttributeAllOfJson) {
      GermplasmAttributeAllOfObject <- jsonlite::fromJSON(GermplasmAttributeAllOfJson)
      self$`attributeDbId` <- GermplasmAttributeAllOfObject$`attributeDbId`
      self
    }
