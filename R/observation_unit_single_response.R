...
#'
#' @description ObservationUnitSingleResponse Class
#'
...
#'
#' @field result  \link{ObservationUnit} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationUnitSingleResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationUnitSingleResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ObservationUnitSingleResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ObservationUnitSingleResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ObservationUnitSingleResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ObservationUnitSingleResponseObject
    },
    fromJSON = function(ObservationUnitSingleResponseJson) {
      ObservationUnitSingleResponseObject <- jsonlite::fromJSON(ObservationUnitSingleResponseJson)
      if (!is.null(ObservationUnitSingleResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ObservationUnitSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationUnitSingleResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ObservationUnitSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ObservationUnitSingleResponseObject$`result`)) {
        resultObject <- ObservationUnit$new()
        resultObject$fromJSON(jsonlite::toJSON(ObservationUnitSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ObservationUnitSingleResponseJson) {
      ObservationUnitSingleResponseObject <- jsonlite::fromJSON(ObservationUnitSingleResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ObservationUnitSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ObservationUnitSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ObservationUnit$new()$fromJSON(jsonlite::toJSON(ObservationUnitSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
