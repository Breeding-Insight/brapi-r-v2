...
#' @docType class
#' @title GermplasmAllOf
#'
#' @description GermplasmAllOf Class
#'
...
GermplasmAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmAllOfObject <- list()
      if (!is.null(self$`germplasmDbId`)) {
        GermplasmAllOfObject[['germplasmDbId']] <-
          self$`germplasmDbId`
      }

      GermplasmAllOfObject
    },
    fromJSON = function(GermplasmAllOfJson) {
      GermplasmAllOfObject <- jsonlite::fromJSON(GermplasmAllOfJson)
      if (!is.null(GermplasmAllOfObject$`germplasmDbId`)) {
        self$`germplasmDbId` <- GermplasmAllOfObject$`germplasmDbId`
      }
      self
    },
    ...
    fromJSONString = function(GermplasmAllOfJson) {
      GermplasmAllOfObject <- jsonlite::fromJSON(GermplasmAllOfJson)
      self$`germplasmDbId` <- GermplasmAllOfObject$`germplasmDbId`
      self
    }
