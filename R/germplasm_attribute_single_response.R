...
#'
#' @description GermplasmAttributeSingleResponse Class
#'
...
#'
#' @field result  \link{GermplasmAttribute} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GermplasmAttributeSingleResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmAttributeSingleResponseObject <- list()
      if (!is.null(self$`@context`)) {
        GermplasmAttributeSingleResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        GermplasmAttributeSingleResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        GermplasmAttributeSingleResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      GermplasmAttributeSingleResponseObject
    },
    fromJSON = function(GermplasmAttributeSingleResponseJson) {
      GermplasmAttributeSingleResponseObject <- jsonlite::fromJSON(GermplasmAttributeSingleResponseJson)
      if (!is.null(GermplasmAttributeSingleResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(GermplasmAttributeSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(GermplasmAttributeSingleResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(GermplasmAttributeSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(GermplasmAttributeSingleResponseObject$`result`)) {
        resultObject <- GermplasmAttribute$new()
        resultObject$fromJSON(jsonlite::toJSON(GermplasmAttributeSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(GermplasmAttributeSingleResponseJson) {
      GermplasmAttributeSingleResponseObject <- jsonlite::fromJSON(GermplasmAttributeSingleResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(GermplasmAttributeSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(GermplasmAttributeSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- GermplasmAttribute$new()$fromJSON(jsonlite::toJSON(GermplasmAttributeSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
