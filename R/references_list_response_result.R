...
#'
#' @description ReferencesListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Reference} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ReferencesListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ReferencesListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        ReferencesListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      ReferencesListResponseResultObject
    },
    fromJSON = function(ReferencesListResponseResultJson) {
      ReferencesListResponseResultObject <- jsonlite::fromJSON(ReferencesListResponseResultJson)
      if (!is.null(ReferencesListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ReferencesListResponseResultObject$`data`, "array[Reference]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ReferencesListResponseResultJson) {
      ReferencesListResponseResultObject <- jsonlite::fromJSON(ReferencesListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(ReferencesListResponseResultObject$`data`, "array[Reference]", loadNamespace("openapi"))
      self
    }
