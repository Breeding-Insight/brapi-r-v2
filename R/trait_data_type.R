...
#' @title TraitDataType
#'
#' @description TraitDataType Class
#'
...
#' @export
TraitDataType <- R6::R6Class(
    "TraitDataType",
    public = list(
        initialize = function(...) {
            local.optional.var <- list(...)
            val <- unlist(local.optional.var)
            enumvec <- .parse_TraitDataType()
        ...
        fromJSON = function(TraitDataTypeJson) {
            private$value <- jsonlite::fromJSON(TraitDataTypeJson,
        ...
        fromJSONString = function(TraitDataTypeJson) {
            private$value <- jsonlite::fromJSON(TraitDataTypeJson,
                simplifyVector = FALSE)
            self
        }
...
# add to utils.R
.parse_TraitDataType <- function(vals) {
    res <- gsub("^\\[|\\]$", "",
