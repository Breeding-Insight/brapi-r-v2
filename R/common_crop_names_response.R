...
#'
#' @description CommonCropNamesResponse Class
#'
...
#'
#' @field result  \link{CommonCropNamesResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
CommonCropNamesResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CommonCropNamesResponseObject <- list()
      if (!is.null(self$`@context`)) {
        CommonCropNamesResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        CommonCropNamesResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        CommonCropNamesResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      CommonCropNamesResponseObject
    },
    fromJSON = function(CommonCropNamesResponseJson) {
      CommonCropNamesResponseObject <- jsonlite::fromJSON(CommonCropNamesResponseJson)
      if (!is.null(CommonCropNamesResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(CommonCropNamesResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(CommonCropNamesResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(CommonCropNamesResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(CommonCropNamesResponseObject$`result`)) {
        resultObject <- CommonCropNamesResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(CommonCropNamesResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(CommonCropNamesResponseJson) {
      CommonCropNamesResponseObject <- jsonlite::fromJSON(CommonCropNamesResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(CommonCropNamesResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(CommonCropNamesResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- CommonCropNamesResponseResult$new()$fromJSON(jsonlite::toJSON(CommonCropNamesResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
