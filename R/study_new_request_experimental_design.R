...
#' @docType class
#' @title StudyNewRequestExperimentalDesign
#'
#' @description StudyNewRequestExperimentalDesign Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field PUI  character [optional]
#'
...
#' @export
StudyNewRequestExperimentalDesign <- R6::R6Class(
  'StudyNewRequestExperimentalDesign',
  public = list(
    `PUI` = NULL,
    `description` = NULL,
    initialize = function(
        `PUI`=NULL, `description`=NULL, ...
    ) {
      local.optional.var <- list(...)
      if (!is.null(`PUI`)) {
        stopifnot(is.character(`PUI`), length(`PUI`) == 1)
        self$`PUI` <- `PUI`
      }
    ...
    toJSON = function() {
      StudyNewRequestExperimentalDesignObject <- list()
      if (!is.null(self$`PUI`)) {
        StudyNewRequestExperimentalDesignObject[['PUI']] <-
          self$`PUI`
      }
      if (!is.null(self$`description`)) {
        StudyNewRequestExperimentalDesignObject[['description']] <-
          self$`description`
      }

      StudyNewRequestExperimentalDesignObject
    },
    fromJSON = function(StudyNewRequestExperimentalDesignJson) {
      StudyNewRequestExperimentalDesignObject <- jsonlite::fromJSON(StudyNewRequestExperimentalDesignJson)
      if (!is.null(StudyNewRequestExperimentalDesignObject$`PUI`)) {
        self$`PUI` <- StudyNewRequestExperimentalDesignObject$`PUI`
      }
      if (!is.null(StudyNewRequestExperimentalDesignObject$`description`)) {
        self$`description` <- StudyNewRequestExperimentalDesignObject$`description`
      }
      self
    },
    ...
    fromJSONString = function(StudyNewRequestExperimentalDesignJson) {
      StudyNewRequestExperimentalDesignObject <- jsonlite::fromJSON(StudyNewRequestExperimentalDesignJson)
      self$`PUI` <- StudyNewRequestExperimentalDesignObject$`PUI`
      self$`description` <- StudyNewRequestExperimentalDesignObject$`description`
      self
