...
#' @docType class
#' @title ListSummaryAllOf
#'
#' @description ListSummaryAllOf Class
#'
...
ListSummaryAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ListSummaryAllOfObject <- list()
      if (!is.null(self$`listDbId`)) {
        ListSummaryAllOfObject[['listDbId']] <-
          self$`listDbId`
      }

      ListSummaryAllOfObject
    },
    fromJSON = function(ListSummaryAllOfJson) {
      ListSummaryAllOfObject <- jsonlite::fromJSON(ListSummaryAllOfJson)
      if (!is.null(ListSummaryAllOfObject$`listDbId`)) {
        self$`listDbId` <- ListSummaryAllOfObject$`listDbId`
      }
      self
    },
    ...
    fromJSONString = function(ListSummaryAllOfJson) {
      ListSummaryAllOfObject <- jsonlite::fromJSON(ListSummaryAllOfJson)
      self$`listDbId` <- ListSummaryAllOfObject$`listDbId`
      self
    }
