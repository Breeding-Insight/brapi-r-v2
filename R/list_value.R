...
#' @title ListValue
#'
#' @description ListValue Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field values  list( \link{OneOfbooleandoublestring} ) [optional]
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ListValue <- R6::R6Class(
  'ListValue',
  public = list(
    `values` = NULL,
    initialize = function(
    ...
    toJSON = function() {
      ListValueObject <- list()
      if (!is.null(self$`values`)) {
        ListValueObject[['values']] <-
          lapply(self$`values`, function(x) x$toJSON())
      }

      ListValueObject
    },
    fromJSON = function(ListValueJson) {
      ListValueObject <- jsonlite::fromJSON(ListValueJson)
      if (!is.null(ListValueObject$`values`)) {
        self$`values` <- ApiClient$new()$deserializeObj(ListValueObject$`values`, "array[OneOfbooleandoublestring]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ListValueJson) {
      ListValueObject <- jsonlite::fromJSON(ListValueJson)
      self$`values` <- ApiClient$new()$deserializeObj(ListValueObject$`values`, "array[OneOfbooleandoublestring]", loadNamespace("openapi"))
      self
    }
