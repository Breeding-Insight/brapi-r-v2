...
#' @docType class
#' @title SeedLotTransactionAllOf
#'
#' @description SeedLotTransactionAllOf Class
#'
...
#' @export
SeedLotTransactionAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SeedLotTransactionAllOfObject <- list()
      if (!is.null(self$`transactionDbId`)) {
        SeedLotTransactionAllOfObject[['transactionDbId']] <-
          self$`transactionDbId`
      }

      SeedLotTransactionAllOfObject
    },
    fromJSON = function(SeedLotTransactionAllOfJson) {
      SeedLotTransactionAllOfObject <- jsonlite::fromJSON(SeedLotTransactionAllOfJson)
      if (!is.null(SeedLotTransactionAllOfObject$`transactionDbId`)) {
        self$`transactionDbId` <- SeedLotTransactionAllOfObject$`transactionDbId`
      }
      self
    },
    ...
    fromJSONString = function(SeedLotTransactionAllOfJson) {
      SeedLotTransactionAllOfObject <- jsonlite::fromJSON(SeedLotTransactionAllOfJson)
      self$`transactionDbId` <- SeedLotTransactionAllOfObject$`transactionDbId`
      self
    }
