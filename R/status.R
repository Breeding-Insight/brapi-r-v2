  ...
  public = list(
    ...
    initialize = function(
      ...
      if (!missing(`messageType`)) {
        stopifnot(is.character(`messageType`), length(`messageType`) == 1)
    ...
    fromJSON = function(StatusJson) {
      ...
      if (!is.null(StatusObject$`messageType`)) {
        self$`messageType` <- StatusObject$`messageType`
      }
      self
    },
