...
#' @docType class
#' @title VendorOrderListResponseResult
#'
#' @description VendorOrderListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{VendorOrder} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VendorOrderListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VendorOrderListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        VendorOrderListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      VendorOrderListResponseResultObject
    },
    fromJSON = function(VendorOrderListResponseResultJson) {
      VendorOrderListResponseResultObject <- jsonlite::fromJSON(VendorOrderListResponseResultJson)
      if (!is.null(VendorOrderListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(VendorOrderListResponseResultObject$`data`, "array[VendorOrder]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(VendorOrderListResponseResultJson) {
      VendorOrderListResponseResultObject <- jsonlite::fromJSON(VendorOrderListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(VendorOrderListResponseResultObject$`data`, "array[VendorOrder]", loadNamespace("openapi"))
      self
    }
