...
#' @docType class
#' @title EventsResponseResult
#'
#' @description EventsResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Event} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
EventsResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      EventsResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        EventsResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      EventsResponseResultObject
    },
    fromJSON = function(EventsResponseResultJson) {
      EventsResponseResultObject <- jsonlite::fromJSON(EventsResponseResultJson)
      if (!is.null(EventsResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(EventsResponseResultObject$`data`, "array[Event]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(EventsResponseResultJson) {
      EventsResponseResultObject <- jsonlite::fromJSON(EventsResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(EventsResponseResultObject$`data`, "array[Event]", loadNamespace("openapi"))
      self
    }
