...
#' @docType class
#' @title TrialListResponseResult
#'
#' @description TrialListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Trial} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
TrialListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      TrialListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        TrialListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      TrialListResponseResultObject
    },
    fromJSON = function(TrialListResponseResultJson) {
      TrialListResponseResultObject <- jsonlite::fromJSON(TrialListResponseResultJson)
      if (!is.null(TrialListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(TrialListResponseResultObject$`data`, "array[Trial]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(TrialListResponseResultJson) {
      TrialListResponseResultObject <- jsonlite::fromJSON(TrialListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(TrialListResponseResultObject$`data`, "array[Trial]", loadNamespace("openapi"))
      self
    }
