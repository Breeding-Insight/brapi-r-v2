...
#' @docType class
#' @title VariantsSearchRequest
#'
#' @description VariantsSearchRequest Class
#'
...
#' @export
VariantsSearchRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(
        `pageSize`=NULL, `pageToken`=NULL, `callSetDbIds`=NULL, `end`=NULL, `referenceDbId`=NULL, `start`=NULL, `variantDbIds`=NULL, `variantSetDbIds`=NULL, ...
    ) {
    ...
    toJSON = function() {
      VariantsSearchRequestObject <- list()
      if (!is.null(self$`pageSize`)) {
        VariantsSearchRequestObject[['pageSize']] <-
          self$`pageSize`
      }
      if (!is.null(self$`pageToken`)) {
        VariantsSearchRequestObject[['pageToken']] <-
          self$`pageToken`
      }
      if (!is.null(self$`callSetDbIds`)) {
        VariantsSearchRequestObject[['callSetDbIds']] <-
          self$`callSetDbIds`
      }
      if (!is.null(self$`end`)) {
        VariantsSearchRequestObject[['end']] <-
          self$`end`
      }
      if (!is.null(self$`referenceDbId`)) {
        VariantsSearchRequestObject[['referenceDbId']] <-
          self$`referenceDbId`
      }
      if (!is.null(self$`start`)) {
        VariantsSearchRequestObject[['start']] <-
          self$`start`
      }
      if (!is.null(self$`variantDbIds`)) {
        VariantsSearchRequestObject[['variantDbIds']] <-
          self$`variantDbIds`
      }
      if (!is.null(self$`variantSetDbIds`)) {
        VariantsSearchRequestObject[['variantSetDbIds']] <-
          self$`variantSetDbIds`
      }

      VariantsSearchRequestObject
    },
    fromJSON = function(VariantsSearchRequestJson) {
      VariantsSearchRequestObject <- jsonlite::fromJSON(VariantsSearchRequestJson)
      if (!is.null(VariantsSearchRequestObject$`pageSize`)) {
        self$`pageSize` <- VariantsSearchRequestObject$`pageSize`
      }
      if (!is.null(VariantsSearchRequestObject$`pageToken`)) {
        self$`pageToken` <- VariantsSearchRequestObject$`pageToken`
      }
      if (!is.null(VariantsSearchRequestObject$`callSetDbIds`)) {
        self$`callSetDbIds` <- ApiClient$new()$deserializeObj(VariantsSearchRequestObject$`callSetDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantsSearchRequestObject$`end`)) {
        self$`end` <- VariantsSearchRequestObject$`end`
      }
      if (!is.null(VariantsSearchRequestObject$`referenceDbId`)) {
        self$`referenceDbId` <- VariantsSearchRequestObject$`referenceDbId`
      }
      if (!is.null(VariantsSearchRequestObject$`start`)) {
        self$`start` <- VariantsSearchRequestObject$`start`
      }
      if (!is.null(VariantsSearchRequestObject$`variantDbIds`)) {
        self$`variantDbIds` <- ApiClient$new()$deserializeObj(VariantsSearchRequestObject$`variantDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantsSearchRequestObject$`variantSetDbIds`)) {
        self$`variantSetDbIds` <- ApiClient$new()$deserializeObj(VariantsSearchRequestObject$`variantSetDbIds`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(VariantsSearchRequestJson) {
      VariantsSearchRequestObject <- jsonlite::fromJSON(VariantsSearchRequestJson)
      self$`pageSize` <- VariantsSearchRequestObject$`pageSize`
      self$`pageToken` <- VariantsSearchRequestObject$`pageToken`
      self$`callSetDbIds` <- ApiClient$new()$deserializeObj(VariantsSearchRequestObject$`callSetDbIds`, "array[character]", loadNamespace("openapi"))
