...
#'
#' @description ReferencesListResponse Class
#'
...
#'
#' @field result  \link{ReferencesListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ReferencesListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ReferencesListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ReferencesListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ReferencesListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ReferencesListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ReferencesListResponseObject
    },
    fromJSON = function(ReferencesListResponseJson) {
      ReferencesListResponseObject <- jsonlite::fromJSON(ReferencesListResponseJson)
      if (!is.null(ReferencesListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ReferencesListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ReferencesListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ReferencesListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ReferencesListResponseObject$`result`)) {
        resultObject <- ReferencesListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(ReferencesListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ReferencesListResponseJson) {
      ReferencesListResponseObject <- jsonlite::fromJSON(ReferencesListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ReferencesListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ReferencesListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ReferencesListResponseResult$new()$fromJSON(jsonlite::toJSON(ReferencesListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
