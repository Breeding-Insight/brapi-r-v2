...
#'
#' @description GermplasmPedigreeResponse Class
#'
...
#'
#' @field result  \link{PedigreeNode} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GermplasmPedigreeResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmPedigreeResponseObject <- list()
      if (!is.null(self$`@context`)) {
        GermplasmPedigreeResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        GermplasmPedigreeResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        GermplasmPedigreeResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      GermplasmPedigreeResponseObject
    },
    fromJSON = function(GermplasmPedigreeResponseJson) {
      GermplasmPedigreeResponseObject <- jsonlite::fromJSON(GermplasmPedigreeResponseJson)
      if (!is.null(GermplasmPedigreeResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(GermplasmPedigreeResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(GermplasmPedigreeResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(GermplasmPedigreeResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(GermplasmPedigreeResponseObject$`result`)) {
        resultObject <- PedigreeNode$new()
        resultObject$fromJSON(jsonlite::toJSON(GermplasmPedigreeResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(GermplasmPedigreeResponseJson) {
      GermplasmPedigreeResponseObject <- jsonlite::fromJSON(GermplasmPedigreeResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(GermplasmPedigreeResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(GermplasmPedigreeResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- PedigreeNode$new()$fromJSON(jsonlite::toJSON(GermplasmPedigreeResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
