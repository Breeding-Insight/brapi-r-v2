...
#' @docType class
#' @title LocationListResponseResult
#'
#' @description LocationListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Location} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
LocationListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      LocationListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        LocationListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      LocationListResponseResultObject
    },
    fromJSON = function(LocationListResponseResultJson) {
      LocationListResponseResultObject <- jsonlite::fromJSON(LocationListResponseResultJson)
      if (!is.null(LocationListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(LocationListResponseResultObject$`data`, "array[Location]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(LocationListResponseResultJson) {
      LocationListResponseResultObject <- jsonlite::fromJSON(LocationListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(LocationListResponseResultObject$`data`, "array[Location]", loadNamespace("openapi"))
      self
    }
