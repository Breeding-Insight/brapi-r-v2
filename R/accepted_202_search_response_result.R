...
#' @docType class
#' @title Accepted202SearchResponseResult
#'
#' @description Accepted202SearchResponseResult Class
#'
...
#' @export
Accepted202SearchResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      Accepted202SearchResponseResultObject <- list()
      if (!is.null(self$`searchResultsDbId`)) {
        Accepted202SearchResponseResultObject[['searchResultsDbId']] <-
          self$`searchResultsDbId`
      }

      Accepted202SearchResponseResultObject
    },
    fromJSON = function(Accepted202SearchResponseResultJson) {
      Accepted202SearchResponseResultObject <- jsonlite::fromJSON(Accepted202SearchResponseResultJson)
      if (!is.null(Accepted202SearchResponseResultObject$`searchResultsDbId`)) {
        self$`searchResultsDbId` <- Accepted202SearchResponseResultObject$`searchResultsDbId`
      }
      self
    },
    ...
    fromJSONString = function(Accepted202SearchResponseResultJson) {
      Accepted202SearchResponseResultObject <- jsonlite::fromJSON(Accepted202SearchResponseResultJson)
      self$`searchResultsDbId` <- Accepted202SearchResponseResultObject$`searchResultsDbId`
      self
    }
