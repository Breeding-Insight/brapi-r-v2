...
#'
#' @description ObservationTreatment Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field factor  character [optional]
#'
#' @field modality  character [optional]
#'
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`factor`)) {
        ObservationTreatmentObject[['factor']] <-
          self$`factor`
      }
      if (!is.null(self$`modality`)) {
        ObservationTreatmentObject[['modality']] <-
          self$`modality`
      }
