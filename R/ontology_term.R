...
#' @title OntologyTerm
#'
#' @description OntologyTerm Class
#'
...
#' @export
OntologyTerm <- R6::R6Class(
  'OntologyTerm',
  public = list(
    `term` = NULL,
    `termURI` = NULL,
    initialize = function(
        `term`=NULL, `termURI`=NULL, ...
    ) {
    ...
    toJSON = function() {
      OntologyTermObject <- list()
      if (!is.null(self$`term`)) {
        OntologyTermObject[['term']] <-
          self$`term`
      }
      if (!is.null(self$`termURI`)) {
        OntologyTermObject[['termURI']] <-
          self$`termURI`
      }

      OntologyTermObject
    },
    fromJSON = function(OntologyTermJson) {
      OntologyTermObject <- jsonlite::fromJSON(OntologyTermJson)
      if (!is.null(OntologyTermObject$`term`)) {
        self$`term` <- OntologyTermObject$`term`
      }
      if (!is.null(OntologyTermObject$`termURI`)) {
        self$`termURI` <- OntologyTermObject$`termURI`
      }
      self
    },
    ...
    fromJSONString = function(OntologyTermJson) {
      OntologyTermObject <- jsonlite::fromJSON(OntologyTermJson)
      self$`term` <- OntologyTermObject$`term`
      self$`termURI` <- OntologyTermObject$`termURI`
      self
