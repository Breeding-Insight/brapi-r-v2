...
#'
#' @description WSMIMEDataTypes Class
#'
...
#' @export
WSMIMEDataTypes <- R6::R6Class(
    "WSMIMEDataTypes",
    public = list(
        initialize = function(...) {
            local.optional.var <- list(...)
            val <- unlist(local.optional.var)
            enumvec <- .parse_WSMIMEDataTypes()
        ...
        fromJSON = function(WSMIMEDataTypesJson) {
            private$value <- jsonlite::fromJSON(WSMIMEDataTypesJson,
        ...
        fromJSONString = function(WSMIMEDataTypesJson) {
            private$value <- jsonlite::fromJSON(WSMIMEDataTypesJson,
                simplifyVector = FALSE)
            self
        }
...
# add to utils.R
.parse_WSMIMEDataTypes <- function(vals) {
    res <- gsub("^\\[|\\]$", "",
        "[application/json, text/csv, text/tsv, application/flapjack]"
    )
    unlist(strsplit(res, ", "))
}
