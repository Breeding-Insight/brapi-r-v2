...
#' @docType class
#' @title Accepted202SearchResponse
#'
#' @description Accepted202SearchResponse Class
#'
...
#'
#' @field result  \link{Accepted202SearchResponseResult} [optional]
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
Accepted202SearchResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      Accepted202SearchResponseObject <- list()
      if (!is.null(self$`@context`)) {
        Accepted202SearchResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        Accepted202SearchResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        Accepted202SearchResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      Accepted202SearchResponseObject
    },
    fromJSON = function(Accepted202SearchResponseJson) {
      Accepted202SearchResponseObject <- jsonlite::fromJSON(Accepted202SearchResponseJson)
      if (!is.null(Accepted202SearchResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(Accepted202SearchResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(Accepted202SearchResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(Accepted202SearchResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(Accepted202SearchResponseObject$`result`)) {
        resultObject <- Accepted202SearchResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(Accepted202SearchResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(Accepted202SearchResponseJson) {
      Accepted202SearchResponseObject <- jsonlite::fromJSON(Accepted202SearchResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(Accepted202SearchResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(Accepted202SearchResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- Accepted202SearchResponseResult$new()$fromJSON(jsonlite::toJSON(Accepted202SearchResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
