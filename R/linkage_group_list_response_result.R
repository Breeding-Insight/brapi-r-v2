...
#' @docType class
#' @title LinkageGroupListResponseResult
#'
#' @description LinkageGroupListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{LinkageGroup} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
LinkageGroupListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      LinkageGroupListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        LinkageGroupListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      LinkageGroupListResponseResultObject
    },
    fromJSON = function(LinkageGroupListResponseResultJson) {
      LinkageGroupListResponseResultObject <- jsonlite::fromJSON(LinkageGroupListResponseResultJson)
      if (!is.null(LinkageGroupListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(LinkageGroupListResponseResultObject$`data`, "array[LinkageGroup]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(LinkageGroupListResponseResultJson) {
      LinkageGroupListResponseResultObject <- jsonlite::fromJSON(LinkageGroupListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(LinkageGroupListResponseResultObject$`data`, "array[LinkageGroup]", loadNamespace("openapi"))
      self
    }
