...
#'
#' @description GermplasmOrigin Class
#'
...
#' @export
GermplasmOrigin <- R6::R6Class(
  'GermplasmOrigin',
  public = list(
    `coordinateUncertainty` = NULL,
    `coordinates` = NULL,
    initialize = function(
        `coordinateUncertainty`=NULL, `coordinates`=NULL, ...
    ) {
    ...
    toJSON = function() {
      GermplasmOriginObject <- list()
      if (!is.null(self$`coordinateUncertainty`)) {
        GermplasmOriginObject[['coordinateUncertainty']] <-
          self$`coordinateUncertainty`
      }
      if (!is.null(self$`coordinates`)) {
        GermplasmOriginObject[['coordinates']] <-
          self$`coordinates`$toJSON()
      }

      GermplasmOriginObject
    },
    fromJSON = function(GermplasmOriginJson) {
      GermplasmOriginObject <- jsonlite::fromJSON(GermplasmOriginJson)
      if (!is.null(GermplasmOriginObject$`coordinateUncertainty`)) {
        self$`coordinateUncertainty` <- GermplasmOriginObject$`coordinateUncertainty`
      }
      if (!is.null(GermplasmOriginObject$`coordinates`)) {
        coordinatesObject <- GeoJSON$new()
        coordinatesObject$fromJSON(jsonlite::toJSON(GermplasmOriginObject$coordinates, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(GermplasmOriginJson) {
      GermplasmOriginObject <- jsonlite::fromJSON(GermplasmOriginJson)
      self$`coordinateUncertainty` <- GermplasmOriginObject$`coordinateUncertainty`
      self$`coordinates` <- GeoJSON$new()$fromJSON(jsonlite::toJSON(GermplasmOriginObject$coordinates, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
