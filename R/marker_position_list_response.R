...
#'
#' @description MarkerPositionListResponse Class
#'
...
#'
#' @field result  \link{MarkerPositionListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
MarkerPositionListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      MarkerPositionListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        MarkerPositionListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        MarkerPositionListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        MarkerPositionListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      MarkerPositionListResponseObject
    },
    fromJSON = function(MarkerPositionListResponseJson) {
      MarkerPositionListResponseObject <- jsonlite::fromJSON(MarkerPositionListResponseJson)
      if (!is.null(MarkerPositionListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(MarkerPositionListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(MarkerPositionListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(MarkerPositionListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(MarkerPositionListResponseObject$`result`)) {
        resultObject <- MarkerPositionListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(MarkerPositionListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(MarkerPositionListResponseJson) {
      MarkerPositionListResponseObject <- jsonlite::fromJSON(MarkerPositionListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(MarkerPositionListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(MarkerPositionListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- MarkerPositionListResponseResult$new()$fromJSON(jsonlite::toJSON(MarkerPositionListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
