...
#'
#' @description VendorResultFileListResponse Class
#'
...
#'
#' @field result  \link{VendorResultFileListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VendorResultFileListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VendorResultFileListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        VendorResultFileListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        VendorResultFileListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        VendorResultFileListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      VendorResultFileListResponseObject
    },
    fromJSON = function(VendorResultFileListResponseJson) {
      VendorResultFileListResponseObject <- jsonlite::fromJSON(VendorResultFileListResponseJson)
      if (!is.null(VendorResultFileListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(VendorResultFileListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VendorResultFileListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(VendorResultFileListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(VendorResultFileListResponseObject$`result`)) {
        resultObject <- VendorResultFileListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(VendorResultFileListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(VendorResultFileListResponseJson) {
      VendorResultFileListResponseObject <- jsonlite::fromJSON(VendorResultFileListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(VendorResultFileListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(VendorResultFileListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- VendorResultFileListResponseResult$new()$fromJSON(jsonlite::toJSON(VendorResultFileListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
