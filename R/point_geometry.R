...
#' @title PointGeometry
#'
#' @description PointGeometry Class
#'
...
#' @export
PointGeometry <- R6::R6Class(
  'PointGeometry',
  public = list(
    `coordinates` = NULL,
    `type` = NULL,
    initialize = function(
        `coordinates`=NULL, `type`='Point', ...
    ) {
    ...
    toJSON = function() {
      PointGeometryObject <- list()
      if (!is.null(self$`coordinates`)) {
        PointGeometryObject[['coordinates']] <-
          self$`coordinates`
      }
      if (!is.null(self$`type`)) {
        PointGeometryObject[['type']] <-
          self$`type`
      }

      PointGeometryObject
    },
    fromJSON = function(PointGeometryJson) {
      PointGeometryObject <- jsonlite::fromJSON(PointGeometryJson)
      if (!is.null(PointGeometryObject$`coordinates`)) {
        self$`coordinates` <- ApiClient$new()$deserializeObj(PointGeometryObject$`coordinates`, "array[numeric]", loadNamespace("openapi"))
      }
      if (!is.null(PointGeometryObject$`type`)) {
        self$`type` <- PointGeometryObject$`type`
      }
      self
    },
    ...
    fromJSONString = function(PointGeometryJson) {
      PointGeometryObject <- jsonlite::fromJSON(PointGeometryJson)
      self$`coordinates` <- ApiClient$new()$deserializeObj(PointGeometryObject$`coordinates`, "array[numeric]", loadNamespace("openapi"))
      self$`type` <- PointGeometryObject$`type`
      self
