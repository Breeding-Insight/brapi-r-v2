...
#'
#' @description ObservationVariableListResponse Class
#'
...
#'
#' @field result  \link{ObservationVariableListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationVariableListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationVariableListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ObservationVariableListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ObservationVariableListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ObservationVariableListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ObservationVariableListResponseObject
    },
    fromJSON = function(ObservationVariableListResponseJson) {
      ObservationVariableListResponseObject <- jsonlite::fromJSON(ObservationVariableListResponseJson)
      if (!is.null(ObservationVariableListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ObservationVariableListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationVariableListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ObservationVariableListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ObservationVariableListResponseObject$`result`)) {
        resultObject <- ObservationVariableListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(ObservationVariableListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ObservationVariableListResponseJson) {
      ObservationVariableListResponseObject <- jsonlite::fromJSON(ObservationVariableListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ObservationVariableListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ObservationVariableListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ObservationVariableListResponseResult$new()$fromJSON(jsonlite::toJSON(ObservationVariableListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
