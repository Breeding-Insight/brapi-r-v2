...
#' @docType class
#' @title SearchRequestParametersStudies
#'
#' @description SearchRequestParametersStudies Class
#'
...
#' @export
SearchRequestParametersStudies <- R6::R6Class(
  'SearchRequestParametersStudies',
  public = list(
    `studyDbIds` = NULL,
    `studyNames` = NULL,
    initialize = function(
        `studyDbIds`=NULL, `studyNames`=NULL, ...
    ) {
    ...
    toJSON = function() {
      SearchRequestParametersStudiesObject <- list()
      if (!is.null(self$`studyDbIds`)) {
        SearchRequestParametersStudiesObject[['studyDbIds']] <-
          self$`studyDbIds`
      }
      if (!is.null(self$`studyNames`)) {
        SearchRequestParametersStudiesObject[['studyNames']] <-
          self$`studyNames`
      }

      SearchRequestParametersStudiesObject
    },
    fromJSON = function(SearchRequestParametersStudiesJson) {
      SearchRequestParametersStudiesObject <- jsonlite::fromJSON(SearchRequestParametersStudiesJson)
      if (!is.null(SearchRequestParametersStudiesObject$`studyDbIds`)) {
        self$`studyDbIds` <- ApiClient$new()$deserializeObj(SearchRequestParametersStudiesObject$`studyDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(SearchRequestParametersStudiesObject$`studyNames`)) {
        self$`studyNames` <- ApiClient$new()$deserializeObj(SearchRequestParametersStudiesObject$`studyNames`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(SearchRequestParametersStudiesJson) {
      SearchRequestParametersStudiesObject <- jsonlite::fromJSON(SearchRequestParametersStudiesJson)
      self$`studyDbIds` <- ApiClient$new()$deserializeObj(SearchRequestParametersStudiesObject$`studyDbIds`, "array[character]", loadNamespace("openapi"))
      self$`studyNames` <- ApiClient$new()$deserializeObj(SearchRequestParametersStudiesObject$`studyNames`, "array[character]", loadNamespace("openapi"))
      self
