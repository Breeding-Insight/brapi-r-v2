...
#' @docType class
#' @title ListNewRequestAllOf
#'
#' @description ListNewRequestAllOf Class
#'
...
#' @export
ListNewRequestAllOf <- R6::R6Class(
  'ListNewRequestAllOf',
  public = list(
    `data` = NULL,
    initialize = function(
    ...
    toJSON = function() {
      ListNewRequestAllOfObject <- list()
      if (!is.null(self$`data`)) {
        ListNewRequestAllOfObject[['data']] <-
          self$`data`
      }

      ListNewRequestAllOfObject
    },
    fromJSON = function(ListNewRequestAllOfJson) {
      ListNewRequestAllOfObject <- jsonlite::fromJSON(ListNewRequestAllOfJson)
      if (!is.null(ListNewRequestAllOfObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ListNewRequestAllOfObject$`data`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(ListNewRequestAllOfJson) {
      ListNewRequestAllOfObject <- jsonlite::fromJSON(ListNewRequestAllOfJson)
      self$`data` <- ApiClient$new()$deserializeObj(ListNewRequestAllOfObject$`data`, "array[character]", loadNamespace("openapi"))
      self
    }
