...
#' @docType class
#' @title 202AcceptedSearchResponseResult
#'
#' @description 202AcceptedSearchResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field searchResultsDbId  character [optional]
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
202AcceptedSearchResponseResult <- R6::R6Class(
  '202AcceptedSearchResponseResult',
  public = list(
    `searchResultsDbId` = NULL,
    initialize = function(
        `searchResultsDbId`=NULL, ...
    ) {
      local.optional.var <- list(...)
      if (!is.null(`searchResultsDbId`)) {
        stopifnot(is.character(`searchResultsDbId`), length(`searchResultsDbId`) == 1)
        self$`searchResultsDbId` <- `searchResultsDbId`
      }
    },
    toJSON = function() {
      202AcceptedSearchResponseResultObject <- list()
      if (!is.null(self$`searchResultsDbId`)) {
        202AcceptedSearchResponseResultObject[['searchResultsDbId']] <-
          self$`searchResultsDbId`
      }

      202AcceptedSearchResponseResultObject
    },
    fromJSON = function(202AcceptedSearchResponseResultJson) {
      202AcceptedSearchResponseResultObject <- jsonlite::fromJSON(202AcceptedSearchResponseResultJson)
      if (!is.null(202AcceptedSearchResponseResultObject$`searchResultsDbId`)) {
        self$`searchResultsDbId` <- 202AcceptedSearchResponseResultObject$`searchResultsDbId`
      }
      self
    },
    ...
    fromJSONString = function(202AcceptedSearchResponseResultJson) {
      202AcceptedSearchResponseResultObject <- jsonlite::fromJSON(202AcceptedSearchResponseResultJson)
      self$`searchResultsDbId` <- 202AcceptedSearchResponseResultObject$`searchResultsDbId`
      self
    }
