...
#' @docType class
#' @title VendorPlateSubmissionRequest
#'
#' @description VendorPlateSubmissionRequest Class
#'
...
#' @export
VendorPlateSubmissionRequest <- R6::R6Class(
  ...
  public = list(
    ...
    `sampleType` = NULL,
    initialize = function(
        `clientId`, `numberOfSamples`, `plates`, `sampleType`, ...
    ) {
    ...
    toJSON = function() {
      VendorPlateSubmissionRequestObject <- list()
      if (!is.null(self$`clientId`)) {
        VendorPlateSubmissionRequestObject[['clientId']] <-
          self$`clientId`
      }
      if (!is.null(self$`numberOfSamples`)) {
        VendorPlateSubmissionRequestObject[['numberOfSamples']] <-
          self$`numberOfSamples`
      }
      if (!is.null(self$`plates`)) {
        VendorPlateSubmissionRequestObject[['plates']] <-
          lapply(self$`plates`, function(x) x$toJSON())
      }
      if (!is.null(self$`sampleType`)) {
        VendorPlateSubmissionRequestObject[['sampleType']] <-
          self$`sampleType`
      }

      VendorPlateSubmissionRequestObject
    },
    fromJSON = function(VendorPlateSubmissionRequestJson) {
      VendorPlateSubmissionRequestObject <- jsonlite::fromJSON(VendorPlateSubmissionRequestJson)
      if (!is.null(VendorPlateSubmissionRequestObject$`clientId`)) {
        self$`clientId` <- VendorPlateSubmissionRequestObject$`clientId`
      }
      if (!is.null(VendorPlateSubmissionRequestObject$`numberOfSamples`)) {
        self$`numberOfSamples` <- VendorPlateSubmissionRequestObject$`numberOfSamples`
      }
      if (!is.null(VendorPlateSubmissionRequestObject$`plates`)) {
        self$`plates` <- ApiClient$new()$deserializeObj(VendorPlateSubmissionRequestObject$`plates`, "array[VendorPlateSubmissionRequestPlates]", loadNamespace("openapi"))
      }
      if (!is.null(VendorPlateSubmissionRequestObject$`sampleType`)) {
        self$`sampleType` <- VendorPlateSubmissionRequestObject$`sampleType`
      }
      self
    },
...
',
    ...
    fromJSONString = function(VendorPlateSubmissionRequestJson) {
      VendorPlateSubmissionRequestObject <- jsonlite::fromJSON(VendorPlateSubmissionRequestJson)
      self$`clientId` <- VendorPlateSubmissionRequestObject$`clientId`
      self$`numberOfSamples` <- VendorPlateSubmissionRequestObject$`numberOfSamples`
      self$`plates` <- ApiClient$new()$deserializeObj(VendorPlateSubmissionRequestObject$`plates`, "array[VendorPlateSubmissionRequestPlates]", loadNamespace("openapi"))
