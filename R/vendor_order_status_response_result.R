...
#' @docType class
#' @title VendorOrderStatusResponseResult
#'
#' @description VendorOrderStatusResponseResult Class
#'
...
#' @export
VendorOrderStatusResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VendorOrderStatusResponseResultObject <- list()
      if (!is.null(self$`status`)) {
        VendorOrderStatusResponseResultObject[['status']] <-
          self$`status`
      }

      VendorOrderStatusResponseResultObject
    },
    fromJSON = function(VendorOrderStatusResponseResultJson) {
      VendorOrderStatusResponseResultObject <- jsonlite::fromJSON(VendorOrderStatusResponseResultJson)
      if (!is.null(VendorOrderStatusResponseResultObject$`status`)) {
        self$`status` <- VendorOrderStatusResponseResultObject$`status`
      }
      self
    },
    ...
    fromJSONString = function(VendorOrderStatusResponseResultJson) {
      VendorOrderStatusResponseResultObject <- jsonlite::fromJSON(VendorOrderStatusResponseResultJson)
      self$`status` <- VendorOrderStatusResponseResultObject$`status`
      self
    }
