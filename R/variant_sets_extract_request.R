...
#' @docType class
#' @title VariantSetsExtractRequest
#'
#' @description VariantSetsExtractRequest Class
#'
...
#' @export
VariantSetsExtractRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(
        `studyDbIds`=NULL, `studyNames`=NULL, `callSetDbIds`=NULL, `expandHomozygotes`=NULL, `sepPhased`=NULL, `sepUnphased`=NULL, `unknownString`=NULL, `variantDbIds`=NULL, `variantSetDbIds`=NULL, ...
    ) {
    ...
    toJSON = function() {
      VariantSetsExtractRequestObject <- list()
      if (!is.null(self$`studyDbIds`)) {
        VariantSetsExtractRequestObject[['studyDbIds']] <-
          self$`studyDbIds`
      }
      if (!is.null(self$`studyNames`)) {
        VariantSetsExtractRequestObject[['studyNames']] <-
          self$`studyNames`
      }
      if (!is.null(self$`callSetDbIds`)) {
        VariantSetsExtractRequestObject[['callSetDbIds']] <-
          self$`callSetDbIds`
      }
      if (!is.null(self$`expandHomozygotes`)) {
        VariantSetsExtractRequestObject[['expandHomozygotes']] <-
          self$`expandHomozygotes`
      }
      if (!is.null(self$`sepPhased`)) {
        VariantSetsExtractRequestObject[['sepPhased']] <-
          self$`sepPhased`
      }
      if (!is.null(self$`sepUnphased`)) {
        VariantSetsExtractRequestObject[['sepUnphased']] <-
          self$`sepUnphased`
      }
      if (!is.null(self$`unknownString`)) {
        VariantSetsExtractRequestObject[['unknownString']] <-
          self$`unknownString`
      }
      if (!is.null(self$`variantDbIds`)) {
        VariantSetsExtractRequestObject[['variantDbIds']] <-
          self$`variantDbIds`
      }
      if (!is.null(self$`variantSetDbIds`)) {
        VariantSetsExtractRequestObject[['variantSetDbIds']] <-
          self$`variantSetDbIds`
      }

      VariantSetsExtractRequestObject
    },
    fromJSON = function(VariantSetsExtractRequestJson) {
      VariantSetsExtractRequestObject <- jsonlite::fromJSON(VariantSetsExtractRequestJson)
      if (!is.null(VariantSetsExtractRequestObject$`studyDbIds`)) {
        self$`studyDbIds` <- ApiClient$new()$deserializeObj(VariantSetsExtractRequestObject$`studyDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsExtractRequestObject$`studyNames`)) {
        self$`studyNames` <- ApiClient$new()$deserializeObj(VariantSetsExtractRequestObject$`studyNames`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsExtractRequestObject$`callSetDbIds`)) {
        self$`callSetDbIds` <- ApiClient$new()$deserializeObj(VariantSetsExtractRequestObject$`callSetDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsExtractRequestObject$`expandHomozygotes`)) {
        self$`expandHomozygotes` <- VariantSetsExtractRequestObject$`expandHomozygotes`
      }
      if (!is.null(VariantSetsExtractRequestObject$`sepPhased`)) {
        self$`sepPhased` <- VariantSetsExtractRequestObject$`sepPhased`
      }
      if (!is.null(VariantSetsExtractRequestObject$`sepUnphased`)) {
        self$`sepUnphased` <- VariantSetsExtractRequestObject$`sepUnphased`
      }
      if (!is.null(VariantSetsExtractRequestObject$`unknownString`)) {
        self$`unknownString` <- VariantSetsExtractRequestObject$`unknownString`
      }
      if (!is.null(VariantSetsExtractRequestObject$`variantDbIds`)) {
        self$`variantDbIds` <- ApiClient$new()$deserializeObj(VariantSetsExtractRequestObject$`variantDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsExtractRequestObject$`variantSetDbIds`)) {
        self$`variantSetDbIds` <- ApiClient$new()$deserializeObj(VariantSetsExtractRequestObject$`variantSetDbIds`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(VariantSetsExtractRequestJson) {
      VariantSetsExtractRequestObject <- jsonlite::fromJSON(VariantSetsExtractRequestJson)
      self$`studyDbIds` <- ApiClient$new()$deserializeObj(VariantSetsExtractRequestObject$`studyDbIds`, "array[character]", loadNamespace("openapi"))
      self$`studyNames` <- ApiClient$new()$deserializeObj(VariantSetsExtractRequestObject$`studyNames`, "array[character]", loadNamespace("openapi"))
      self$`callSetDbIds` <- ApiClient$new()$deserializeObj(VariantSetsExtractRequestObject$`callSetDbIds`, "array[character]", loadNamespace("openapi"))
