...
#'
#' @description SeedLotTransactionListResponse Class
#'
...
#'
#' @field result  \link{SeedLotTransactionListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SeedLotTransactionListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SeedLotTransactionListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        SeedLotTransactionListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        SeedLotTransactionListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        SeedLotTransactionListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      SeedLotTransactionListResponseObject
    },
    fromJSON = function(SeedLotTransactionListResponseJson) {
      SeedLotTransactionListResponseObject <- jsonlite::fromJSON(SeedLotTransactionListResponseJson)
      if (!is.null(SeedLotTransactionListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(SeedLotTransactionListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(SeedLotTransactionListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(SeedLotTransactionListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(SeedLotTransactionListResponseObject$`result`)) {
        resultObject <- SeedLotTransactionListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(SeedLotTransactionListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(SeedLotTransactionListResponseJson) {
      SeedLotTransactionListResponseObject <- jsonlite::fromJSON(SeedLotTransactionListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(SeedLotTransactionListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(SeedLotTransactionListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- SeedLotTransactionListResponseResult$new()$fromJSON(jsonlite::toJSON(SeedLotTransactionListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
