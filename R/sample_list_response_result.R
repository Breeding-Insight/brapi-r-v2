...
#' @docType class
#' @title SampleListResponseResult
#'
#' @description SampleListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Sample} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SampleListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SampleListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        SampleListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      SampleListResponseResultObject
    },
    fromJSON = function(SampleListResponseResultJson) {
      SampleListResponseResultObject <- jsonlite::fromJSON(SampleListResponseResultJson)
      if (!is.null(SampleListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(SampleListResponseResultObject$`data`, "array[Sample]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(SampleListResponseResultJson) {
      SampleListResponseResultObject <- jsonlite::fromJSON(SampleListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(SampleListResponseResultObject$`data`, "array[Sample]", loadNamespace("openapi"))
      self
    }
