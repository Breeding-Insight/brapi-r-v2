...
#' @docType class
#' @title OntologyReferenceDocumentationLinks
#'
#' @description OntologyReferenceDocumentationLinks Class
#'
...
#' @export
OntologyReferenceDocumentationLinks <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      OntologyReferenceDocumentationLinksObject <- list()
      if (!is.null(self$`URL`)) {
        OntologyReferenceDocumentationLinksObject[['URL']] <-
          self$`URL`
      }
      if (!is.null(self$`type`)) {
        OntologyReferenceDocumentationLinksObject[['type']] <-
          self$`type`
      }

      OntologyReferenceDocumentationLinksObject
    },
    fromJSON = function(OntologyReferenceDocumentationLinksJson) {
      OntologyReferenceDocumentationLinksObject <- jsonlite::fromJSON(OntologyReferenceDocumentationLinksJson)
      if (!is.null(OntologyReferenceDocumentationLinksObject$`URL`)) {
        self$`URL` <- OntologyReferenceDocumentationLinksObject$`URL`
      }
      if (!is.null(OntologyReferenceDocumentationLinksObject$`type`)) {
        self$`type` <- OntologyReferenceDocumentationLinksObject$`type`
      }
      self
    },
    ...
    fromJSONString = function(OntologyReferenceDocumentationLinksJson) {
      OntologyReferenceDocumentationLinksObject <- jsonlite::fromJSON(OntologyReferenceDocumentationLinksJson)
      self$`URL` <- OntologyReferenceDocumentationLinksObject$`URL`
      self$`type` <- OntologyReferenceDocumentationLinksObject$`type`
      self
