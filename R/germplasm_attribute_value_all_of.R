...
#' @docType class
#' @title GermplasmAttributeValueAllOf
#'
#' @description GermplasmAttributeValueAllOf Class
#'
...
#' @export
GermplasmAttributeValueAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmAttributeValueAllOfObject <- list()
      if (!is.null(self$`attributeValueDbId`)) {
        GermplasmAttributeValueAllOfObject[['attributeValueDbId']] <-
          self$`attributeValueDbId`
      }

      GermplasmAttributeValueAllOfObject
    },
    fromJSON = function(GermplasmAttributeValueAllOfJson) {
      GermplasmAttributeValueAllOfObject <- jsonlite::fromJSON(GermplasmAttributeValueAllOfJson)
      if (!is.null(GermplasmAttributeValueAllOfObject$`attributeValueDbId`)) {
        self$`attributeValueDbId` <- GermplasmAttributeValueAllOfObject$`attributeValueDbId`
      }
      self
    },
    ...
    fromJSONString = function(GermplasmAttributeValueAllOfJson) {
      GermplasmAttributeValueAllOfObject <- jsonlite::fromJSON(GermplasmAttributeValueAllOfJson)
      self$`attributeValueDbId` <- GermplasmAttributeValueAllOfObject$`attributeValueDbId`
      self
    }
