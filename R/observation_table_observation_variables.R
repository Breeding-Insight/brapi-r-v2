...
#' @docType class
#' @title ObservationTableObservationVariables
#'
#' @description ObservationTableObservationVariables Class
#'
...
#' @export
ObservationTableObservationVariables <- R6::R6Class(
  'ObservationTableObservationVariables',
  public = list(
    `observationVariableDbId` = NULL,
    `observationVariableName` = NULL,
    initialize = function(
        `observationVariableDbId`=NULL, `observationVariableName`=NULL, ...
    ) {
    ...
    toJSON = function() {
      ObservationTableObservationVariablesObject <- list()
      if (!is.null(self$`observationVariableDbId`)) {
        ObservationTableObservationVariablesObject[['observationVariableDbId']] <-
          self$`observationVariableDbId`
      }
      if (!is.null(self$`observationVariableName`)) {
        ObservationTableObservationVariablesObject[['observationVariableName']] <-
          self$`observationVariableName`
      }

      ObservationTableObservationVariablesObject
    },
    fromJSON = function(ObservationTableObservationVariablesJson) {
      ObservationTableObservationVariablesObject <- jsonlite::fromJSON(ObservationTableObservationVariablesJson)
      if (!is.null(ObservationTableObservationVariablesObject$`observationVariableDbId`)) {
        self$`observationVariableDbId` <- ObservationTableObservationVariablesObject$`observationVariableDbId`
      }
      if (!is.null(ObservationTableObservationVariablesObject$`observationVariableName`)) {
        self$`observationVariableName` <- ObservationTableObservationVariablesObject$`observationVariableName`
      }
      self
    },
    ...
    fromJSONString = function(ObservationTableObservationVariablesJson) {
      ObservationTableObservationVariablesObject <- jsonlite::fromJSON(ObservationTableObservationVariablesJson)
      self$`observationVariableDbId` <- ObservationTableObservationVariablesObject$`observationVariableDbId`
      self$`observationVariableName` <- ObservationTableObservationVariablesObject$`observationVariableName`
      self
