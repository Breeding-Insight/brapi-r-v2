...
#' @docType class
#' @title TraitListResponseResult
#'
#' @description TraitListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Trait} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
TraitListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      TraitListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        TraitListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      TraitListResponseResultObject
    },
    fromJSON = function(TraitListResponseResultJson) {
      TraitListResponseResultObject <- jsonlite::fromJSON(TraitListResponseResultJson)
      if (!is.null(TraitListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(TraitListResponseResultObject$`data`, "array[Trait]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(TraitListResponseResultJson) {
      TraitListResponseResultObject <- jsonlite::fromJSON(TraitListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(TraitListResponseResultObject$`data`, "array[Trait]", loadNamespace("openapi"))
      self
    }
