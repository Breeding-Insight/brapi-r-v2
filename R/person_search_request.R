...
#'
#' @description PersonSearchRequest Class
#'
...
#' @export
PersonSearchRequest <- R6::R6Class(
  'PersonSearchRequest',
  public = list(
    `page` = NULL,
    `pageSize` = NULL,
    ...
    `userIDs` = NULL,
    initialize = function(
        `page`=NULL, `pageSize`=NULL, `externalReferenceIDs`=NULL, `externalReferenceSources`=NULL, `emailAddresses`=NULL, `firstNames`=NULL, `lastNames`=NULL, `mailingAddresses`=NULL, `middleNames`=NULL, `personDbIds`=NULL, `phoneNumbers`=NULL, `userIDs`=NULL, ...
    ) {
    ...
    toJSON = function() {
      PersonSearchRequestObject <- list()
      if (!is.null(self$`page`)) {
        PersonSearchRequestObject[['page']] <-
          self$`page`
      }
      if (!is.null(self$`pageSize`)) {
        PersonSearchRequestObject[['pageSize']] <-
          self$`pageSize`
      }
      if (!is.null(self$`externalReferenceIDs`)) {
        PersonSearchRequestObject[['externalReferenceIDs']] <-
          self$`externalReferenceIDs`
      }
      if (!is.null(self$`externalReferenceSources`)) {
        PersonSearchRequestObject[['externalReferenceSources']] <-
          self$`externalReferenceSources`
      }
      if (!is.null(self$`emailAddresses`)) {
        PersonSearchRequestObject[['emailAddresses']] <-
          self$`emailAddresses`
      }
      if (!is.null(self$`firstNames`)) {
        PersonSearchRequestObject[['firstNames']] <-
          self$`firstNames`
      }
      if (!is.null(self$`lastNames`)) {
        PersonSearchRequestObject[['lastNames']] <-
          self$`lastNames`
      }
      if (!is.null(self$`mailingAddresses`)) {
        PersonSearchRequestObject[['mailingAddresses']] <-
          self$`mailingAddresses`
      }
      if (!is.null(self$`middleNames`)) {
        PersonSearchRequestObject[['middleNames']] <-
          self$`middleNames`
      }
      if (!is.null(self$`personDbIds`)) {
        PersonSearchRequestObject[['personDbIds']] <-
          self$`personDbIds`
      }
      if (!is.null(self$`phoneNumbers`)) {
        PersonSearchRequestObject[['phoneNumbers']] <-
          self$`phoneNumbers`
      }
      if (!is.null(self$`userIDs`)) {
        PersonSearchRequestObject[['userIDs']] <-
          self$`userIDs`
      }

      PersonSearchRequestObject
    },
    fromJSON = function(PersonSearchRequestJson) {
      PersonSearchRequestObject <- jsonlite::fromJSON(PersonSearchRequestJson)
      if (!is.null(PersonSearchRequestObject$`page`)) {
        self$`page` <- PersonSearchRequestObject$`page`
      }
      if (!is.null(PersonSearchRequestObject$`pageSize`)) {
        self$`pageSize` <- PersonSearchRequestObject$`pageSize`
      }
      if (!is.null(PersonSearchRequestObject$`externalReferenceIDs`)) {
        self$`externalReferenceIDs` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`externalReferenceIDs`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(PersonSearchRequestObject$`externalReferenceSources`)) {
        self$`externalReferenceSources` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`externalReferenceSources`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(PersonSearchRequestObject$`emailAddresses`)) {
        self$`emailAddresses` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`emailAddresses`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(PersonSearchRequestObject$`firstNames`)) {
        self$`firstNames` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`firstNames`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(PersonSearchRequestObject$`lastNames`)) {
        self$`lastNames` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`lastNames`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(PersonSearchRequestObject$`mailingAddresses`)) {
        self$`mailingAddresses` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`mailingAddresses`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(PersonSearchRequestObject$`middleNames`)) {
        self$`middleNames` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`middleNames`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(PersonSearchRequestObject$`personDbIds`)) {
        self$`personDbIds` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`personDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(PersonSearchRequestObject$`phoneNumbers`)) {
        self$`phoneNumbers` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`phoneNumbers`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(PersonSearchRequestObject$`userIDs`)) {
        self$`userIDs` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`userIDs`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(PersonSearchRequestJson) {
      PersonSearchRequestObject <- jsonlite::fromJSON(PersonSearchRequestJson)
      self$`page` <- PersonSearchRequestObject$`page`
      self$`pageSize` <- PersonSearchRequestObject$`pageSize`
      self$`externalReferenceIDs` <- ApiClient$new()$deserializeObj(PersonSearchRequestObject$`externalReferenceIDs`, "array[character]", loadNamespace("openapi"))
