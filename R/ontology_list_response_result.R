...
#' @docType class
#' @title OntologyListResponseResult
#'
#' @description OntologyListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Ontology} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
OntologyListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      OntologyListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        OntologyListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      OntologyListResponseResultObject
    },
    fromJSON = function(OntologyListResponseResultJson) {
      OntologyListResponseResultObject <- jsonlite::fromJSON(OntologyListResponseResultJson)
      if (!is.null(OntologyListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(OntologyListResponseResultObject$`data`, "array[Ontology]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(OntologyListResponseResultJson) {
      OntologyListResponseResultObject <- jsonlite::fromJSON(OntologyListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(OntologyListResponseResultObject$`data`, "array[Ontology]", loadNamespace("openapi"))
      self
    }
