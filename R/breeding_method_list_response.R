...
#'
#' @description BreedingMethodListResponse Class
#'
...
#'
#' @field result  \link{BreedingMethodListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
BreedingMethodListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      BreedingMethodListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        BreedingMethodListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        BreedingMethodListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        BreedingMethodListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      BreedingMethodListResponseObject
    },
    fromJSON = function(BreedingMethodListResponseJson) {
      BreedingMethodListResponseObject <- jsonlite::fromJSON(BreedingMethodListResponseJson)
      if (!is.null(BreedingMethodListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(BreedingMethodListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(BreedingMethodListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(BreedingMethodListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(BreedingMethodListResponseObject$`result`)) {
        resultObject <- BreedingMethodListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(BreedingMethodListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(BreedingMethodListResponseJson) {
      BreedingMethodListResponseObject <- jsonlite::fromJSON(BreedingMethodListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(BreedingMethodListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(BreedingMethodListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- BreedingMethodListResponseResult$new()$fromJSON(jsonlite::toJSON(BreedingMethodListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
