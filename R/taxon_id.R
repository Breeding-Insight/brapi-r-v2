  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`sourceName`)) {
        TaxonIDObject[['sourceName']] <-
          self$`sourceName`
      }
      if (!is.null(self$`taxonId`)) {
        TaxonIDObject[['taxonId']] <-
          self$`taxonId`
      }

      TaxonIDObject
    },
    fromJSON = function(TaxonIDJson) {
      TaxonIDObject <- jsonlite::fromJSON(TaxonIDJson)
      if (!is.null(TaxonIDObject$`sourceName`)) {
        self$`sourceName` <- TaxonIDObject$`sourceName`
      }
      if (!is.null(TaxonIDObject$`taxonId`)) {
        self$`taxonId` <- TaxonIDObject$`taxonId`
      }
      self
    },
    ...
    fromJSONString = function(TaxonIDJson) {
      TaxonIDObject <- jsonlite::fromJSON(TaxonIDJson)
      self$`sourceName` <- TaxonIDObject$`sourceName`
      self$`taxonId` <- TaxonIDObject$`taxonId`
      self
