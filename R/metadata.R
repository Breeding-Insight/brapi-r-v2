...
#'
#' @field pagination  \link{IndexPagination} [optional]
#'
  ...
  public = list(
    ...
    fromJSON = function(MetadataJson) {
      ...
      if (!is.null(MetadataObject$`datafiles`)) {
        self$`datafiles` <- ApiClient$new()$deserializeObj(MetadataObject$`datafiles`, "array[DataFile]", loadNamespace("openapi"))
      }
      if (!is.null(MetadataObject$`status`)) {
        self$`status` <- ApiClient$new()$deserializeObj(MetadataObject$`status`, "array[Status]", loadNamespace("openapi"))
      }
      if (!is.null(MetadataObject$`pagination`)) {
        paginationObject <- IndexPagination$new()
        paginationObject$fromJSON(jsonlite::toJSON(MetadataObject$pagination, auto_unbox = TRUE, digits = NA))
...
',
    ...
    fromJSONString = function(MetadataJson) {
      ...
      self$`datafiles` <- ApiClient$new()$deserializeObj(MetadataObject$`datafiles`, "array[DataFile]", loadNamespace("openapi"))
      self$`status` <- ApiClient$new()$deserializeObj(MetadataObject$`status`, "array[Status]", loadNamespace("openapi"))
      self$`pagination` <- IndexPagination$new()$fromJSON(jsonlite::toJSON(MetadataObject$pagination, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
