...
#'
#' @description PlannedCrossesListResponse Class
#'
...
#'
#' @field result  \link{PlannedCrossesListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PlannedCrossesListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      PlannedCrossesListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        PlannedCrossesListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        PlannedCrossesListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        PlannedCrossesListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      PlannedCrossesListResponseObject
    },
    fromJSON = function(PlannedCrossesListResponseJson) {
      PlannedCrossesListResponseObject <- jsonlite::fromJSON(PlannedCrossesListResponseJson)
      if (!is.null(PlannedCrossesListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(PlannedCrossesListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(PlannedCrossesListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(PlannedCrossesListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(PlannedCrossesListResponseObject$`result`)) {
        resultObject <- PlannedCrossesListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(PlannedCrossesListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(PlannedCrossesListResponseJson) {
      PlannedCrossesListResponseObject <- jsonlite::fromJSON(PlannedCrossesListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(PlannedCrossesListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(PlannedCrossesListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- PlannedCrossesListResponseResult$new()$fromJSON(jsonlite::toJSON(PlannedCrossesListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
