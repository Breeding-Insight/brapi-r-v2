...
#'
#' @description ObservationTableResponse Class
#'
...
#'
#' @field result  \link{ObservationTable} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationTableResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationTableResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ObservationTableResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ObservationTableResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ObservationTableResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ObservationTableResponseObject
    },
    fromJSON = function(ObservationTableResponseJson) {
      ObservationTableResponseObject <- jsonlite::fromJSON(ObservationTableResponseJson)
      if (!is.null(ObservationTableResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ObservationTableResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationTableResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ObservationTableResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ObservationTableResponseObject$`result`)) {
        resultObject <- ObservationTable$new()
        resultObject$fromJSON(jsonlite::toJSON(ObservationTableResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ObservationTableResponseJson) {
      ObservationTableResponseObject <- jsonlite::fromJSON(ObservationTableResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ObservationTableResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ObservationTableResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ObservationTable$new()$fromJSON(jsonlite::toJSON(ObservationTableResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
