...
#'
#' @description LinkageGroupListResponse Class
#'
...
#'
#' @field result  \link{LinkageGroupListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
LinkageGroupListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      LinkageGroupListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        LinkageGroupListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        LinkageGroupListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        LinkageGroupListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      LinkageGroupListResponseObject
    },
    fromJSON = function(LinkageGroupListResponseJson) {
      LinkageGroupListResponseObject <- jsonlite::fromJSON(LinkageGroupListResponseJson)
      if (!is.null(LinkageGroupListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(LinkageGroupListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(LinkageGroupListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(LinkageGroupListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(LinkageGroupListResponseObject$`result`)) {
        resultObject <- LinkageGroupListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(LinkageGroupListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(LinkageGroupListResponseJson) {
      LinkageGroupListResponseObject <- jsonlite::fromJSON(LinkageGroupListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(LinkageGroupListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(LinkageGroupListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- LinkageGroupListResponseResult$new()$fromJSON(jsonlite::toJSON(LinkageGroupListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
