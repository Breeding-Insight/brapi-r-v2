...
#' @docType class
#' @title VariantSetAvailableFormats
#'
#' @description VariantSetAvailableFormats Class
#'
...
#'
#' @field fileURL  character [optional]
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VariantSetAvailableFormats <- R6::R6Class(
  ...
  public = list(
    ...
    `fileURL` = NULL,
    initialize = function(
        `dataFormat`=NULL, `fileFormat`=NULL, `fileURL`=NULL, ...
    ) {
    ...
    toJSON = function() {
      VariantSetAvailableFormatsObject <- list()
      if (!is.null(self$`dataFormat`)) {
        VariantSetAvailableFormatsObject[['dataFormat']] <-
          self$`dataFormat`
      }
      if (!is.null(self$`fileFormat`)) {
        VariantSetAvailableFormatsObject[['fileFormat']] <-
          self$`fileFormat`
      }
      if (!is.null(self$`fileURL`)) {
        VariantSetAvailableFormatsObject[['fileURL']] <-
          self$`fileURL`
      }

      VariantSetAvailableFormatsObject
    },
    fromJSON = function(VariantSetAvailableFormatsJson) {
      VariantSetAvailableFormatsObject <- jsonlite::fromJSON(VariantSetAvailableFormatsJson)
      if (!is.null(VariantSetAvailableFormatsObject$`dataFormat`)) {
        self$`dataFormat` <- VariantSetAvailableFormatsObject$`dataFormat`
      }
      if (!is.null(VariantSetAvailableFormatsObject$`fileFormat`)) {
        self$`fileFormat` <- VariantSetAvailableFormatsObject$`fileFormat`
      }
      if (!is.null(VariantSetAvailableFormatsObject$`fileURL`)) {
        self$`fileURL` <- VariantSetAvailableFormatsObject$`fileURL`
      }
      self
    },
    ...
    fromJSONString = function(VariantSetAvailableFormatsJson) {
      VariantSetAvailableFormatsObject <- jsonlite::fromJSON(VariantSetAvailableFormatsJson)
      self$`dataFormat` <- VariantSetAvailableFormatsObject$`dataFormat`
      self$`fileFormat` <- VariantSetAvailableFormatsObject$`fileFormat`
      self$`fileURL` <- VariantSetAvailableFormatsObject$`fileURL`
