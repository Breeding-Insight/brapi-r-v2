...
#' @docType class
#' @title GenomeMapListResponseResult
#'
#' @description GenomeMapListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{GenomeMap} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GenomeMapListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GenomeMapListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        GenomeMapListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      GenomeMapListResponseResultObject
    },
    fromJSON = function(GenomeMapListResponseResultJson) {
      GenomeMapListResponseResultObject <- jsonlite::fromJSON(GenomeMapListResponseResultJson)
      if (!is.null(GenomeMapListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(GenomeMapListResponseResultObject$`data`, "array[GenomeMap]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(GenomeMapListResponseResultJson) {
      GenomeMapListResponseResultObject <- jsonlite::fromJSON(GenomeMapListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(GenomeMapListResponseResultObject$`data`, "array[GenomeMap]", loadNamespace("openapi"))
      self
    }
