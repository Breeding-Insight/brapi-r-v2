...
#' @docType class
#' @title CommonCropNamesResponseResult
#'
#' @description CommonCropNamesResponseResult Class
#'
...
#' @export
CommonCropNamesResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CommonCropNamesResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        CommonCropNamesResponseResultObject[['data']] <-
          self$`data`
      }

      CommonCropNamesResponseResultObject
    },
    fromJSON = function(CommonCropNamesResponseResultJson) {
      CommonCropNamesResponseResultObject <- jsonlite::fromJSON(CommonCropNamesResponseResultJson)
      if (!is.null(CommonCropNamesResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(CommonCropNamesResponseResultObject$`data`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(CommonCropNamesResponseResultJson) {
      CommonCropNamesResponseResultObject <- jsonlite::fromJSON(CommonCropNamesResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(CommonCropNamesResponseResultObject$`data`, "array[character]", loadNamespace("openapi"))
      self
    }
