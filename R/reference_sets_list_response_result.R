...
#'
#' @description ReferenceSetsListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{ReferenceSet} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ReferenceSetsListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ReferenceSetsListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        ReferenceSetsListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      ReferenceSetsListResponseResultObject
    },
    fromJSON = function(ReferenceSetsListResponseResultJson) {
      ReferenceSetsListResponseResultObject <- jsonlite::fromJSON(ReferenceSetsListResponseResultJson)
      if (!is.null(ReferenceSetsListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ReferenceSetsListResponseResultObject$`data`, "array[ReferenceSet]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ReferenceSetsListResponseResultJson) {
      ReferenceSetsListResponseResultObject <- jsonlite::fromJSON(ReferenceSetsListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(ReferenceSetsListResponseResultObject$`data`, "array[ReferenceSet]", loadNamespace("openapi"))
      self
    }
