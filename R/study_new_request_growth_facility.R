...
#' @docType class
#' @title StudyNewRequestGrowthFacility
#'
#' @description StudyNewRequestGrowthFacility Class
#'
...
#' @export
StudyNewRequestGrowthFacility <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      StudyNewRequestGrowthFacilityObject <- list()
      if (!is.null(self$`PUI`)) {
        StudyNewRequestGrowthFacilityObject[['PUI']] <-
          self$`PUI`
      }
      if (!is.null(self$`description`)) {
        StudyNewRequestGrowthFacilityObject[['description']] <-
          self$`description`
      }

      StudyNewRequestGrowthFacilityObject
    },
    fromJSON = function(StudyNewRequestGrowthFacilityJson) {
      StudyNewRequestGrowthFacilityObject <- jsonlite::fromJSON(StudyNewRequestGrowthFacilityJson)
      if (!is.null(StudyNewRequestGrowthFacilityObject$`PUI`)) {
        self$`PUI` <- StudyNewRequestGrowthFacilityObject$`PUI`
      }
      if (!is.null(StudyNewRequestGrowthFacilityObject$`description`)) {
        self$`description` <- StudyNewRequestGrowthFacilityObject$`description`
      }
      self
    },
    ...
    fromJSONString = function(StudyNewRequestGrowthFacilityJson) {
      StudyNewRequestGrowthFacilityObject <- jsonlite::fromJSON(StudyNewRequestGrowthFacilityJson)
      self$`PUI` <- StudyNewRequestGrowthFacilityObject$`PUI`
      self$`description` <- StudyNewRequestGrowthFacilityObject$`description`
      self
