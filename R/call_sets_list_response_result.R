...
#'
#' @description CallSetsListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{CallSet} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
CallSetsListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CallSetsListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        CallSetsListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      CallSetsListResponseResultObject
    },
    fromJSON = function(CallSetsListResponseResultJson) {
      CallSetsListResponseResultObject <- jsonlite::fromJSON(CallSetsListResponseResultJson)
      if (!is.null(CallSetsListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(CallSetsListResponseResultObject$`data`, "array[CallSet]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(CallSetsListResponseResultJson) {
      CallSetsListResponseResultObject <- jsonlite::fromJSON(CallSetsListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(CallSetsListResponseResultObject$`data`, "array[CallSet]", loadNamespace("openapi"))
      self
    }
