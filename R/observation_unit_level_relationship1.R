...
#' @docType class
#' @title ObservationUnitLevelRelationship1
#'
#' @description ObservationUnitLevelRelationship1 Class
#'
...
#' @export
ObservationUnitLevelRelationship1 <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationUnitLevelRelationship1Object <- list()
      if (!is.null(self$`levelCode`)) {
        ObservationUnitLevelRelationship1Object[['levelCode']] <-
          self$`levelCode`
      }

      ObservationUnitLevelRelationship1Object
    },
    fromJSON = function(ObservationUnitLevelRelationship1Json) {
      ObservationUnitLevelRelationship1Object <- jsonlite::fromJSON(ObservationUnitLevelRelationship1Json)
      if (!is.null(ObservationUnitLevelRelationship1Object$`levelCode`)) {
        self$`levelCode` <- ObservationUnitLevelRelationship1Object$`levelCode`
      }
      self
    },
    ...
    fromJSONString = function(ObservationUnitLevelRelationship1Json) {
      ObservationUnitLevelRelationship1Object <- jsonlite::fromJSON(ObservationUnitLevelRelationship1Json)
      self$`levelCode` <- ObservationUnitLevelRelationship1Object$`levelCode`
      self
    }
