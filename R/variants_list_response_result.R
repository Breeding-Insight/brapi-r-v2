...
#'
#' @description VariantsListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Variant} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VariantsListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VariantsListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        VariantsListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      VariantsListResponseResultObject
    },
    fromJSON = function(VariantsListResponseResultJson) {
      VariantsListResponseResultObject <- jsonlite::fromJSON(VariantsListResponseResultJson)
      if (!is.null(VariantsListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(VariantsListResponseResultObject$`data`, "array[Variant]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(VariantsListResponseResultJson) {
      VariantsListResponseResultObject <- jsonlite::fromJSON(VariantsListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(VariantsListResponseResultObject$`data`, "array[Variant]", loadNamespace("openapi"))
      self
    }
