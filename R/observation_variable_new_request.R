...
#' @docType class
#' @title ObservationVariableNewRequest
#'
#' @description ObservationVariableNewRequest Class
#'
...
#' @export
ObservationVariableNewRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(
        `method`, `scale`, `trait`, `observationVariableName`, `additionalInfo`=NULL, `commonCropName`=NULL, `contextOfUse`=NULL, `defaultValue`=NULL, `documentationURL`=NULL, `externalReferences`=NULL, `growthStage`=NULL, `institution`=NULL, `language`=NULL, `ontologyReference`=NULL, `scientist`=NULL, `status`=NULL, `submissionTimestamp`=NULL, `synonyms`=NULL, ...
    ) {
    ...
    toJSON = function() {
      ObservationVariableNewRequestObject <- list()
      if (!is.null(self$`additionalInfo`)) {
        ObservationVariableNewRequestObject[['additionalInfo']] <-
          self$`additionalInfo`
      }
      if (!is.null(self$`commonCropName`)) {
        ObservationVariableNewRequestObject[['commonCropName']] <-
          self$`commonCropName`
      }
      if (!is.null(self$`contextOfUse`)) {
        ObservationVariableNewRequestObject[['contextOfUse']] <-
          self$`contextOfUse`
      }
      if (!is.null(self$`defaultValue`)) {
        ObservationVariableNewRequestObject[['defaultValue']] <-
          self$`defaultValue`
      }
      if (!is.null(self$`documentationURL`)) {
        ObservationVariableNewRequestObject[['documentationURL']] <-
          self$`documentationURL`
      }
      if (!is.null(self$`externalReferences`)) {
        ObservationVariableNewRequestObject[['externalReferences']] <-
          self$`externalReferences`
      }
      if (!is.null(self$`growthStage`)) {
        ObservationVariableNewRequestObject[['growthStage']] <-
          self$`growthStage`
      }
      if (!is.null(self$`institution`)) {
        ObservationVariableNewRequestObject[['institution']] <-
          self$`institution`
      }
      if (!is.null(self$`language`)) {
        ObservationVariableNewRequestObject[['language']] <-
          self$`language`
      }
      if (!is.null(self$`method`)) {
        ObservationVariableNewRequestObject[['method']] <-
          self$`method`$toJSON()
      }
      if (!is.null(self$`ontologyReference`)) {
        ObservationVariableNewRequestObject[['ontologyReference']] <-
          self$`ontologyReference`$toJSON()
      }
      if (!is.null(self$`scale`)) {
        ObservationVariableNewRequestObject[['scale']] <-
          self$`scale`$toJSON()
      }
      if (!is.null(self$`scientist`)) {
        ObservationVariableNewRequestObject[['scientist']] <-
          self$`scientist`
      }
      if (!is.null(self$`status`)) {
        ObservationVariableNewRequestObject[['status']] <-
          self$`status`
      }
      if (!is.null(self$`submissionTimestamp`)) {
        ObservationVariableNewRequestObject[['submissionTimestamp']] <-
          self$`submissionTimestamp`
      }
      if (!is.null(self$`synonyms`)) {
        ObservationVariableNewRequestObject[['synonyms']] <-
          self$`synonyms`
      }
      if (!is.null(self$`trait`)) {
        ObservationVariableNewRequestObject[['trait']] <-
          self$`trait`$toJSON()
      }
      if (!is.null(self$`observationVariableName`)) {
        ObservationVariableNewRequestObject[['observationVariableName']] <-
          self$`observationVariableName`
      }

      ObservationVariableNewRequestObject
    },
    fromJSON = function(ObservationVariableNewRequestJson) {
      ObservationVariableNewRequestObject <- jsonlite::fromJSON(ObservationVariableNewRequestJson)
      if (!is.null(ObservationVariableNewRequestObject$`additionalInfo`)) {
        self$`additionalInfo` <- ApiClient$new()$deserializeObj(ObservationVariableNewRequestObject$`additionalInfo`, "map(character)", loadNamespace("openapi"))
      }
      if (!is.null(ObservationVariableNewRequestObject$`commonCropName`)) {
        self$`commonCropName` <- ObservationVariableNewRequestObject$`commonCropName`
      }
      if (!is.null(ObservationVariableNewRequestObject$`contextOfUse`)) {
        self$`contextOfUse` <- ApiClient$new()$deserializeObj(ObservationVariableNewRequestObject$`contextOfUse`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationVariableNewRequestObject$`defaultValue`)) {
        self$`defaultValue` <- ObservationVariableNewRequestObject$`defaultValue`
      }
      if (!is.null(ObservationVariableNewRequestObject$`documentationURL`)) {
        self$`documentationURL` <- ObservationVariableNewRequestObject$`documentationURL`
      }
      if (!is.null(ObservationVariableNewRequestObject$`externalReferences`)) {
        self$`externalReferences` <- ApiClient$new()$deserializeObj(ObservationVariableNewRequestObject$`externalReferences`, "array[object]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationVariableNewRequestObject$`growthStage`)) {
        self$`growthStage` <- ObservationVariableNewRequestObject$`growthStage`
      }
      if (!is.null(ObservationVariableNewRequestObject$`institution`)) {
        self$`institution` <- ObservationVariableNewRequestObject$`institution`
      }
      if (!is.null(ObservationVariableNewRequestObject$`language`)) {
        self$`language` <- ObservationVariableNewRequestObject$`language`
      }
      if (!is.null(ObservationVariableNewRequestObject$`method`)) {
        methodObject <- MethodBaseClass$new()
        methodObject$fromJSON(jsonlite::toJSON(ObservationVariableNewRequestObject$method, auto_unbox = TRUE, digits = NA))
        self$`method` <- methodObject
      }
      if (!is.null(ObservationVariableNewRequestObject$`ontologyReference`)) {
        ontologyReferenceObject <- OntologyReference$new()
        ontologyReferenceObject$fromJSON(jsonlite::toJSON(ObservationVariableNewRequestObject$ontologyReference, auto_unbox = TRUE, digits = NA))
        self$`ontologyReference` <- ontologyReferenceObject
      }
      if (!is.null(ObservationVariableNewRequestObject$`scale`)) {
        scaleObject <- ScaleBaseClass$new()
        scaleObject$fromJSON(jsonlite::toJSON(ObservationVariableNewRequestObject$scale, auto_unbox = TRUE, digits = NA))
        self$`scale` <- scaleObject
      }
      if (!is.null(ObservationVariableNewRequestObject$`scientist`)) {
        self$`scientist` <- ObservationVariableNewRequestObject$`scientist`
      }
      if (!is.null(ObservationVariableNewRequestObject$`status`)) {
        self$`status` <- ObservationVariableNewRequestObject$`status`
      }
      if (!is.null(ObservationVariableNewRequestObject$`submissionTimestamp`)) {
        self$`submissionTimestamp` <- ObservationVariableNewRequestObject$`submissionTimestamp`
      }
      if (!is.null(ObservationVariableNewRequestObject$`synonyms`)) {
        self$`synonyms` <- ApiClient$new()$deserializeObj(ObservationVariableNewRequestObject$`synonyms`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationVariableNewRequestObject$`trait`)) {
        traitObject <- TraitBaseClass$new()
        traitObject$fromJSON(jsonlite::toJSON(ObservationVariableNewRequestObject$trait, auto_unbox = TRUE, digits = NA))
        self$`trait` <- traitObject
      }
      if (!is.null(ObservationVariableNewRequestObject$`observationVariableName`)) {
        self$`observationVariableName` <- ObservationVariableNewRequestObject$`observationVariableName`
      }
      self
    },
    ...
    fromJSONString = function(ObservationVariableNewRequestJson) {
      ObservationVariableNewRequestObject <- jsonlite::fromJSON(ObservationVariableNewRequestJson)
      self$`additionalInfo` <- ApiClient$new()$deserializeObj(ObservationVariableNewRequestObject$`additionalInfo`, "map(character)", loadNamespace("openapi"))
      self$`commonCropName` <- ObservationVariableNewRequestObject$`commonCropName`
      self$`contextOfUse` <- ApiClient$new()$deserializeObj(ObservationVariableNewRequestObject$`contextOfUse`, "array[character]", loadNamespace("openapi"))
      ...
      self$`institution` <- ObservationVariableNewRequestObject$`institution`
      self$`language` <- ObservationVariableNewRequestObject$`language`
      self$`method` <- MethodBaseClass$new()$fromJSON(jsonlite::toJSON(ObservationVariableNewRequestObject$method, auto_unbox = TRUE, digits = NA))
      self$`ontologyReference` <- OntologyReference$new()$fromJSON(jsonlite::toJSON(ObservationVariableNewRequestObject$ontologyReference, auto_unbox = TRUE, digits = NA))
      self$`scale` <- ScaleBaseClass$new()$fromJSON(jsonlite::toJSON(ObservationVariableNewRequestObject$scale, auto_unbox = TRUE, digits = NA))
      self$`scientist` <- ObservationVariableNewRequestObject$`scientist`
      self$`status` <- ObservationVariableNewRequestObject$`status`
      self$`submissionTimestamp` <- ObservationVariableNewRequestObject$`submissionTimestamp`
      self$`synonyms` <- ApiClient$new()$deserializeObj(ObservationVariableNewRequestObject$`synonyms`, "array[character]", loadNamespace("openapi"))
      self$`trait` <- TraitBaseClass$new()$fromJSON(jsonlite::toJSON(ObservationVariableNewRequestObject$trait, auto_unbox = TRUE, digits = NA))
      self$`observationVariableName` <- ObservationVariableNewRequestObject$`observationVariableName`
      self
    }
  )
