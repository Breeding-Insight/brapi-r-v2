...
#' @docType class
#' @title MarkerPositionSearchRequestAllOf
#'
#' @description MarkerPositionSearchRequestAllOf Class
#'
...
#' @export
MarkerPositionSearchRequestAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    `variantDbIds` = NULL,
    initialize = function(
        `linkageGroupNames`=NULL, `mapDbIds`=NULL, `maxPosition`=NULL, `minPosition`=NULL, `variantDbIds`=NULL, ...
    ) {
    ...
    toJSON = function() {
      MarkerPositionSearchRequestAllOfObject <- list()
      if (!is.null(self$`linkageGroupNames`)) {
        MarkerPositionSearchRequestAllOfObject[['linkageGroupNames']] <-
          self$`linkageGroupNames`
      }
      if (!is.null(self$`mapDbIds`)) {
        MarkerPositionSearchRequestAllOfObject[['mapDbIds']] <-
          self$`mapDbIds`
      }
      if (!is.null(self$`maxPosition`)) {
        MarkerPositionSearchRequestAllOfObject[['maxPosition']] <-
          self$`maxPosition`
      }
      if (!is.null(self$`minPosition`)) {
        MarkerPositionSearchRequestAllOfObject[['minPosition']] <-
          self$`minPosition`
      }
      if (!is.null(self$`variantDbIds`)) {
        MarkerPositionSearchRequestAllOfObject[['variantDbIds']] <-
          self$`variantDbIds`
      }

      MarkerPositionSearchRequestAllOfObject
    },
    fromJSON = function(MarkerPositionSearchRequestAllOfJson) {
      MarkerPositionSearchRequestAllOfObject <- jsonlite::fromJSON(MarkerPositionSearchRequestAllOfJson)
      if (!is.null(MarkerPositionSearchRequestAllOfObject$`linkageGroupNames`)) {
        self$`linkageGroupNames` <- ApiClient$new()$deserializeObj(MarkerPositionSearchRequestAllOfObject$`linkageGroupNames`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(MarkerPositionSearchRequestAllOfObject$`mapDbIds`)) {
        self$`mapDbIds` <- ApiClient$new()$deserializeObj(MarkerPositionSearchRequestAllOfObject$`mapDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(MarkerPositionSearchRequestAllOfObject$`maxPosition`)) {
        self$`maxPosition` <- MarkerPositionSearchRequestAllOfObject$`maxPosition`
      }
      if (!is.null(MarkerPositionSearchRequestAllOfObject$`minPosition`)) {
        self$`minPosition` <- MarkerPositionSearchRequestAllOfObject$`minPosition`
      }
      if (!is.null(MarkerPositionSearchRequestAllOfObject$`variantDbIds`)) {
        self$`variantDbIds` <- ApiClient$new()$deserializeObj(MarkerPositionSearchRequestAllOfObject$`variantDbIds`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(MarkerPositionSearchRequestAllOfJson) {
      MarkerPositionSearchRequestAllOfObject <- jsonlite::fromJSON(MarkerPositionSearchRequestAllOfJson)
      self$`linkageGroupNames` <- ApiClient$new()$deserializeObj(MarkerPositionSearchRequestAllOfObject$`linkageGroupNames`, "array[character]", loadNamespace("openapi"))
      self$`mapDbIds` <- ApiClient$new()$deserializeObj(MarkerPositionSearchRequestAllOfObject$`mapDbIds`, "array[character]", loadNamespace("openapi"))
      self$`maxPosition` <- MarkerPositionSearchRequestAllOfObject$`maxPosition`
