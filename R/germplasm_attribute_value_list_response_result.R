...
#' @docType class
#' @title GermplasmAttributeValueListResponseResult
#'
#' @description GermplasmAttributeValueListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{GermplasmAttributeValue} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GermplasmAttributeValueListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmAttributeValueListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        GermplasmAttributeValueListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      GermplasmAttributeValueListResponseResultObject
    },
    fromJSON = function(GermplasmAttributeValueListResponseResultJson) {
      GermplasmAttributeValueListResponseResultObject <- jsonlite::fromJSON(GermplasmAttributeValueListResponseResultJson)
      if (!is.null(GermplasmAttributeValueListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(GermplasmAttributeValueListResponseResultObject$`data`, "array[GermplasmAttributeValue]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(GermplasmAttributeValueListResponseResultJson) {
      GermplasmAttributeValueListResponseResultObject <- jsonlite::fromJSON(GermplasmAttributeValueListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(GermplasmAttributeValueListResponseResultObject$`data`, "array[GermplasmAttributeValue]", loadNamespace("openapi"))
      self
    }
