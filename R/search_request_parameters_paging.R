...
#' @docType class
#' @title SearchRequestParametersPaging
#'
#' @description SearchRequestParametersPaging Class
#'
...
#' @export
SearchRequestParametersPaging <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SearchRequestParametersPagingObject <- list()
      if (!is.null(self$`page`)) {
        SearchRequestParametersPagingObject[['page']] <-
          self$`page`
      }
      if (!is.null(self$`pageSize`)) {
        SearchRequestParametersPagingObject[['pageSize']] <-
          self$`pageSize`
      }

      SearchRequestParametersPagingObject
    },
    fromJSON = function(SearchRequestParametersPagingJson) {
      SearchRequestParametersPagingObject <- jsonlite::fromJSON(SearchRequestParametersPagingJson)
      if (!is.null(SearchRequestParametersPagingObject$`page`)) {
        self$`page` <- SearchRequestParametersPagingObject$`page`
      }
      if (!is.null(SearchRequestParametersPagingObject$`pageSize`)) {
        self$`pageSize` <- SearchRequestParametersPagingObject$`pageSize`
      }
      self
    },
    ...
    fromJSONString = function(SearchRequestParametersPagingJson) {
      SearchRequestParametersPagingObject <- jsonlite::fromJSON(SearchRequestParametersPagingJson)
      self$`page` <- SearchRequestParametersPagingObject$`page`
      self$`pageSize` <- SearchRequestParametersPagingObject$`pageSize`
      self
