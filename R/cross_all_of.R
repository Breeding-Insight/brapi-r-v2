...
CrossAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CrossAllOfObject <- list()
      if (!is.null(self$`crossDbId`)) {
        CrossAllOfObject[['crossDbId']] <-
          self$`crossDbId`
      }

      CrossAllOfObject
    },
    fromJSON = function(CrossAllOfJson) {
      CrossAllOfObject <- jsonlite::fromJSON(CrossAllOfJson)
      if (!is.null(CrossAllOfObject$`crossDbId`)) {
        self$`crossDbId` <- CrossAllOfObject$`crossDbId`
      }
      self
    },
    ...
    fromJSONString = function(CrossAllOfJson) {
      CrossAllOfObject <- jsonlite::fromJSON(CrossAllOfJson)
      self$`crossDbId` <- CrossAllOfObject$`crossDbId`
      self
    }
