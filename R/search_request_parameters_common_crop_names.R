...
#' @docType class
#' @title SearchRequestParametersCommonCropNames
#'
#' @description SearchRequestParametersCommonCropNames Class
#'
...
#' @export
SearchRequestParametersCommonCropNames <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SearchRequestParametersCommonCropNamesObject <- list()
      if (!is.null(self$`commonCropNames`)) {
        SearchRequestParametersCommonCropNamesObject[['commonCropNames']] <-
          self$`commonCropNames`
      }

      SearchRequestParametersCommonCropNamesObject
    },
    fromJSON = function(SearchRequestParametersCommonCropNamesJson) {
      SearchRequestParametersCommonCropNamesObject <- jsonlite::fromJSON(SearchRequestParametersCommonCropNamesJson)
      if (!is.null(SearchRequestParametersCommonCropNamesObject$`commonCropNames`)) {
        self$`commonCropNames` <- ApiClient$new()$deserializeObj(SearchRequestParametersCommonCropNamesObject$`commonCropNames`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(SearchRequestParametersCommonCropNamesJson) {
      SearchRequestParametersCommonCropNamesObject <- jsonlite::fromJSON(SearchRequestParametersCommonCropNamesJson)
      self$`commonCropNames` <- ApiClient$new()$deserializeObj(SearchRequestParametersCommonCropNamesObject$`commonCropNames`, "array[character]", loadNamespace("openapi"))
      self
    }
