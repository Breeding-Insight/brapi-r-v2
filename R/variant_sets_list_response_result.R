...
#'
#' @description VariantSetsListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{VariantSet} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VariantSetsListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VariantSetsListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        VariantSetsListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      VariantSetsListResponseResultObject
    },
    fromJSON = function(VariantSetsListResponseResultJson) {
      VariantSetsListResponseResultObject <- jsonlite::fromJSON(VariantSetsListResponseResultJson)
      if (!is.null(VariantSetsListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(VariantSetsListResponseResultObject$`data`, "array[VariantSet]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(VariantSetsListResponseResultJson) {
      VariantSetsListResponseResultObject <- jsonlite::fromJSON(VariantSetsListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(VariantSetsListResponseResultObject$`data`, "array[VariantSet]", loadNamespace("openapi"))
      self
    }
