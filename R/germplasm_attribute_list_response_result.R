...
#' @docType class
#' @title GermplasmAttributeListResponseResult
#'
#' @description GermplasmAttributeListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{GermplasmAttribute} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GermplasmAttributeListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmAttributeListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        GermplasmAttributeListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      GermplasmAttributeListResponseResultObject
    },
    fromJSON = function(GermplasmAttributeListResponseResultJson) {
      GermplasmAttributeListResponseResultObject <- jsonlite::fromJSON(GermplasmAttributeListResponseResultJson)
      if (!is.null(GermplasmAttributeListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(GermplasmAttributeListResponseResultObject$`data`, "array[GermplasmAttribute]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(GermplasmAttributeListResponseResultJson) {
      GermplasmAttributeListResponseResultObject <- jsonlite::fromJSON(GermplasmAttributeListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(GermplasmAttributeListResponseResultObject$`data`, "array[GermplasmAttribute]", loadNamespace("openapi"))
      self
    }
