...
#' @docType class
#' @title GermplasmMCPDDonorInfoDonorInstitute
#'
#' @description GermplasmMCPDDonorInfoDonorInstitute Class
#'
...
#' @export
GermplasmMCPDDonorInfoDonorInstitute <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmMCPDDonorInfoDonorInstituteObject <- list()
      if (!is.null(self$`instituteCode`)) {
        GermplasmMCPDDonorInfoDonorInstituteObject[['instituteCode']] <-
          self$`instituteCode`
      }
      if (!is.null(self$`instituteName`)) {
        GermplasmMCPDDonorInfoDonorInstituteObject[['instituteName']] <-
          self$`instituteName`
      }

      GermplasmMCPDDonorInfoDonorInstituteObject
    },
    fromJSON = function(GermplasmMCPDDonorInfoDonorInstituteJson) {
      GermplasmMCPDDonorInfoDonorInstituteObject <- jsonlite::fromJSON(GermplasmMCPDDonorInfoDonorInstituteJson)
      if (!is.null(GermplasmMCPDDonorInfoDonorInstituteObject$`instituteCode`)) {
        self$`instituteCode` <- GermplasmMCPDDonorInfoDonorInstituteObject$`instituteCode`
      }
      if (!is.null(GermplasmMCPDDonorInfoDonorInstituteObject$`instituteName`)) {
        self$`instituteName` <- GermplasmMCPDDonorInfoDonorInstituteObject$`instituteName`
      }
      self
    },
    ...
    fromJSONString = function(GermplasmMCPDDonorInfoDonorInstituteJson) {
      GermplasmMCPDDonorInfoDonorInstituteObject <- jsonlite::fromJSON(GermplasmMCPDDonorInfoDonorInstituteJson)
      self$`instituteCode` <- GermplasmMCPDDonorInfoDonorInstituteObject$`instituteCode`
      self$`instituteName` <- GermplasmMCPDDonorInfoDonorInstituteObject$`instituteName`
      self
