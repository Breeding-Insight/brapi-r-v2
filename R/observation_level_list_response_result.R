...
#' @docType class
#' @title ObservationLevelListResponseResult
#'
#' @description ObservationLevelListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{ObservationUnitHierarchyLevel} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationLevelListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationLevelListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        ObservationLevelListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      ObservationLevelListResponseResultObject
    },
    fromJSON = function(ObservationLevelListResponseResultJson) {
      ObservationLevelListResponseResultObject <- jsonlite::fromJSON(ObservationLevelListResponseResultJson)
      if (!is.null(ObservationLevelListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ObservationLevelListResponseResultObject$`data`, "array[ObservationUnitHierarchyLevel]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ObservationLevelListResponseResultJson) {
      ObservationLevelListResponseResultObject <- jsonlite::fromJSON(ObservationLevelListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(ObservationLevelListResponseResultObject$`data`, "array[ObservationUnitHierarchyLevel]", loadNamespace("openapi"))
      self
    }
