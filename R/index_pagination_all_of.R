...
#' @docType class
#' @title IndexPaginationAllOf
#'
#' @description IndexPaginationAllOf Class
#'
...
#' @export
IndexPaginationAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      IndexPaginationAllOfObject <- list()
      if (!is.null(self$`currentPage`)) {
        IndexPaginationAllOfObject[['currentPage']] <-
          self$`currentPage`
      }

      IndexPaginationAllOfObject
    },
    fromJSON = function(IndexPaginationAllOfJson) {
      IndexPaginationAllOfObject <- jsonlite::fromJSON(IndexPaginationAllOfJson)
      if (!is.null(IndexPaginationAllOfObject$`currentPage`)) {
        self$`currentPage` <- IndexPaginationAllOfObject$`currentPage`
      }
      self
    },
    ...
    fromJSONString = function(IndexPaginationAllOfJson) {
      IndexPaginationAllOfObject <- jsonlite::fromJSON(IndexPaginationAllOfJson)
      self$`currentPage` <- IndexPaginationAllOfObject$`currentPage`
      self
    }
