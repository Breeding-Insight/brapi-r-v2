...
#' @docType class
#' @title CrossingProjectAllOf
#'
#' @description CrossingProjectAllOf Class
#'
...
#' @export
CrossingProjectAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CrossingProjectAllOfObject <- list()
      if (!is.null(self$`crossingProjectDbId`)) {
        CrossingProjectAllOfObject[['crossingProjectDbId']] <-
          self$`crossingProjectDbId`
      }

      CrossingProjectAllOfObject
    },
    fromJSON = function(CrossingProjectAllOfJson) {
      CrossingProjectAllOfObject <- jsonlite::fromJSON(CrossingProjectAllOfJson)
      if (!is.null(CrossingProjectAllOfObject$`crossingProjectDbId`)) {
        self$`crossingProjectDbId` <- CrossingProjectAllOfObject$`crossingProjectDbId`
      }
      self
    },
    ...
    fromJSONString = function(CrossingProjectAllOfJson) {
      CrossingProjectAllOfObject <- jsonlite::fromJSON(CrossingProjectAllOfJson)
      self$`crossingProjectDbId` <- CrossingProjectAllOfObject$`crossingProjectDbId`
      self
    }
