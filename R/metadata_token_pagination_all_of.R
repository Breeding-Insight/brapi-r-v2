...
#' @docType class
#' @title MetadataTokenPaginationAllOf
#'
#' @description MetadataTokenPaginationAllOf Class
#'
...
#' @export
MetadataTokenPaginationAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      MetadataTokenPaginationAllOfObject <- list()
      if (!is.null(self$`pagination`)) {
        MetadataTokenPaginationAllOfObject[['pagination']] <-
          self$`pagination`$toJSON()
      }

      MetadataTokenPaginationAllOfObject
    },
    fromJSON = function(MetadataTokenPaginationAllOfJson) {
      MetadataTokenPaginationAllOfObject <- jsonlite::fromJSON(MetadataTokenPaginationAllOfJson)
      if (!is.null(MetadataTokenPaginationAllOfObject$`pagination`)) {
        paginationObject <- TokenPagination$new()
        paginationObject$fromJSON(jsonlite::toJSON(MetadataTokenPaginationAllOfObject$pagination, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(MetadataTokenPaginationAllOfJson) {
      MetadataTokenPaginationAllOfObject <- jsonlite::fromJSON(MetadataTokenPaginationAllOfJson)
      self$`pagination` <- TokenPagination$new()$fromJSON(jsonlite::toJSON(MetadataTokenPaginationAllOfObject$pagination, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
