...
#' @docType class
#' @title GermplasmNewRequestSynonyms
#'
#' @description GermplasmNewRequestSynonyms Class
#'
...
#' @export
GermplasmNewRequestSynonyms <- R6::R6Class(
  'GermplasmNewRequestSynonyms',
  public = list(
    `synonym` = NULL,
    `type` = NULL,
    initialize = function(
        `synonym`=NULL, `type`=NULL, ...
    ) {
      local.optional.var <- list(...)
      if (!is.null(`synonym`)) {
        stopifnot(is.character(`synonym`), length(`synonym`) == 1)
    ...
    toJSON = function() {
      GermplasmNewRequestSynonymsObject <- list()
      if (!is.null(self$`synonym`)) {
        GermplasmNewRequestSynonymsObject[['synonym']] <-
          self$`synonym`
      }
      if (!is.null(self$`type`)) {
        GermplasmNewRequestSynonymsObject[['type']] <-
          self$`type`
      }

      GermplasmNewRequestSynonymsObject
    },
    fromJSON = function(GermplasmNewRequestSynonymsJson) {
      GermplasmNewRequestSynonymsObject <- jsonlite::fromJSON(GermplasmNewRequestSynonymsJson)
      if (!is.null(GermplasmNewRequestSynonymsObject$`synonym`)) {
        self$`synonym` <- GermplasmNewRequestSynonymsObject$`synonym`
      }
      if (!is.null(GermplasmNewRequestSynonymsObject$`type`)) {
        self$`type` <- GermplasmNewRequestSynonymsObject$`type`
      }
      self
    },
    ...
    fromJSONString = function(GermplasmNewRequestSynonymsJson) {
      GermplasmNewRequestSynonymsObject <- jsonlite::fromJSON(GermplasmNewRequestSynonymsJson)
      self$`synonym` <- GermplasmNewRequestSynonymsObject$`synonym`
      self$`type` <- GermplasmNewRequestSynonymsObject$`type`
      self
