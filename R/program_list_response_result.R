...
#' @docType class
#' @title ProgramListResponseResult
#'
#' @description ProgramListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Program} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ProgramListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ProgramListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        ProgramListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      ProgramListResponseResultObject
    },
    fromJSON = function(ProgramListResponseResultJson) {
      ProgramListResponseResultObject <- jsonlite::fromJSON(ProgramListResponseResultJson)
      if (!is.null(ProgramListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ProgramListResponseResultObject$`data`, "array[Program]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ProgramListResponseResultJson) {
      ProgramListResponseResultObject <- jsonlite::fromJSON(ProgramListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(ProgramListResponseResultObject$`data`, "array[Program]", loadNamespace("openapi"))
      self
    }
