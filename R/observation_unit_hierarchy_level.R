...
#'
#' @description ObservationUnitHierarchyLevel Class
#'
...
#' @export
ObservationUnitHierarchyLevel <- R6::R6Class(
  'ObservationUnitHierarchyLevel',
  public = list(
    `levelName` = NULL,
    `levelOrder` = NULL,
    initialize = function(
        `levelName`=NULL, `levelOrder`=NULL, ...
    ) {
    ...
    toJSON = function() {
      ObservationUnitHierarchyLevelObject <- list()
      if (!is.null(self$`levelName`)) {
        ObservationUnitHierarchyLevelObject[['levelName']] <-
          self$`levelName`
      }
      if (!is.null(self$`levelOrder`)) {
        ObservationUnitHierarchyLevelObject[['levelOrder']] <-
          self$`levelOrder`
      }

      ObservationUnitHierarchyLevelObject
    },
    fromJSON = function(ObservationUnitHierarchyLevelJson) {
      ObservationUnitHierarchyLevelObject <- jsonlite::fromJSON(ObservationUnitHierarchyLevelJson)
      if (!is.null(ObservationUnitHierarchyLevelObject$`levelName`)) {
        self$`levelName` <- ObservationUnitHierarchyLevelObject$`levelName`
      }
      if (!is.null(ObservationUnitHierarchyLevelObject$`levelOrder`)) {
        self$`levelOrder` <- ObservationUnitHierarchyLevelObject$`levelOrder`
      }
      self
    },
    ...
    fromJSONString = function(ObservationUnitHierarchyLevelJson) {
      ObservationUnitHierarchyLevelObject <- jsonlite::fromJSON(ObservationUnitHierarchyLevelJson)
      self$`levelName` <- ObservationUnitHierarchyLevelObject$`levelName`
      self$`levelOrder` <- ObservationUnitHierarchyLevelObject$`levelOrder`
      self
