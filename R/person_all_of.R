...
PersonAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      PersonAllOfObject <- list()
      if (!is.null(self$`personDbId`)) {
        PersonAllOfObject[['personDbId']] <-
          self$`personDbId`
      }

      PersonAllOfObject
    },
    fromJSON = function(PersonAllOfJson) {
      PersonAllOfObject <- jsonlite::fromJSON(PersonAllOfJson)
      if (!is.null(PersonAllOfObject$`personDbId`)) {
        self$`personDbId` <- PersonAllOfObject$`personDbId`
      }
      self
    },
    ...
    fromJSONString = function(PersonAllOfJson) {
      PersonAllOfObject <- jsonlite::fromJSON(PersonAllOfJson)
      self$`personDbId` <- PersonAllOfObject$`personDbId`
      self
    }
