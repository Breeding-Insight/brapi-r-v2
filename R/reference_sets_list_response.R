...
#'
#' @description ReferenceSetsListResponse Class
#'
...
#'
#' @field result  \link{ReferenceSetsListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ReferenceSetsListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ReferenceSetsListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ReferenceSetsListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ReferenceSetsListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ReferenceSetsListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ReferenceSetsListResponseObject
    },
    fromJSON = function(ReferenceSetsListResponseJson) {
      ReferenceSetsListResponseObject <- jsonlite::fromJSON(ReferenceSetsListResponseJson)
      if (!is.null(ReferenceSetsListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ReferenceSetsListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ReferenceSetsListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ReferenceSetsListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ReferenceSetsListResponseObject$`result`)) {
        resultObject <- ReferenceSetsListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(ReferenceSetsListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ReferenceSetsListResponseJson) {
      ReferenceSetsListResponseObject <- jsonlite::fromJSON(ReferenceSetsListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ReferenceSetsListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ReferenceSetsListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ReferenceSetsListResponseResult$new()$fromJSON(jsonlite::toJSON(ReferenceSetsListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
