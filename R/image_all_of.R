...
ImageAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ImageAllOfObject <- list()
      if (!is.null(self$`imageDbId`)) {
        ImageAllOfObject[['imageDbId']] <-
          self$`imageDbId`
      }

      ImageAllOfObject
    },
    fromJSON = function(ImageAllOfJson) {
      ImageAllOfObject <- jsonlite::fromJSON(ImageAllOfJson)
      if (!is.null(ImageAllOfObject$`imageDbId`)) {
        self$`imageDbId` <- ImageAllOfObject$`imageDbId`
      }
      self
    },
    ...
    fromJSONString = function(ImageAllOfJson) {
      ImageAllOfObject <- jsonlite::fromJSON(ImageAllOfJson)
      self$`imageDbId` <- ImageAllOfObject$`imageDbId`
      self
    }
