...
#'
#' @description GermplasmProgenyResponse Class
#'
...
#'
#' @field result  \link{ProgenyNode} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GermplasmProgenyResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmProgenyResponseObject <- list()
      if (!is.null(self$`@context`)) {
        GermplasmProgenyResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        GermplasmProgenyResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        GermplasmProgenyResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      GermplasmProgenyResponseObject
    },
    fromJSON = function(GermplasmProgenyResponseJson) {
      GermplasmProgenyResponseObject <- jsonlite::fromJSON(GermplasmProgenyResponseJson)
      if (!is.null(GermplasmProgenyResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(GermplasmProgenyResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(GermplasmProgenyResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(GermplasmProgenyResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(GermplasmProgenyResponseObject$`result`)) {
        resultObject <- ProgenyNode$new()
        resultObject$fromJSON(jsonlite::toJSON(GermplasmProgenyResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(GermplasmProgenyResponseJson) {
      GermplasmProgenyResponseObject <- jsonlite::fromJSON(GermplasmProgenyResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(GermplasmProgenyResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(GermplasmProgenyResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ProgenyNode$new()$fromJSON(jsonlite::toJSON(GermplasmProgenyResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
