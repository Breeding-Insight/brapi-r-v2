...
#'
#' @description ReferenceSetsSingleResponse Class
#'
...
#'
#' @field result  \link{ReferenceSet} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ReferenceSetsSingleResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ReferenceSetsSingleResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ReferenceSetsSingleResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ReferenceSetsSingleResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ReferenceSetsSingleResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ReferenceSetsSingleResponseObject
    },
    fromJSON = function(ReferenceSetsSingleResponseJson) {
      ReferenceSetsSingleResponseObject <- jsonlite::fromJSON(ReferenceSetsSingleResponseJson)
      if (!is.null(ReferenceSetsSingleResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ReferenceSetsSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ReferenceSetsSingleResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ReferenceSetsSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ReferenceSetsSingleResponseObject$`result`)) {
        resultObject <- ReferenceSet$new()
        resultObject$fromJSON(jsonlite::toJSON(ReferenceSetsSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ReferenceSetsSingleResponseJson) {
      ReferenceSetsSingleResponseObject <- jsonlite::fromJSON(ReferenceSetsSingleResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ReferenceSetsSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ReferenceSetsSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ReferenceSet$new()$fromJSON(jsonlite::toJSON(ReferenceSetsSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
