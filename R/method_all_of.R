...
MethodAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      MethodAllOfObject <- list()
      if (!is.null(self$`methodDbId`)) {
        MethodAllOfObject[['methodDbId']] <-
          self$`methodDbId`
      }

      MethodAllOfObject
    },
    fromJSON = function(MethodAllOfJson) {
      MethodAllOfObject <- jsonlite::fromJSON(MethodAllOfJson)
      if (!is.null(MethodAllOfObject$`methodDbId`)) {
        self$`methodDbId` <- MethodAllOfObject$`methodDbId`
      }
      self
    },
    ...
    fromJSONString = function(MethodAllOfJson) {
      MethodAllOfObject <- jsonlite::fromJSON(MethodAllOfJson)
      self$`methodDbId` <- MethodAllOfObject$`methodDbId`
      self
    }
