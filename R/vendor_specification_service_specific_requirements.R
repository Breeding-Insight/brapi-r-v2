...
#' @docType class
#' @title VendorSpecificationServiceSpecificRequirements
#'
#' @description VendorSpecificationServiceSpecificRequirements Class
#'
...
#' @export
VendorSpecificationServiceSpecificRequirements <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VendorSpecificationServiceSpecificRequirementsObject <- list()
      if (!is.null(self$`description`)) {
        VendorSpecificationServiceSpecificRequirementsObject[['description']] <-
          self$`description`
      }
      if (!is.null(self$`key`)) {
        VendorSpecificationServiceSpecificRequirementsObject[['key']] <-
          self$`key`
      }

      VendorSpecificationServiceSpecificRequirementsObject
    },
    fromJSON = function(VendorSpecificationServiceSpecificRequirementsJson) {
      VendorSpecificationServiceSpecificRequirementsObject <- jsonlite::fromJSON(VendorSpecificationServiceSpecificRequirementsJson)
      if (!is.null(VendorSpecificationServiceSpecificRequirementsObject$`description`)) {
        self$`description` <- VendorSpecificationServiceSpecificRequirementsObject$`description`
      }
      if (!is.null(VendorSpecificationServiceSpecificRequirementsObject$`key`)) {
        self$`key` <- VendorSpecificationServiceSpecificRequirementsObject$`key`
      }
      self
    },
    ...
    fromJSONString = function(VendorSpecificationServiceSpecificRequirementsJson) {
      VendorSpecificationServiceSpecificRequirementsObject <- jsonlite::fromJSON(VendorSpecificationServiceSpecificRequirementsJson)
      self$`description` <- VendorSpecificationServiceSpecificRequirementsObject$`description`
      self$`key` <- VendorSpecificationServiceSpecificRequirementsObject$`key`
      self
