...
#'
#' @description BreedingMethodSingleResponse Class
#'
...
#'
#' @field result  \link{BreedingMethod} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
BreedingMethodSingleResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      BreedingMethodSingleResponseObject <- list()
      if (!is.null(self$`@context`)) {
        BreedingMethodSingleResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        BreedingMethodSingleResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        BreedingMethodSingleResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      BreedingMethodSingleResponseObject
    },
    fromJSON = function(BreedingMethodSingleResponseJson) {
      BreedingMethodSingleResponseObject <- jsonlite::fromJSON(BreedingMethodSingleResponseJson)
      if (!is.null(BreedingMethodSingleResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(BreedingMethodSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(BreedingMethodSingleResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(BreedingMethodSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(BreedingMethodSingleResponseObject$`result`)) {
        resultObject <- BreedingMethod$new()
        resultObject$fromJSON(jsonlite::toJSON(BreedingMethodSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(BreedingMethodSingleResponseJson) {
      BreedingMethodSingleResponseObject <- jsonlite::fromJSON(BreedingMethodSingleResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(BreedingMethodSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(BreedingMethodSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- BreedingMethod$new()$fromJSON(jsonlite::toJSON(BreedingMethodSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
