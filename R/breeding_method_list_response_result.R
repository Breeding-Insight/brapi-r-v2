...
#' @docType class
#' @title BreedingMethodListResponseResult
#'
#' @description BreedingMethodListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{BreedingMethod} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
BreedingMethodListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      BreedingMethodListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        BreedingMethodListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      BreedingMethodListResponseResultObject
    },
    fromJSON = function(BreedingMethodListResponseResultJson) {
      BreedingMethodListResponseResultObject <- jsonlite::fromJSON(BreedingMethodListResponseResultJson)
      if (!is.null(BreedingMethodListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(BreedingMethodListResponseResultObject$`data`, "array[BreedingMethod]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(BreedingMethodListResponseResultJson) {
      BreedingMethodListResponseResultObject <- jsonlite::fromJSON(BreedingMethodListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(BreedingMethodListResponseResultObject$`data`, "array[BreedingMethod]", loadNamespace("openapi"))
      self
    }
