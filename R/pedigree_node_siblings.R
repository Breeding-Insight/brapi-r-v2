...
#' @docType class
#' @title PedigreeNodeSiblings
#'
#' @description PedigreeNodeSiblings Class
#'
...
#' @export
PedigreeNodeSiblings <- R6::R6Class(
  'PedigreeNodeSiblings',
  public = list(
    `germplasmDbId` = NULL,
    `germplasmName` = NULL,
    initialize = function(
        `germplasmDbId`=NULL, `germplasmName`=NULL, ...
    ) {
    ...
    toJSON = function() {
      PedigreeNodeSiblingsObject <- list()
      if (!is.null(self$`germplasmDbId`)) {
        PedigreeNodeSiblingsObject[['germplasmDbId']] <-
          self$`germplasmDbId`
      }
      if (!is.null(self$`germplasmName`)) {
        PedigreeNodeSiblingsObject[['germplasmName']] <-
          self$`germplasmName`
      }

      PedigreeNodeSiblingsObject
    },
    fromJSON = function(PedigreeNodeSiblingsJson) {
      PedigreeNodeSiblingsObject <- jsonlite::fromJSON(PedigreeNodeSiblingsJson)
      if (!is.null(PedigreeNodeSiblingsObject$`germplasmDbId`)) {
        self$`germplasmDbId` <- PedigreeNodeSiblingsObject$`germplasmDbId`
      }
      if (!is.null(PedigreeNodeSiblingsObject$`germplasmName`)) {
        self$`germplasmName` <- PedigreeNodeSiblingsObject$`germplasmName`
      }
      self
    },
    ...
    fromJSONString = function(PedigreeNodeSiblingsJson) {
      PedigreeNodeSiblingsObject <- jsonlite::fromJSON(PedigreeNodeSiblingsJson)
      self$`germplasmDbId` <- PedigreeNodeSiblingsObject$`germplasmDbId`
      self$`germplasmName` <- PedigreeNodeSiblingsObject$`germplasmName`
      self
