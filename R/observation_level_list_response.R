...
#'
#' @description ObservationLevelListResponse Class
#'
...
#'
#' @field result  \link{ObservationLevelListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationLevelListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationLevelListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ObservationLevelListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ObservationLevelListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ObservationLevelListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ObservationLevelListResponseObject
    },
    fromJSON = function(ObservationLevelListResponseJson) {
      ObservationLevelListResponseObject <- jsonlite::fromJSON(ObservationLevelListResponseJson)
      if (!is.null(ObservationLevelListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ObservationLevelListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationLevelListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ObservationLevelListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ObservationLevelListResponseObject$`result`)) {
        resultObject <- ObservationLevelListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(ObservationLevelListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ObservationLevelListResponseJson) {
      ObservationLevelListResponseObject <- jsonlite::fromJSON(ObservationLevelListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ObservationLevelListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ObservationLevelListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ObservationLevelListResponseResult$new()$fromJSON(jsonlite::toJSON(ObservationLevelListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
