...
#' @docType class
#' @title MethodListResponseResult
#'
#' @description MethodListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Method} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
MethodListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      MethodListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        MethodListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      MethodListResponseResultObject
    },
    fromJSON = function(MethodListResponseResultJson) {
      MethodListResponseResultObject <- jsonlite::fromJSON(MethodListResponseResultJson)
      if (!is.null(MethodListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(MethodListResponseResultObject$`data`, "array[Method]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(MethodListResponseResultJson) {
      MethodListResponseResultObject <- jsonlite::fromJSON(MethodListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(MethodListResponseResultObject$`data`, "array[Method]", loadNamespace("openapi"))
      self
    }
