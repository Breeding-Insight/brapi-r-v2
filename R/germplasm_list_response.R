...
#'
#' @description GermplasmListResponse Class
#'
...
#'
#' @field result  \link{GermplasmListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GermplasmListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        GermplasmListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        GermplasmListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        GermplasmListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      GermplasmListResponseObject
    },
    fromJSON = function(GermplasmListResponseJson) {
      GermplasmListResponseObject <- jsonlite::fromJSON(GermplasmListResponseJson)
      if (!is.null(GermplasmListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(GermplasmListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(GermplasmListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(GermplasmListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(GermplasmListResponseObject$`result`)) {
        resultObject <- GermplasmListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(GermplasmListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(GermplasmListResponseJson) {
      GermplasmListResponseObject <- jsonlite::fromJSON(GermplasmListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(GermplasmListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(GermplasmListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- GermplasmListResponseResult$new()$fromJSON(jsonlite::toJSON(GermplasmListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
