...
#' @docType class
#' @title ProgenyNodeProgeny
#'
#' @description ProgenyNodeProgeny Class
#'
...
#'
#' @field parentType  character 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ProgenyNodeProgeny <- R6::R6Class(
  'ProgenyNodeProgeny',
  public = list(
    `germplasmDbId` = NULL,
    `germplasmName` = NULL,
    `parentType` = NULL,
    initialize = function(
        `germplasmDbId`, `parentType`, `germplasmName`=NULL, ...
    ) {
    ...
    toJSON = function() {
      ProgenyNodeProgenyObject <- list()
      if (!is.null(self$`germplasmDbId`)) {
        ProgenyNodeProgenyObject[['germplasmDbId']] <-
          self$`germplasmDbId`
      }
      if (!is.null(self$`germplasmName`)) {
        ProgenyNodeProgenyObject[['germplasmName']] <-
          self$`germplasmName`
      }
      if (!is.null(self$`parentType`)) {
        ProgenyNodeProgenyObject[['parentType']] <-
          self$`parentType`
      }

      ProgenyNodeProgenyObject
    },
    fromJSON = function(ProgenyNodeProgenyJson) {
      ProgenyNodeProgenyObject <- jsonlite::fromJSON(ProgenyNodeProgenyJson)
      if (!is.null(ProgenyNodeProgenyObject$`germplasmDbId`)) {
        self$`germplasmDbId` <- ProgenyNodeProgenyObject$`germplasmDbId`
      }
      if (!is.null(ProgenyNodeProgenyObject$`germplasmName`)) {
        self$`germplasmName` <- ProgenyNodeProgenyObject$`germplasmName`
      }
      if (!is.null(ProgenyNodeProgenyObject$`parentType`)) {
        self$`parentType` <- ProgenyNodeProgenyObject$`parentType`
      }
      self
    },
    ...
    fromJSONString = function(ProgenyNodeProgenyJson) {
      ProgenyNodeProgenyObject <- jsonlite::fromJSON(ProgenyNodeProgenyJson)
      self$`germplasmDbId` <- ProgenyNodeProgenyObject$`germplasmDbId`
      self$`germplasmName` <- ProgenyNodeProgenyObject$`germplasmName`
      self$`parentType` <- ProgenyNodeProgenyObject$`parentType`
