...
#' @docType class
#' @title GermplasmNewRequestStorageTypes
#'
#' @description GermplasmNewRequestStorageTypes Class
#'
...
#' @export
GermplasmNewRequestStorageTypes <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmNewRequestStorageTypesObject <- list()
      if (!is.null(self$`code`)) {
        GermplasmNewRequestStorageTypesObject[['code']] <-
          self$`code`
      }
      if (!is.null(self$`description`)) {
        GermplasmNewRequestStorageTypesObject[['description']] <-
          self$`description`
      }

      GermplasmNewRequestStorageTypesObject
    },
    fromJSON = function(GermplasmNewRequestStorageTypesJson) {
      GermplasmNewRequestStorageTypesObject <- jsonlite::fromJSON(GermplasmNewRequestStorageTypesJson)
      if (!is.null(GermplasmNewRequestStorageTypesObject$`code`)) {
        self$`code` <- GermplasmNewRequestStorageTypesObject$`code`
      }
      if (!is.null(GermplasmNewRequestStorageTypesObject$`description`)) {
        self$`description` <- GermplasmNewRequestStorageTypesObject$`description`
      }
      self
    },
    ...
    fromJSONString = function(GermplasmNewRequestStorageTypesJson) {
      GermplasmNewRequestStorageTypesObject <- jsonlite::fromJSON(GermplasmNewRequestStorageTypesJson)
      self$`code` <- GermplasmNewRequestStorageTypesObject$`code`
      self$`description` <- GermplasmNewRequestStorageTypesObject$`description`
      self
