...
#' @docType class
#' @title StudyTypesResponseResult
#'
#' @description StudyTypesResponseResult Class
#'
...
#' @export
StudyTypesResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      StudyTypesResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        StudyTypesResponseResultObject[['data']] <-
          self$`data`
      }

      StudyTypesResponseResultObject
    },
    fromJSON = function(StudyTypesResponseResultJson) {
      StudyTypesResponseResultObject <- jsonlite::fromJSON(StudyTypesResponseResultJson)
      if (!is.null(StudyTypesResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(StudyTypesResponseResultObject$`data`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(StudyTypesResponseResultJson) {
      StudyTypesResponseResultObject <- jsonlite::fromJSON(StudyTypesResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(StudyTypesResponseResultObject$`data`, "array[character]", loadNamespace("openapi"))
      self
    }
