...
#' @docType class
#' @title ObservationAllOf
#'
#' @description ObservationAllOf Class
#'
...
ObservationAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationAllOfObject <- list()
      if (!is.null(self$`observationDbId`)) {
        ObservationAllOfObject[['observationDbId']] <-
          self$`observationDbId`
      }

      ObservationAllOfObject
    },
    fromJSON = function(ObservationAllOfJson) {
      ObservationAllOfObject <- jsonlite::fromJSON(ObservationAllOfJson)
      if (!is.null(ObservationAllOfObject$`observationDbId`)) {
        self$`observationDbId` <- ObservationAllOfObject$`observationDbId`
      }
      self
    },
    ...
    fromJSONString = function(ObservationAllOfJson) {
      ObservationAllOfObject <- jsonlite::fromJSON(ObservationAllOfJson)
      self$`observationDbId` <- ObservationAllOfObject$`observationDbId`
      self
    }
