...
#' @docType class
#' @title ScaleBaseClassValidValuesCategories
#'
#' @description ScaleBaseClassValidValuesCategories Class
#'
...
#' @export
ScaleBaseClassValidValuesCategories <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ScaleBaseClassValidValuesCategoriesObject <- list()
      if (!is.null(self$`label`)) {
        ScaleBaseClassValidValuesCategoriesObject[['label']] <-
          self$`label`
      }
      if (!is.null(self$`value`)) {
        ScaleBaseClassValidValuesCategoriesObject[['value']] <-
          self$`value`
      }

      ScaleBaseClassValidValuesCategoriesObject
    },
    fromJSON = function(ScaleBaseClassValidValuesCategoriesJson) {
      ScaleBaseClassValidValuesCategoriesObject <- jsonlite::fromJSON(ScaleBaseClassValidValuesCategoriesJson)
      if (!is.null(ScaleBaseClassValidValuesCategoriesObject$`label`)) {
        self$`label` <- ScaleBaseClassValidValuesCategoriesObject$`label`
      }
      if (!is.null(ScaleBaseClassValidValuesCategoriesObject$`value`)) {
        self$`value` <- ScaleBaseClassValidValuesCategoriesObject$`value`
      }
      self
    },
    ...
    fromJSONString = function(ScaleBaseClassValidValuesCategoriesJson) {
      ScaleBaseClassValidValuesCategoriesObject <- jsonlite::fromJSON(ScaleBaseClassValidValuesCategoriesJson)
      self$`label` <- ScaleBaseClassValidValuesCategoriesObject$`label`
      self$`value` <- ScaleBaseClassValidValuesCategoriesObject$`value`
      self
