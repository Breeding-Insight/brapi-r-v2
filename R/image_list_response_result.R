...
#' @docType class
#' @title ImageListResponseResult
#'
#' @description ImageListResponseResult Class
#'
...
#' @export
ImageListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ImageListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        ImageListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      ImageListResponseResultObject
    },
    fromJSON = function(ImageListResponseResultJson) {
      ImageListResponseResultObject <- jsonlite::fromJSON(ImageListResponseResultJson)
      if (!is.null(ImageListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ImageListResponseResultObject$`data`, "array[Image]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ImageListResponseResultJson) {
      ImageListResponseResultObject <- jsonlite::fromJSON(ImageListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(ImageListResponseResultObject$`data`, "array[Image]", loadNamespace("openapi"))
      self
    }
