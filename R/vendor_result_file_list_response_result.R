...
#' @docType class
#' @title VendorResultFileListResponseResult
#'
#' @description VendorResultFileListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{VendorResultFile} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VendorResultFileListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VendorResultFileListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        VendorResultFileListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      VendorResultFileListResponseResultObject
    },
    fromJSON = function(VendorResultFileListResponseResultJson) {
      VendorResultFileListResponseResultObject <- jsonlite::fromJSON(VendorResultFileListResponseResultJson)
      if (!is.null(VendorResultFileListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(VendorResultFileListResponseResultObject$`data`, "array[VendorResultFile]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(VendorResultFileListResponseResultJson) {
      VendorResultFileListResponseResultObject <- jsonlite::fromJSON(VendorResultFileListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(VendorResultFileListResponseResultObject$`data`, "array[VendorResultFile]", loadNamespace("openapi"))
      self
    }
