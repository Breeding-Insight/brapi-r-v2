...
SampleAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SampleAllOfObject <- list()
      if (!is.null(self$`sampleDbId`)) {
        SampleAllOfObject[['sampleDbId']] <-
          self$`sampleDbId`
      }

      SampleAllOfObject
    },
    fromJSON = function(SampleAllOfJson) {
      SampleAllOfObject <- jsonlite::fromJSON(SampleAllOfJson)
      if (!is.null(SampleAllOfObject$`sampleDbId`)) {
        self$`sampleDbId` <- SampleAllOfObject$`sampleDbId`
      }
      self
    },
    ...
    fromJSONString = function(SampleAllOfJson) {
      SampleAllOfObject <- jsonlite::fromJSON(SampleAllOfJson)
      self$`sampleDbId` <- SampleAllOfObject$`sampleDbId`
      self
    }
