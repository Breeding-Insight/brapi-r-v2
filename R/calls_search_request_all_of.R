...
#' @docType class
#' @title CallsSearchRequestAllOf
#'
#' @description CallsSearchRequestAllOf Class
#'
...
#' @export
CallsSearchRequestAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CallsSearchRequestAllOfObject <- list()
      if (!is.null(self$`callSetDbIds`)) {
        CallsSearchRequestAllOfObject[['callSetDbIds']] <-
          self$`callSetDbIds`
      }
      if (!is.null(self$`expandHomozygotes`)) {
        CallsSearchRequestAllOfObject[['expandHomozygotes']] <-
          self$`expandHomozygotes`
      }
      if (!is.null(self$`sepPhased`)) {
        CallsSearchRequestAllOfObject[['sepPhased']] <-
          self$`sepPhased`
      }
      if (!is.null(self$`sepUnphased`)) {
        CallsSearchRequestAllOfObject[['sepUnphased']] <-
          self$`sepUnphased`
      }
      if (!is.null(self$`unknownString`)) {
        CallsSearchRequestAllOfObject[['unknownString']] <-
          self$`unknownString`
      }
      if (!is.null(self$`variantDbIds`)) {
        CallsSearchRequestAllOfObject[['variantDbIds']] <-
          self$`variantDbIds`
      }
      if (!is.null(self$`variantSetDbIds`)) {
        CallsSearchRequestAllOfObject[['variantSetDbIds']] <-
          self$`variantSetDbIds`
      }

      CallsSearchRequestAllOfObject
    },
    fromJSON = function(CallsSearchRequestAllOfJson) {
      CallsSearchRequestAllOfObject <- jsonlite::fromJSON(CallsSearchRequestAllOfJson)
      if (!is.null(CallsSearchRequestAllOfObject$`callSetDbIds`)) {
        self$`callSetDbIds` <- ApiClient$new()$deserializeObj(CallsSearchRequestAllOfObject$`callSetDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(CallsSearchRequestAllOfObject$`expandHomozygotes`)) {
        self$`expandHomozygotes` <- CallsSearchRequestAllOfObject$`expandHomozygotes`
      }
      if (!is.null(CallsSearchRequestAllOfObject$`sepPhased`)) {
        self$`sepPhased` <- CallsSearchRequestAllOfObject$`sepPhased`
      }
      if (!is.null(CallsSearchRequestAllOfObject$`sepUnphased`)) {
        self$`sepUnphased` <- CallsSearchRequestAllOfObject$`sepUnphased`
      }
      if (!is.null(CallsSearchRequestAllOfObject$`unknownString`)) {
        self$`unknownString` <- CallsSearchRequestAllOfObject$`unknownString`
      }
      if (!is.null(CallsSearchRequestAllOfObject$`variantDbIds`)) {
        self$`variantDbIds` <- ApiClient$new()$deserializeObj(CallsSearchRequestAllOfObject$`variantDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(CallsSearchRequestAllOfObject$`variantSetDbIds`)) {
        self$`variantSetDbIds` <- ApiClient$new()$deserializeObj(CallsSearchRequestAllOfObject$`variantSetDbIds`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(CallsSearchRequestAllOfJson) {
      CallsSearchRequestAllOfObject <- jsonlite::fromJSON(CallsSearchRequestAllOfJson)
      self$`callSetDbIds` <- ApiClient$new()$deserializeObj(CallsSearchRequestAllOfObject$`callSetDbIds`, "array[character]", loadNamespace("openapi"))
      self$`expandHomozygotes` <- CallsSearchRequestAllOfObject$`expandHomozygotes`
      self$`sepPhased` <- CallsSearchRequestAllOfObject$`sepPhased`
