...
#' @docType class
#' @title GermplasmAttributeNewRequestAllOf
#'
#' @description GermplasmAttributeNewRequestAllOf Class
#'
...
#' @export
GermplasmAttributeNewRequestAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    `attributeName` = NULL,
    initialize = function(
        `attributeName`, `attributeCategory`=NULL, `attributeDescription`=NULL, ...
    ) {
    ...
    toJSON = function() {
      GermplasmAttributeNewRequestAllOfObject <- list()
      if (!is.null(self$`attributeCategory`)) {
        GermplasmAttributeNewRequestAllOfObject[['attributeCategory']] <-
          self$`attributeCategory`
      }
      if (!is.null(self$`attributeDescription`)) {
        GermplasmAttributeNewRequestAllOfObject[['attributeDescription']] <-
          self$`attributeDescription`
      }
      if (!is.null(self$`attributeName`)) {
        GermplasmAttributeNewRequestAllOfObject[['attributeName']] <-
          self$`attributeName`
      }

      GermplasmAttributeNewRequestAllOfObject
    },
    fromJSON = function(GermplasmAttributeNewRequestAllOfJson) {
      GermplasmAttributeNewRequestAllOfObject <- jsonlite::fromJSON(GermplasmAttributeNewRequestAllOfJson)
      if (!is.null(GermplasmAttributeNewRequestAllOfObject$`attributeCategory`)) {
        self$`attributeCategory` <- GermplasmAttributeNewRequestAllOfObject$`attributeCategory`
      }
      if (!is.null(GermplasmAttributeNewRequestAllOfObject$`attributeDescription`)) {
        self$`attributeDescription` <- GermplasmAttributeNewRequestAllOfObject$`attributeDescription`
      }
      if (!is.null(GermplasmAttributeNewRequestAllOfObject$`attributeName`)) {
        self$`attributeName` <- GermplasmAttributeNewRequestAllOfObject$`attributeName`
      }
      self
    },
    ...
    fromJSONString = function(GermplasmAttributeNewRequestAllOfJson) {
      GermplasmAttributeNewRequestAllOfObject <- jsonlite::fromJSON(GermplasmAttributeNewRequestAllOfJson)
      self$`attributeCategory` <- GermplasmAttributeNewRequestAllOfObject$`attributeCategory`
      self$`attributeDescription` <- GermplasmAttributeNewRequestAllOfObject$`attributeDescription`
      self$`attributeName` <- GermplasmAttributeNewRequestAllOfObject$`attributeName`
