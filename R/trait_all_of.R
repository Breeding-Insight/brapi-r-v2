...
TraitAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      TraitAllOfObject <- list()
      if (!is.null(self$`traitDbId`)) {
        TraitAllOfObject[['traitDbId']] <-
          self$`traitDbId`
      }

      TraitAllOfObject
    },
    fromJSON = function(TraitAllOfJson) {
      TraitAllOfObject <- jsonlite::fromJSON(TraitAllOfJson)
      if (!is.null(TraitAllOfObject$`traitDbId`)) {
        self$`traitDbId` <- TraitAllOfObject$`traitDbId`
      }
      self
    },
    ...
    fromJSONString = function(TraitAllOfJson) {
      TraitAllOfObject <- jsonlite::fromJSON(TraitAllOfJson)
      self$`traitDbId` <- TraitAllOfObject$`traitDbId`
      self
    }
