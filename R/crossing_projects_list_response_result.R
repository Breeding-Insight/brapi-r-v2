...
#' @docType class
#' @title CrossingProjectsListResponseResult
#'
#' @description CrossingProjectsListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{CrossingProject} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
CrossingProjectsListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CrossingProjectsListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        CrossingProjectsListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      CrossingProjectsListResponseResultObject
    },
    fromJSON = function(CrossingProjectsListResponseResultJson) {
      CrossingProjectsListResponseResultObject <- jsonlite::fromJSON(CrossingProjectsListResponseResultJson)
      if (!is.null(CrossingProjectsListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(CrossingProjectsListResponseResultObject$`data`, "array[CrossingProject]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(CrossingProjectsListResponseResultJson) {
      CrossingProjectsListResponseResultObject <- jsonlite::fromJSON(CrossingProjectsListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(CrossingProjectsListResponseResultObject$`data`, "array[CrossingProject]", loadNamespace("openapi"))
      self
    }
