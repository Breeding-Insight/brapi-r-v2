...
#' @docType class
#' @title GermplasmListResponseResult
#'
#' @description GermplasmListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Germplasm} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GermplasmListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        GermplasmListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      GermplasmListResponseResultObject
    },
    fromJSON = function(GermplasmListResponseResultJson) {
      GermplasmListResponseResultObject <- jsonlite::fromJSON(GermplasmListResponseResultJson)
      if (!is.null(GermplasmListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(GermplasmListResponseResultObject$`data`, "array[Germplasm]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(GermplasmListResponseResultJson) {
      GermplasmListResponseResultObject <- jsonlite::fromJSON(GermplasmListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(GermplasmListResponseResultObject$`data`, "array[Germplasm]", loadNamespace("openapi"))
      self
    }
