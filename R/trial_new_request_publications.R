...
#' @docType class
#' @title TrialNewRequestPublications
#'
#' @description TrialNewRequestPublications Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field publicationPUI  character [optional]
#'
#' @field publicationReference  character [optional]
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
TrialNewRequestPublications <- R6::R6Class(
  'TrialNewRequestPublications',
  public = list(
    `publicationPUI` = NULL,
    `publicationReference` = NULL,
    initialize = function(
        `publicationPUI`=NULL, `publicationReference`=NULL, ...
    ) {
      local.optional.var <- list(...)
      if (!is.null(`publicationPUI`)) {
        stopifnot(is.character(`publicationPUI`), length(`publicationPUI`) == 1)
        self$`publicationPUI` <- `publicationPUI`
      }
      if (!is.null(`publicationReference`)) {
        stopifnot(is.character(`publicationReference`), length(`publicationReference`) == 1)
        self$`publicationReference` <- `publicationReference`
      }
    },
    toJSON = function() {
      TrialNewRequestPublicationsObject <- list()
      if (!is.null(self$`publicationPUI`)) {
        TrialNewRequestPublicationsObject[['publicationPUI']] <-
          self$`publicationPUI`
      }
      if (!is.null(self$`publicationReference`)) {
        TrialNewRequestPublicationsObject[['publicationReference']] <-
          self$`publicationReference`
      }

      TrialNewRequestPublicationsObject
    },
    fromJSON = function(TrialNewRequestPublicationsJson) {
      TrialNewRequestPublicationsObject <- jsonlite::fromJSON(TrialNewRequestPublicationsJson)
      if (!is.null(TrialNewRequestPublicationsObject$`publicationPUI`)) {
        self$`publicationPUI` <- TrialNewRequestPublicationsObject$`publicationPUI`
      }
      if (!is.null(TrialNewRequestPublicationsObject$`publicationReference`)) {
        self$`publicationReference` <- TrialNewRequestPublicationsObject$`publicationReference`
      }
      self
    },
    ...
    fromJSONString = function(TrialNewRequestPublicationsJson) {
      TrialNewRequestPublicationsObject <- jsonlite::fromJSON(TrialNewRequestPublicationsJson)
      self$`publicationPUI` <- TrialNewRequestPublicationsObject$`publicationPUI`
      self$`publicationReference` <- TrialNewRequestPublicationsObject$`publicationReference`
      self
