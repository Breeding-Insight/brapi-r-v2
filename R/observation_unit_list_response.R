...
#'
#' @description ObservationUnitListResponse Class
#'
...
#'
#' @field result  \link{ObservationUnitListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationUnitListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationUnitListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ObservationUnitListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ObservationUnitListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ObservationUnitListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ObservationUnitListResponseObject
    },
    fromJSON = function(ObservationUnitListResponseJson) {
      ObservationUnitListResponseObject <- jsonlite::fromJSON(ObservationUnitListResponseJson)
      if (!is.null(ObservationUnitListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ObservationUnitListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationUnitListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ObservationUnitListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ObservationUnitListResponseObject$`result`)) {
        resultObject <- ObservationUnitListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(ObservationUnitListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ObservationUnitListResponseJson) {
      ObservationUnitListResponseObject <- jsonlite::fromJSON(ObservationUnitListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ObservationUnitListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ObservationUnitListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ObservationUnitListResponseResult$new()$fromJSON(jsonlite::toJSON(ObservationUnitListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
