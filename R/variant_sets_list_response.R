...
#'
#' @description VariantSetsListResponse Class
#'
...
#'
#' @field result  \link{VariantSetsListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VariantSetsListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VariantSetsListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        VariantSetsListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        VariantSetsListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        VariantSetsListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      VariantSetsListResponseObject
    },
    fromJSON = function(VariantSetsListResponseJson) {
      VariantSetsListResponseObject <- jsonlite::fromJSON(VariantSetsListResponseJson)
      if (!is.null(VariantSetsListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(VariantSetsListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(VariantSetsListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(VariantSetsListResponseObject$`result`)) {
        resultObject <- VariantSetsListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(VariantSetsListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(VariantSetsListResponseJson) {
      VariantSetsListResponseObject <- jsonlite::fromJSON(VariantSetsListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(VariantSetsListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(VariantSetsListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- VariantSetsListResponseResult$new()$fromJSON(jsonlite::toJSON(VariantSetsListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
