...
#' @docType class
#' @title VariantSetsSearchRequestAllOf
#'
#' @description VariantSetsSearchRequestAllOf Class
#'
...
#' @export
VariantSetsSearchRequestAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(
        `callSetDbIds`=NULL, `variantDbIds`=NULL, `variantSetDbIds`=NULL, ...
    ) {
    ...
    toJSON = function() {
      VariantSetsSearchRequestAllOfObject <- list()
      if (!is.null(self$`callSetDbIds`)) {
        VariantSetsSearchRequestAllOfObject[['callSetDbIds']] <-
          self$`callSetDbIds`
      }
      if (!is.null(self$`variantDbIds`)) {
        VariantSetsSearchRequestAllOfObject[['variantDbIds']] <-
          self$`variantDbIds`
      }
      if (!is.null(self$`variantSetDbIds`)) {
        VariantSetsSearchRequestAllOfObject[['variantSetDbIds']] <-
          self$`variantSetDbIds`
      }

      VariantSetsSearchRequestAllOfObject
    },
    fromJSON = function(VariantSetsSearchRequestAllOfJson) {
      VariantSetsSearchRequestAllOfObject <- jsonlite::fromJSON(VariantSetsSearchRequestAllOfJson)
      if (!is.null(VariantSetsSearchRequestAllOfObject$`callSetDbIds`)) {
        self$`callSetDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestAllOfObject$`callSetDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsSearchRequestAllOfObject$`variantDbIds`)) {
        self$`variantDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestAllOfObject$`variantDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsSearchRequestAllOfObject$`variantSetDbIds`)) {
        self$`variantSetDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestAllOfObject$`variantSetDbIds`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(VariantSetsSearchRequestAllOfJson) {
      VariantSetsSearchRequestAllOfObject <- jsonlite::fromJSON(VariantSetsSearchRequestAllOfJson)
      self$`callSetDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestAllOfObject$`callSetDbIds`, "array[character]", loadNamespace("openapi"))
      self$`variantDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestAllOfObject$`variantDbIds`, "array[character]", loadNamespace("openapi"))
      self$`variantSetDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestAllOfObject$`variantSetDbIds`, "array[character]", loadNamespace("openapi"))
