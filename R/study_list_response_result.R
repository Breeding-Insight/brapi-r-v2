...
#' @docType class
#' @title StudyListResponseResult
#'
#' @description StudyListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Study} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
StudyListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      StudyListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        StudyListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      StudyListResponseResultObject
    },
    fromJSON = function(StudyListResponseResultJson) {
      StudyListResponseResultObject <- jsonlite::fromJSON(StudyListResponseResultJson)
      if (!is.null(StudyListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(StudyListResponseResultObject$`data`, "array[Study]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(StudyListResponseResultJson) {
      StudyListResponseResultObject <- jsonlite::fromJSON(StudyListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(StudyListResponseResultObject$`data`, "array[Study]", loadNamespace("openapi"))
      self
    }
