...
#'
#' @description VendorPlateListResponse Class
#'
...
#'
#' @field result  \link{VendorPlateListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VendorPlateListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VendorPlateListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        VendorPlateListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        VendorPlateListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        VendorPlateListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      VendorPlateListResponseObject
    },
    fromJSON = function(VendorPlateListResponseJson) {
      VendorPlateListResponseObject <- jsonlite::fromJSON(VendorPlateListResponseJson)
      if (!is.null(VendorPlateListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(VendorPlateListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VendorPlateListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(VendorPlateListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(VendorPlateListResponseObject$`result`)) {
        resultObject <- VendorPlateListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(VendorPlateListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(VendorPlateListResponseJson) {
      VendorPlateListResponseObject <- jsonlite::fromJSON(VendorPlateListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(VendorPlateListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(VendorPlateListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- VendorPlateListResponseResult$new()$fromJSON(jsonlite::toJSON(VendorPlateListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
