...
#' @docType class
#' @title SeedLotTransactionListResponseResult
#'
#' @description SeedLotTransactionListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{SeedLotTransaction} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SeedLotTransactionListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SeedLotTransactionListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        SeedLotTransactionListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      SeedLotTransactionListResponseResultObject
    },
    fromJSON = function(SeedLotTransactionListResponseResultJson) {
      SeedLotTransactionListResponseResultObject <- jsonlite::fromJSON(SeedLotTransactionListResponseResultJson)
      if (!is.null(SeedLotTransactionListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(SeedLotTransactionListResponseResultObject$`data`, "array[SeedLotTransaction]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(SeedLotTransactionListResponseResultJson) {
      SeedLotTransactionListResponseResultObject <- jsonlite::fromJSON(SeedLotTransactionListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(SeedLotTransactionListResponseResultObject$`data`, "array[SeedLotTransaction]", loadNamespace("openapi"))
      self
    }
