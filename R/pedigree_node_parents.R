...
#' @docType class
#' @title PedigreeNodeParents
#'
#' @description PedigreeNodeParents Class
#'
...
#' @export
PedigreeNodeParents <- R6::R6Class(
  'PedigreeNodeParents',
  public = list(
    `germplasmDbId` = NULL,
    `germplasmName` = NULL,
    `parentType` = NULL,
    initialize = function(
        `germplasmDbId`=NULL, `germplasmName`=NULL, `parentType`=NULL, ...
    ) {
    ...
    toJSON = function() {
      PedigreeNodeParentsObject <- list()
      if (!is.null(self$`germplasmDbId`)) {
        PedigreeNodeParentsObject[['germplasmDbId']] <-
          self$`germplasmDbId`
      }
      if (!is.null(self$`germplasmName`)) {
        PedigreeNodeParentsObject[['germplasmName']] <-
          self$`germplasmName`
      }
      if (!is.null(self$`parentType`)) {
        PedigreeNodeParentsObject[['parentType']] <-
          self$`parentType`
      }

      PedigreeNodeParentsObject
    },
    fromJSON = function(PedigreeNodeParentsJson) {
      PedigreeNodeParentsObject <- jsonlite::fromJSON(PedigreeNodeParentsJson)
      if (!is.null(PedigreeNodeParentsObject$`germplasmDbId`)) {
        self$`germplasmDbId` <- PedigreeNodeParentsObject$`germplasmDbId`
      }
      if (!is.null(PedigreeNodeParentsObject$`germplasmName`)) {
        self$`germplasmName` <- PedigreeNodeParentsObject$`germplasmName`
      }
      if (!is.null(PedigreeNodeParentsObject$`parentType`)) {
        self$`parentType` <- PedigreeNodeParentsObject$`parentType`
      }
      self
    },
    ...
    fromJSONString = function(PedigreeNodeParentsJson) {
      PedigreeNodeParentsObject <- jsonlite::fromJSON(PedigreeNodeParentsJson)
      self$`germplasmDbId` <- PedigreeNodeParentsObject$`germplasmDbId`
      self$`germplasmName` <- PedigreeNodeParentsObject$`germplasmName`
      self$`parentType` <- PedigreeNodeParentsObject$`parentType`
