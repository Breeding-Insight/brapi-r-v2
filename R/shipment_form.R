...
#' @title ShipmentForm
#'
#' @description ShipmentForm Class
#'
...
ShipmentForm <- R6::R6Class(
  ...
  public = list(
    ...
    `fileURL` = NULL,
    initialize = function(
        `fileURL`, `fileDescription`=NULL, `fileName`=NULL, ...
    ) {
    ...
    toJSON = function() {
      ShipmentFormObject <- list()
      if (!is.null(self$`fileDescription`)) {
        ShipmentFormObject[['fileDescription']] <-
          self$`fileDescription`
      }
      if (!is.null(self$`fileName`)) {
        ShipmentFormObject[['fileName']] <-
          self$`fileName`
      }
      if (!is.null(self$`fileURL`)) {
        ShipmentFormObject[['fileURL']] <-
          self$`fileURL`
      }

      ShipmentFormObject
    },
    fromJSON = function(ShipmentFormJson) {
      ShipmentFormObject <- jsonlite::fromJSON(ShipmentFormJson)
      if (!is.null(ShipmentFormObject$`fileDescription`)) {
        self$`fileDescription` <- ShipmentFormObject$`fileDescription`
      }
      if (!is.null(ShipmentFormObject$`fileName`)) {
        self$`fileName` <- ShipmentFormObject$`fileName`
      }
      if (!is.null(ShipmentFormObject$`fileURL`)) {
        self$`fileURL` <- ShipmentFormObject$`fileURL`
      }
      self
    },
    ...
    fromJSONString = function(ShipmentFormJson) {
      ShipmentFormObject <- jsonlite::fromJSON(ShipmentFormJson)
      self$`fileDescription` <- ShipmentFormObject$`fileDescription`
      self$`fileName` <- ShipmentFormObject$`fileName`
      self$`fileURL` <- ShipmentFormObject$`fileURL`
