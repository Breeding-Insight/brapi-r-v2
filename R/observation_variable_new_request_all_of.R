...
#' @docType class
#' @title ObservationVariableNewRequestAllOf
#'
#' @description ObservationVariableNewRequestAllOf Class
#'
...
#' @export
ObservationVariableNewRequestAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationVariableNewRequestAllOfObject <- list()
      if (!is.null(self$`observationVariableName`)) {
        ObservationVariableNewRequestAllOfObject[['observationVariableName']] <-
          self$`observationVariableName`
      }

      ObservationVariableNewRequestAllOfObject
    },
    fromJSON = function(ObservationVariableNewRequestAllOfJson) {
      ObservationVariableNewRequestAllOfObject <- jsonlite::fromJSON(ObservationVariableNewRequestAllOfJson)
      if (!is.null(ObservationVariableNewRequestAllOfObject$`observationVariableName`)) {
        self$`observationVariableName` <- ObservationVariableNewRequestAllOfObject$`observationVariableName`
      }
      self
    },
    ...
    fromJSONString = function(ObservationVariableNewRequestAllOfJson) {
      ObservationVariableNewRequestAllOfObject <- jsonlite::fromJSON(ObservationVariableNewRequestAllOfJson)
      self$`observationVariableName` <- ObservationVariableNewRequestAllOfObject$`observationVariableName`
      self
    }
