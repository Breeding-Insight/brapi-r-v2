...
#' @docType class
#' @title MarkerPositionListResponseResult
#'
#' @description MarkerPositionListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{MarkerPosition} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
MarkerPositionListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      MarkerPositionListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        MarkerPositionListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      MarkerPositionListResponseResultObject
    },
    fromJSON = function(MarkerPositionListResponseResultJson) {
      MarkerPositionListResponseResultObject <- jsonlite::fromJSON(MarkerPositionListResponseResultJson)
      if (!is.null(MarkerPositionListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(MarkerPositionListResponseResultObject$`data`, "array[MarkerPosition]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(MarkerPositionListResponseResultJson) {
      MarkerPositionListResponseResultObject <- jsonlite::fromJSON(MarkerPositionListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(MarkerPositionListResponseResultObject$`data`, "array[MarkerPosition]", loadNamespace("openapi"))
      self
    }
