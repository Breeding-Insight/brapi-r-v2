...
#'
#' @description GermplasmAttributeListResponse Class
#'
...
#'
#' @field result  \link{GermplasmAttributeListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GermplasmAttributeListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmAttributeListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        GermplasmAttributeListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        GermplasmAttributeListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        GermplasmAttributeListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      GermplasmAttributeListResponseObject
    },
    fromJSON = function(GermplasmAttributeListResponseJson) {
      GermplasmAttributeListResponseObject <- jsonlite::fromJSON(GermplasmAttributeListResponseJson)
      if (!is.null(GermplasmAttributeListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(GermplasmAttributeListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(GermplasmAttributeListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(GermplasmAttributeListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(GermplasmAttributeListResponseObject$`result`)) {
        resultObject <- GermplasmAttributeListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(GermplasmAttributeListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(GermplasmAttributeListResponseJson) {
      GermplasmAttributeListResponseObject <- jsonlite::fromJSON(GermplasmAttributeListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(GermplasmAttributeListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(GermplasmAttributeListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- GermplasmAttributeListResponseResult$new()$fromJSON(jsonlite::toJSON(GermplasmAttributeListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
