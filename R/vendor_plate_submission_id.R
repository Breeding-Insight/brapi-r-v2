...
#' @docType class
#' @title VendorPlateSubmissionId
#'
#' @description VendorPlateSubmissionId Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field submissionId  character 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VendorPlateSubmissionId <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VendorPlateSubmissionIdObject <- list()
      if (!is.null(self$`submissionId`)) {
        VendorPlateSubmissionIdObject[['submissionId']] <-
          self$`submissionId`
      }

      VendorPlateSubmissionIdObject
    },
    fromJSON = function(VendorPlateSubmissionIdJson) {
      VendorPlateSubmissionIdObject <- jsonlite::fromJSON(VendorPlateSubmissionIdJson)
      if (!is.null(VendorPlateSubmissionIdObject$`submissionId`)) {
        self$`submissionId` <- VendorPlateSubmissionIdObject$`submissionId`
      }
      self
    },
    ...
    fromJSONString = function(VendorPlateSubmissionIdJson) {
      VendorPlateSubmissionIdObject <- jsonlite::fromJSON(VendorPlateSubmissionIdJson)
      self$`submissionId` <- VendorPlateSubmissionIdObject$`submissionId`
      self
    }
