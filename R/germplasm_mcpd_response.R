...
#'
#' @description GermplasmMCPDResponse Class
#'
...
#'
#' @field result  \link{GermplasmMCPD} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GermplasmMCPDResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmMCPDResponseObject <- list()
      if (!is.null(self$`@context`)) {
        GermplasmMCPDResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        GermplasmMCPDResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        GermplasmMCPDResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      GermplasmMCPDResponseObject
    },
    fromJSON = function(GermplasmMCPDResponseJson) {
      GermplasmMCPDResponseObject <- jsonlite::fromJSON(GermplasmMCPDResponseJson)
      if (!is.null(GermplasmMCPDResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(GermplasmMCPDResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(GermplasmMCPDResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(GermplasmMCPDResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(GermplasmMCPDResponseObject$`result`)) {
        resultObject <- GermplasmMCPD$new()
        resultObject$fromJSON(jsonlite::toJSON(GermplasmMCPDResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(GermplasmMCPDResponseJson) {
      GermplasmMCPDResponseObject <- jsonlite::fromJSON(GermplasmMCPDResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(GermplasmMCPDResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(GermplasmMCPDResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- GermplasmMCPD$new()$fromJSON(jsonlite::toJSON(GermplasmMCPDResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
