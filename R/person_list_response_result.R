...
#' @docType class
#' @title PersonListResponseResult
#'
#' @description PersonListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Person} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PersonListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      PersonListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        PersonListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      PersonListResponseResultObject
    },
    fromJSON = function(PersonListResponseResultJson) {
      PersonListResponseResultObject <- jsonlite::fromJSON(PersonListResponseResultJson)
      if (!is.null(PersonListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(PersonListResponseResultObject$`data`, "array[Person]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(PersonListResponseResultJson) {
      PersonListResponseResultObject <- jsonlite::fromJSON(PersonListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(PersonListResponseResultObject$`data`, "array[Person]", loadNamespace("openapi"))
      self
    }
