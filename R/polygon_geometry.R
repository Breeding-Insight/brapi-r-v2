...
#'
#' @description PolygonGeometry Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field coordinates  list( \link{array[Array]} ) [optional]
#'
...
#' @export
PolygonGeometry <- R6::R6Class(
  'PolygonGeometry',
  public = list(
    `coordinates` = NULL,
    `type` = NULL,
    initialize = function(
        `coordinates`=NULL, `type`='Polygon', ...
    ) {
    ...
    toJSON = function() {
      PolygonGeometryObject <- list()
      if (!is.null(self$`coordinates`)) {
        PolygonGeometryObject[['coordinates']] <-
          lapply(self$`coordinates`, function(x) x$toJSON())
      }
      if (!is.null(self$`type`)) {
        PolygonGeometryObject[['type']] <-
          self$`type`
      }

      PolygonGeometryObject
    },
    fromJSON = function(PolygonGeometryJson) {
      PolygonGeometryObject <- jsonlite::fromJSON(PolygonGeometryJson)
      if (!is.null(PolygonGeometryObject$`coordinates`)) {
        self$`coordinates` <- ApiClient$new()$deserializeObj(PolygonGeometryObject$`coordinates`, "array[Array]", loadNamespace("openapi"))
      }
      if (!is.null(PolygonGeometryObject$`type`)) {
        self$`type` <- PolygonGeometryObject$`type`
      }
      self
    },
...
',
    ...
    fromJSONString = function(PolygonGeometryJson) {
      PolygonGeometryObject <- jsonlite::fromJSON(PolygonGeometryJson)
      self$`coordinates` <- ApiClient$new()$deserializeObj(PolygonGeometryObject$`coordinates`, "array[Array]", loadNamespace("openapi"))
      self$`type` <- PolygonGeometryObject$`type`
      self
