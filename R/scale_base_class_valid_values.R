...
#' @docType class
#' @title ScaleBaseClassValidValues
#'
#' @description ScaleBaseClassValidValues Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field categories  list( \link{ScaleBaseClassValidValuesCategories} ) [optional]
#'
...
#' @export
ScaleBaseClassValidValues <- R6::R6Class(
  ...
  public = list(
    ...
    `min` = NULL,
    initialize = function(
        `categories`=NULL, `max`=NULL, `min`=NULL, ...
    ) {
    ...
    toJSON = function() {
      ScaleBaseClassValidValuesObject <- list()
      if (!is.null(self$`categories`)) {
        ScaleBaseClassValidValuesObject[['categories']] <-
          lapply(self$`categories`, function(x) x$toJSON())
      }
      if (!is.null(self$`max`)) {
        ScaleBaseClassValidValuesObject[['max']] <-
          self$`max`
      }
      if (!is.null(self$`min`)) {
        ScaleBaseClassValidValuesObject[['min']] <-
          self$`min`
      }

      ScaleBaseClassValidValuesObject
    },
    fromJSON = function(ScaleBaseClassValidValuesJson) {
      ScaleBaseClassValidValuesObject <- jsonlite::fromJSON(ScaleBaseClassValidValuesJson)
      if (!is.null(ScaleBaseClassValidValuesObject$`categories`)) {
        self$`categories` <- ApiClient$new()$deserializeObj(ScaleBaseClassValidValuesObject$`categories`, "array[ScaleBaseClassValidValuesCategories]", loadNamespace("openapi"))
      }
      if (!is.null(ScaleBaseClassValidValuesObject$`max`)) {
        self$`max` <- ScaleBaseClassValidValuesObject$`max`
      }
      if (!is.null(ScaleBaseClassValidValuesObject$`min`)) {
        self$`min` <- ScaleBaseClassValidValuesObject$`min`
      }
      self
    },
...
',
    ...
    fromJSONString = function(ScaleBaseClassValidValuesJson) {
      ScaleBaseClassValidValuesObject <- jsonlite::fromJSON(ScaleBaseClassValidValuesJson)
      self$`categories` <- ApiClient$new()$deserializeObj(ScaleBaseClassValidValuesObject$`categories`, "array[ScaleBaseClassValidValuesCategories]", loadNamespace("openapi"))
      self$`max` <- ScaleBaseClassValidValuesObject$`max`
      self$`min` <- ScaleBaseClassValidValuesObject$`min`
