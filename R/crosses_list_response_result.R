...
#' @docType class
#' @title CrossesListResponseResult
#'
#' @description CrossesListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Cross} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
CrossesListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CrossesListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        CrossesListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      CrossesListResponseResultObject
    },
    fromJSON = function(CrossesListResponseResultJson) {
      CrossesListResponseResultObject <- jsonlite::fromJSON(CrossesListResponseResultJson)
      if (!is.null(CrossesListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(CrossesListResponseResultObject$`data`, "array[Cross]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(CrossesListResponseResultJson) {
      CrossesListResponseResultObject <- jsonlite::fromJSON(CrossesListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(CrossesListResponseResultObject$`data`, "array[Cross]", loadNamespace("openapi"))
      self
    }
