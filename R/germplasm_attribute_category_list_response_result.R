...
#' @docType class
#' @title GermplasmAttributeCategoryListResponseResult
#'
#' @description GermplasmAttributeCategoryListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( character ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GermplasmAttributeCategoryListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmAttributeCategoryListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        GermplasmAttributeCategoryListResponseResultObject[['data']] <-
          self$`data`
      }

      GermplasmAttributeCategoryListResponseResultObject
    },
    fromJSON = function(GermplasmAttributeCategoryListResponseResultJson) {
      GermplasmAttributeCategoryListResponseResultObject <- jsonlite::fromJSON(GermplasmAttributeCategoryListResponseResultJson)
      if (!is.null(GermplasmAttributeCategoryListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(GermplasmAttributeCategoryListResponseResultObject$`data`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(GermplasmAttributeCategoryListResponseResultJson) {
      GermplasmAttributeCategoryListResponseResultObject <- jsonlite::fromJSON(GermplasmAttributeCategoryListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(GermplasmAttributeCategoryListResponseResultObject$`data`, "array[character]", loadNamespace("openapi"))
      self
    }
