...
#' @docType class
#' @title ObservationListResponseResult
#'
#' @description ObservationListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Observation} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        ObservationListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      ObservationListResponseResultObject
    },
    fromJSON = function(ObservationListResponseResultJson) {
      ObservationListResponseResultObject <- jsonlite::fromJSON(ObservationListResponseResultJson)
      if (!is.null(ObservationListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ObservationListResponseResultObject$`data`, "array[Observation]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ObservationListResponseResultJson) {
      ObservationListResponseResultObject <- jsonlite::fromJSON(ObservationListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(ObservationListResponseResultObject$`data`, "array[Observation]", loadNamespace("openapi"))
      self
    }
