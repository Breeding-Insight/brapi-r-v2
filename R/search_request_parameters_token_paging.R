...
#' @docType class
#' @title SearchRequestParametersTokenPaging
#'
#' @description SearchRequestParametersTokenPaging Class
#'
...
#' @export
SearchRequestParametersTokenPaging <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SearchRequestParametersTokenPagingObject <- list()
      if (!is.null(self$`pageSize`)) {
        SearchRequestParametersTokenPagingObject[['pageSize']] <-
          self$`pageSize`
      }
      if (!is.null(self$`pageToken`)) {
        SearchRequestParametersTokenPagingObject[['pageToken']] <-
          self$`pageToken`
      }

      SearchRequestParametersTokenPagingObject
    },
    fromJSON = function(SearchRequestParametersTokenPagingJson) {
      SearchRequestParametersTokenPagingObject <- jsonlite::fromJSON(SearchRequestParametersTokenPagingJson)
      if (!is.null(SearchRequestParametersTokenPagingObject$`pageSize`)) {
        self$`pageSize` <- SearchRequestParametersTokenPagingObject$`pageSize`
      }
      if (!is.null(SearchRequestParametersTokenPagingObject$`pageToken`)) {
        self$`pageToken` <- SearchRequestParametersTokenPagingObject$`pageToken`
      }
      self
    },
    ...
    fromJSONString = function(SearchRequestParametersTokenPagingJson) {
      SearchRequestParametersTokenPagingObject <- jsonlite::fromJSON(SearchRequestParametersTokenPagingJson)
      self$`pageSize` <- SearchRequestParametersTokenPagingObject$`pageSize`
      self$`pageToken` <- SearchRequestParametersTokenPagingObject$`pageToken`
      self
