...
#'
#' @description ObservationVariableSingleResponse Class
#'
...
#'
#' @field result  \link{ObservationVariable} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationVariableSingleResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationVariableSingleResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ObservationVariableSingleResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ObservationVariableSingleResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ObservationVariableSingleResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ObservationVariableSingleResponseObject
    },
    fromJSON = function(ObservationVariableSingleResponseJson) {
      ObservationVariableSingleResponseObject <- jsonlite::fromJSON(ObservationVariableSingleResponseJson)
      if (!is.null(ObservationVariableSingleResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ObservationVariableSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationVariableSingleResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ObservationVariableSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ObservationVariableSingleResponseObject$`result`)) {
        resultObject <- ObservationVariable$new()
        resultObject$fromJSON(jsonlite::toJSON(ObservationVariableSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ObservationVariableSingleResponseJson) {
      ObservationVariableSingleResponseObject <- jsonlite::fromJSON(ObservationVariableSingleResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ObservationVariableSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ObservationVariableSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ObservationVariable$new()$fromJSON(jsonlite::toJSON(ObservationVariableSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
