...
TrialAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      TrialAllOfObject <- list()
      if (!is.null(self$`trialDbId`)) {
        TrialAllOfObject[['trialDbId']] <-
          self$`trialDbId`
      }

      TrialAllOfObject
    },
    fromJSON = function(TrialAllOfJson) {
      TrialAllOfObject <- jsonlite::fromJSON(TrialAllOfJson)
      if (!is.null(TrialAllOfObject$`trialDbId`)) {
        self$`trialDbId` <- TrialAllOfObject$`trialDbId`
      }
      self
    },
    ...
    fromJSONString = function(TrialAllOfJson) {
      TrialAllOfObject <- jsonlite::fromJSON(TrialAllOfJson)
      self$`trialDbId` <- TrialAllOfObject$`trialDbId`
      self
    }
