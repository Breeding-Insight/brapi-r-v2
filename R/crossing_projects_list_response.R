...
#'
#' @description CrossingProjectsListResponse Class
#'
...
#'
#' @field result  \link{CrossingProjectsListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
CrossingProjectsListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CrossingProjectsListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        CrossingProjectsListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        CrossingProjectsListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        CrossingProjectsListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      CrossingProjectsListResponseObject
    },
    fromJSON = function(CrossingProjectsListResponseJson) {
      CrossingProjectsListResponseObject <- jsonlite::fromJSON(CrossingProjectsListResponseJson)
      if (!is.null(CrossingProjectsListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(CrossingProjectsListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(CrossingProjectsListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(CrossingProjectsListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(CrossingProjectsListResponseObject$`result`)) {
        resultObject <- CrossingProjectsListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(CrossingProjectsListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(CrossingProjectsListResponseJson) {
      CrossingProjectsListResponseObject <- jsonlite::fromJSON(CrossingProjectsListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(CrossingProjectsListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(CrossingProjectsListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- CrossingProjectsListResponseResult$new()$fromJSON(jsonlite::toJSON(CrossingProjectsListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
