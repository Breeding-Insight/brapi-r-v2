...
#' @docType class
#' @title SearchRequestParametersTrials
#'
#' @description SearchRequestParametersTrials Class
#'
...
#' @export
SearchRequestParametersTrials <- R6::R6Class(
  'SearchRequestParametersTrials',
  public = list(
    `trialDbIds` = NULL,
    `trialNames` = NULL,
    initialize = function(
        `trialDbIds`=NULL, `trialNames`=NULL, ...
    ) {
    ...
    toJSON = function() {
      SearchRequestParametersTrialsObject <- list()
      if (!is.null(self$`trialDbIds`)) {
        SearchRequestParametersTrialsObject[['trialDbIds']] <-
          self$`trialDbIds`
      }
      if (!is.null(self$`trialNames`)) {
        SearchRequestParametersTrialsObject[['trialNames']] <-
          self$`trialNames`
      }

      SearchRequestParametersTrialsObject
    },
    fromJSON = function(SearchRequestParametersTrialsJson) {
      SearchRequestParametersTrialsObject <- jsonlite::fromJSON(SearchRequestParametersTrialsJson)
      if (!is.null(SearchRequestParametersTrialsObject$`trialDbIds`)) {
        self$`trialDbIds` <- ApiClient$new()$deserializeObj(SearchRequestParametersTrialsObject$`trialDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(SearchRequestParametersTrialsObject$`trialNames`)) {
        self$`trialNames` <- ApiClient$new()$deserializeObj(SearchRequestParametersTrialsObject$`trialNames`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(SearchRequestParametersTrialsJson) {
      SearchRequestParametersTrialsObject <- jsonlite::fromJSON(SearchRequestParametersTrialsJson)
      self$`trialDbIds` <- ApiClient$new()$deserializeObj(SearchRequestParametersTrialsObject$`trialDbIds`, "array[character]", loadNamespace("openapi"))
      self$`trialNames` <- ApiClient$new()$deserializeObj(SearchRequestParametersTrialsObject$`trialNames`, "array[character]", loadNamespace("openapi"))
      self
