...
#' @docType class
#' @title ListsListResponseResult
#'
#' @description ListsListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{ListSummary} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ListsListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ListsListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        ListsListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      ListsListResponseResultObject
    },
    fromJSON = function(ListsListResponseResultJson) {
      ListsListResponseResultObject <- jsonlite::fromJSON(ListsListResponseResultJson)
      if (!is.null(ListsListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ListsListResponseResultObject$`data`, "array[ListSummary]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ListsListResponseResultJson) {
      ListsListResponseResultObject <- jsonlite::fromJSON(ListsListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(ListsListResponseResultObject$`data`, "array[ListSummary]", loadNamespace("openapi"))
      self
    }
