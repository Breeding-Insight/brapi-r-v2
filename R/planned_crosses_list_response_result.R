...
#' @docType class
#' @title PlannedCrossesListResponseResult
#'
#' @description PlannedCrossesListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{PlannedCross} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PlannedCrossesListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      PlannedCrossesListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        PlannedCrossesListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      PlannedCrossesListResponseResultObject
    },
    fromJSON = function(PlannedCrossesListResponseResultJson) {
      PlannedCrossesListResponseResultObject <- jsonlite::fromJSON(PlannedCrossesListResponseResultJson)
      if (!is.null(PlannedCrossesListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(PlannedCrossesListResponseResultObject$`data`, "array[PlannedCross]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(PlannedCrossesListResponseResultJson) {
      PlannedCrossesListResponseResultObject <- jsonlite::fromJSON(PlannedCrossesListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(PlannedCrossesListResponseResultObject$`data`, "array[PlannedCross]", loadNamespace("openapi"))
      self
    }
