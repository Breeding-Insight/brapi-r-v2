...
#' @title SeedLotAllOf
#'
#' @description SeedLotAllOf Class
#'
...
SeedLotAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SeedLotAllOfObject <- list()
      if (!is.null(self$`seedLotDbId`)) {
        SeedLotAllOfObject[['seedLotDbId']] <-
          self$`seedLotDbId`
      }

      SeedLotAllOfObject
    },
    fromJSON = function(SeedLotAllOfJson) {
      SeedLotAllOfObject <- jsonlite::fromJSON(SeedLotAllOfJson)
      if (!is.null(SeedLotAllOfObject$`seedLotDbId`)) {
        self$`seedLotDbId` <- SeedLotAllOfObject$`seedLotDbId`
      }
      self
    },
    ...
    fromJSONString = function(SeedLotAllOfJson) {
      SeedLotAllOfObject <- jsonlite::fromJSON(SeedLotAllOfJson)
      self$`seedLotDbId` <- SeedLotAllOfObject$`seedLotDbId`
      self
    }
