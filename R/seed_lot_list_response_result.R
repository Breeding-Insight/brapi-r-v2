...
#' @docType class
#' @title SeedLotListResponseResult
#'
#' @description SeedLotListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{SeedLot} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SeedLotListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SeedLotListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        SeedLotListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      SeedLotListResponseResultObject
    },
    fromJSON = function(SeedLotListResponseResultJson) {
      SeedLotListResponseResultObject <- jsonlite::fromJSON(SeedLotListResponseResultJson)
      if (!is.null(SeedLotListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(SeedLotListResponseResultObject$`data`, "array[SeedLot]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(SeedLotListResponseResultJson) {
      SeedLotListResponseResultObject <- jsonlite::fromJSON(SeedLotListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(SeedLotListResponseResultObject$`data`, "array[SeedLot]", loadNamespace("openapi"))
      self
    }
