...
#'
#' @field progeny  list( \link{ProgenyNodeProgeny} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ProgenyNode <- R6::R6Class(
  'ProgenyNode',
  public = list(
    `germplasmDbId` = NULL,
    `germplasmName` = NULL,
    `progeny` = NULL,
    initialize = function(
        `germplasmDbId`, `progeny`, `germplasmName`=NULL, ...
    ) {
      ...
      if (!missing(`progeny`)) {
        stopifnot(is.vector(`progeny`), length(`progeny`) != 0)
        sapply(`progeny`, function(x) stopifnot(R6::is.R6(x)))
    ...
    toJSON = function() {
      ProgenyNodeObject <- list()
      if (!is.null(self$`germplasmDbId`)) {
        ProgenyNodeObject[['germplasmDbId']] <-
          self$`germplasmDbId`
      }
      if (!is.null(self$`germplasmName`)) {
        ProgenyNodeObject[['germplasmName']] <-
          self$`germplasmName`
      }
      if (!is.null(self$`progeny`)) {
        ProgenyNodeObject[['progeny']] <-
          lapply(self$`progeny`, function(x) x$toJSON())
      }

      ProgenyNodeObject
    },
    fromJSON = function(ProgenyNodeJson) {
      ProgenyNodeObject <- jsonlite::fromJSON(ProgenyNodeJson)
      if (!is.null(ProgenyNodeObject$`germplasmDbId`)) {
        self$`germplasmDbId` <- ProgenyNodeObject$`germplasmDbId`
      }
      if (!is.null(ProgenyNodeObject$`germplasmName`)) {
        self$`germplasmName` <- ProgenyNodeObject$`germplasmName`
      }
      if (!is.null(ProgenyNodeObject$`progeny`)) {
        self$`progeny` <- ApiClient$new()$deserializeObj(ProgenyNodeObject$`progeny`, "array[ProgenyNodeProgeny]", loadNamespace("openapi"))
      }
      self
    },
    toJSONString = function() {
      jsoncontent <- c(
        ...
        [%s]
',
        paste(sapply(self$`progeny`, function(x) jsonlite::toJSON(x$toJSON(), auto_unbox=TRUE, digits = NA)), collapse=",")
        )}
      )
      jsoncontent <- paste(jsoncontent, collapse = ",")
      paste('{', jsoncontent, '}', sep = "")
    },
    fromJSONString = function(ProgenyNodeJson) {
      ProgenyNodeObject <- jsonlite::fromJSON(ProgenyNodeJson)
      self$`germplasmDbId` <- ProgenyNodeObject$`germplasmDbId`
      self$`germplasmName` <- ProgenyNodeObject$`germplasmName`
      self$`progeny` <- ApiClient$new()$deserializeObj(ProgenyNodeObject$`progeny`, "array[ProgenyNodeProgeny]", loadNamespace("openapi"))
