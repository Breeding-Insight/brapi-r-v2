...
#' @docType class
#' @title ScaleListResponseResult
#'
#' @description ScaleListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Scale} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ScaleListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ScaleListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        ScaleListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      ScaleListResponseResultObject
    },
    fromJSON = function(ScaleListResponseResultJson) {
      ScaleListResponseResultObject <- jsonlite::fromJSON(ScaleListResponseResultJson)
      if (!is.null(ScaleListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(ScaleListResponseResultObject$`data`, "array[Scale]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(ScaleListResponseResultJson) {
      ScaleListResponseResultObject <- jsonlite::fromJSON(ScaleListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(ScaleListResponseResultObject$`data`, "array[Scale]", loadNamespace("openapi"))
      self
    }
