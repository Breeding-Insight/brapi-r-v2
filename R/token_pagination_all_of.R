...
#' @docType class
#' @title TokenPaginationAllOf
#'
#' @description TokenPaginationAllOf Class
#'
...
#' @export
TokenPaginationAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    `prevPageToken` = NULL,
    initialize = function(
        `nextPageToken`, `currentPageToken`=NULL, `prevPageToken`=NULL, ...
    ) {
    ...
    toJSON = function() {
      TokenPaginationAllOfObject <- list()
      if (!is.null(self$`currentPageToken`)) {
        TokenPaginationAllOfObject[['currentPageToken']] <-
          self$`currentPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        TokenPaginationAllOfObject[['nextPageToken']] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        TokenPaginationAllOfObject[['prevPageToken']] <-
          self$`prevPageToken`
      }

      TokenPaginationAllOfObject
    },
    fromJSON = function(TokenPaginationAllOfJson) {
      TokenPaginationAllOfObject <- jsonlite::fromJSON(TokenPaginationAllOfJson)
      if (!is.null(TokenPaginationAllOfObject$`currentPageToken`)) {
        self$`currentPageToken` <- TokenPaginationAllOfObject$`currentPageToken`
      }
      if (!is.null(TokenPaginationAllOfObject$`nextPageToken`)) {
        self$`nextPageToken` <- TokenPaginationAllOfObject$`nextPageToken`
      }
      if (!is.null(TokenPaginationAllOfObject$`prevPageToken`)) {
        self$`prevPageToken` <- TokenPaginationAllOfObject$`prevPageToken`
      }
      self
    },
    ...
    fromJSONString = function(TokenPaginationAllOfJson) {
      TokenPaginationAllOfObject <- jsonlite::fromJSON(TokenPaginationAllOfJson)
      self$`currentPageToken` <- TokenPaginationAllOfObject$`currentPageToken`
      self$`nextPageToken` <- TokenPaginationAllOfObject$`nextPageToken`
      self$`prevPageToken` <- TokenPaginationAllOfObject$`prevPageToken`
