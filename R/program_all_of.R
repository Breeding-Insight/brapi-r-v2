...
#' @title ProgramAllOf
#'
#' @description ProgramAllOf Class
#'
...
ProgramAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ProgramAllOfObject <- list()
      if (!is.null(self$`programDbId`)) {
        ProgramAllOfObject[['programDbId']] <-
          self$`programDbId`
      }

      ProgramAllOfObject
    },
    fromJSON = function(ProgramAllOfJson) {
      ProgramAllOfObject <- jsonlite::fromJSON(ProgramAllOfJson)
      if (!is.null(ProgramAllOfObject$`programDbId`)) {
        self$`programDbId` <- ProgramAllOfObject$`programDbId`
      }
      self
    },
    ...
    fromJSONString = function(ProgramAllOfJson) {
      ProgramAllOfObject <- jsonlite::fromJSON(ProgramAllOfJson)
      self$`programDbId` <- ProgramAllOfObject$`programDbId`
      self
    }
