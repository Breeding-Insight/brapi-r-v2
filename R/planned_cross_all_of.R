...
#' @docType class
#' @title PlannedCrossAllOf
#'
#' @description PlannedCrossAllOf Class
#'
...
PlannedCrossAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      PlannedCrossAllOfObject <- list()
      if (!is.null(self$`plannedCrossDbId`)) {
        PlannedCrossAllOfObject[['plannedCrossDbId']] <-
          self$`plannedCrossDbId`
      }

      PlannedCrossAllOfObject
    },
    fromJSON = function(PlannedCrossAllOfJson) {
      PlannedCrossAllOfObject <- jsonlite::fromJSON(PlannedCrossAllOfJson)
      if (!is.null(PlannedCrossAllOfObject$`plannedCrossDbId`)) {
        self$`plannedCrossDbId` <- PlannedCrossAllOfObject$`plannedCrossDbId`
      }
      self
    },
    ...
    fromJSONString = function(PlannedCrossAllOfJson) {
      PlannedCrossAllOfObject <- jsonlite::fromJSON(PlannedCrossAllOfJson)
      self$`plannedCrossDbId` <- PlannedCrossAllOfObject$`plannedCrossDbId`
      self
    }
