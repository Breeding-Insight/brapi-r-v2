...
#'
#' @description GenomeMapListResponse Class
#'
...
#'
#' @field result  \link{GenomeMapListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
GenomeMapListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GenomeMapListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        GenomeMapListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        GenomeMapListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        GenomeMapListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      GenomeMapListResponseObject
    },
    fromJSON = function(GenomeMapListResponseJson) {
      GenomeMapListResponseObject <- jsonlite::fromJSON(GenomeMapListResponseJson)
      if (!is.null(GenomeMapListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(GenomeMapListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(GenomeMapListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(GenomeMapListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(GenomeMapListResponseObject$`result`)) {
        resultObject <- GenomeMapListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(GenomeMapListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(GenomeMapListResponseJson) {
      GenomeMapListResponseObject <- jsonlite::fromJSON(GenomeMapListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(GenomeMapListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(GenomeMapListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- GenomeMapListResponseResult$new()$fromJSON(jsonlite::toJSON(GenomeMapListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
