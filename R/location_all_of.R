...
#' @title LocationAllOf
#'
#' @description LocationAllOf Class
#'
...
LocationAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      LocationAllOfObject <- list()
      if (!is.null(self$`locationDbId`)) {
        LocationAllOfObject[['locationDbId']] <-
          self$`locationDbId`
      }

      LocationAllOfObject
    },
    fromJSON = function(LocationAllOfJson) {
      LocationAllOfObject <- jsonlite::fromJSON(LocationAllOfJson)
      if (!is.null(LocationAllOfObject$`locationDbId`)) {
        self$`locationDbId` <- LocationAllOfObject$`locationDbId`
      }
      self
    },
    ...
    fromJSONString = function(LocationAllOfJson) {
      LocationAllOfObject <- jsonlite::fromJSON(LocationAllOfJson)
      self$`locationDbId` <- LocationAllOfObject$`locationDbId`
      self
    }
