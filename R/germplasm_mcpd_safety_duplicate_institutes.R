...
#' @docType class
#' @title GermplasmMCPDSafetyDuplicateInstitutes
#'
#' @description GermplasmMCPDSafetyDuplicateInstitutes Class
#'
...
#' @export
GermplasmMCPDSafetyDuplicateInstitutes <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      GermplasmMCPDSafetyDuplicateInstitutesObject <- list()
      if (!is.null(self$`instituteCode`)) {
        GermplasmMCPDSafetyDuplicateInstitutesObject[['instituteCode']] <-
          self$`instituteCode`
      }
      if (!is.null(self$`instituteName`)) {
        GermplasmMCPDSafetyDuplicateInstitutesObject[['instituteName']] <-
          self$`instituteName`
      }

      GermplasmMCPDSafetyDuplicateInstitutesObject
    },
    fromJSON = function(GermplasmMCPDSafetyDuplicateInstitutesJson) {
      GermplasmMCPDSafetyDuplicateInstitutesObject <- jsonlite::fromJSON(GermplasmMCPDSafetyDuplicateInstitutesJson)
      if (!is.null(GermplasmMCPDSafetyDuplicateInstitutesObject$`instituteCode`)) {
        self$`instituteCode` <- GermplasmMCPDSafetyDuplicateInstitutesObject$`instituteCode`
      }
      if (!is.null(GermplasmMCPDSafetyDuplicateInstitutesObject$`instituteName`)) {
        self$`instituteName` <- GermplasmMCPDSafetyDuplicateInstitutesObject$`instituteName`
      }
      self
    },
    ...
    fromJSONString = function(GermplasmMCPDSafetyDuplicateInstitutesJson) {
      GermplasmMCPDSafetyDuplicateInstitutesObject <- jsonlite::fromJSON(GermplasmMCPDSafetyDuplicateInstitutesJson)
      self$`instituteCode` <- GermplasmMCPDSafetyDuplicateInstitutesObject$`instituteCode`
      self$`instituteName` <- GermplasmMCPDSafetyDuplicateInstitutesObject$`instituteName`
      self
