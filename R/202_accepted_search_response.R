...
#'
#' @description 202AcceptedSearchResponse Class
#'
...
#'
#' @field result  \link{202AcceptedSearchResponseResult} [optional]
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
202AcceptedSearchResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      202AcceptedSearchResponseObject <- list()
      if (!is.null(self$`@context`)) {
        202AcceptedSearchResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        202AcceptedSearchResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        202AcceptedSearchResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      202AcceptedSearchResponseObject
    },
    fromJSON = function(202AcceptedSearchResponseJson) {
      202AcceptedSearchResponseObject <- jsonlite::fromJSON(202AcceptedSearchResponseJson)
      if (!is.null(202AcceptedSearchResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(202AcceptedSearchResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(202AcceptedSearchResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(202AcceptedSearchResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(202AcceptedSearchResponseObject$`result`)) {
        resultObject <- 202AcceptedSearchResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(202AcceptedSearchResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(202AcceptedSearchResponseJson) {
      202AcceptedSearchResponseObject <- jsonlite::fromJSON(202AcceptedSearchResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(202AcceptedSearchResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(202AcceptedSearchResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- 202AcceptedSearchResponseResult$new()$fromJSON(jsonlite::toJSON(202AcceptedSearchResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
