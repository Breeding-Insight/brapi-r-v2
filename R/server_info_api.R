...
#' @docType class
#' @title ServerInfo operations
#' @description openapi.ServerInfo
#' @format An \code{R6Class} generator object
#' @field apiClient Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ ServerinfoGet } \emph{ Get the list of implemented Calls }
...
#'
#' \itemize{
#' \item \emph{ @param } data.type \link{WSMIMEDataTypes}
#' \item \emph{ @param } authorization character
#' \item \emph{ @returnType } \link{ServerInfoResponse} \cr
#'
#'
#' \item status code : 200 | OK
#'
#' \item return type : ServerInfoResponse 
...
ServerInfoApi <- R6::R6Class(
  ...
  public = list(
    ...
    ServerinfoGet = function(data.type=NULL, authorization=NULL, ...){
      apiResponse <- self$ServerinfoGetWithHttpInfo(data.type, authorization, ...)
    ...
    ServerinfoGetWithHttpInfo = function(data.type=NULL, authorization=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      queryParams['dataType'] <- data.type
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "ServerInfoResponse", loadNamespace("openapi")),
          error = function(e){
