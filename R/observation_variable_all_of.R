...
#' @docType class
#' @title ObservationVariableAllOf
#'
#' @description ObservationVariableAllOf Class
#'
...
#' @export
ObservationVariableAllOf <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationVariableAllOfObject <- list()
      if (!is.null(self$`observationVariableDbId`)) {
        ObservationVariableAllOfObject[['observationVariableDbId']] <-
          self$`observationVariableDbId`
      }
      if (!is.null(self$`observationVariableName`)) {
        ObservationVariableAllOfObject[['observationVariableName']] <-
          self$`observationVariableName`
      }

      ObservationVariableAllOfObject
    },
    fromJSON = function(ObservationVariableAllOfJson) {
      ObservationVariableAllOfObject <- jsonlite::fromJSON(ObservationVariableAllOfJson)
      if (!is.null(ObservationVariableAllOfObject$`observationVariableDbId`)) {
        self$`observationVariableDbId` <- ObservationVariableAllOfObject$`observationVariableDbId`
      }
      if (!is.null(ObservationVariableAllOfObject$`observationVariableName`)) {
        self$`observationVariableName` <- ObservationVariableAllOfObject$`observationVariableName`
      }
      self
    },
    ...
    fromJSONString = function(ObservationVariableAllOfJson) {
      ObservationVariableAllOfObject <- jsonlite::fromJSON(ObservationVariableAllOfJson)
      self$`observationVariableDbId` <- ObservationVariableAllOfObject$`observationVariableDbId`
      self$`observationVariableName` <- ObservationVariableAllOfObject$`observationVariableName`
      self
