...
#'
#' @description VendorSpecificationSingleResponse Class
#'
...
#'
#' @field result  \link{VendorSpecification} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VendorSpecificationSingleResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VendorSpecificationSingleResponseObject <- list()
      if (!is.null(self$`@context`)) {
        VendorSpecificationSingleResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        VendorSpecificationSingleResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        VendorSpecificationSingleResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      VendorSpecificationSingleResponseObject
    },
    fromJSON = function(VendorSpecificationSingleResponseJson) {
      VendorSpecificationSingleResponseObject <- jsonlite::fromJSON(VendorSpecificationSingleResponseJson)
      if (!is.null(VendorSpecificationSingleResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(VendorSpecificationSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VendorSpecificationSingleResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(VendorSpecificationSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(VendorSpecificationSingleResponseObject$`result`)) {
        resultObject <- VendorSpecification$new()
        resultObject$fromJSON(jsonlite::toJSON(VendorSpecificationSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(VendorSpecificationSingleResponseJson) {
      VendorSpecificationSingleResponseObject <- jsonlite::fromJSON(VendorSpecificationSingleResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(VendorSpecificationSingleResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(VendorSpecificationSingleResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- VendorSpecification$new()$fromJSON(jsonlite::toJSON(VendorSpecificationSingleResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
