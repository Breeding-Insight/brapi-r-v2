...
#'
#' @description VendorOrderStatusResponse Class
#'
...
#'
#' @field result  \link{VendorOrderStatusResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VendorOrderStatusResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VendorOrderStatusResponseObject <- list()
      if (!is.null(self$`@context`)) {
        VendorOrderStatusResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        VendorOrderStatusResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        VendorOrderStatusResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      VendorOrderStatusResponseObject
    },
    fromJSON = function(VendorOrderStatusResponseJson) {
      VendorOrderStatusResponseObject <- jsonlite::fromJSON(VendorOrderStatusResponseJson)
      if (!is.null(VendorOrderStatusResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(VendorOrderStatusResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VendorOrderStatusResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(VendorOrderStatusResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(VendorOrderStatusResponseObject$`result`)) {
        resultObject <- VendorOrderStatusResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(VendorOrderStatusResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(VendorOrderStatusResponseJson) {
      VendorOrderStatusResponseObject <- jsonlite::fromJSON(VendorOrderStatusResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(VendorOrderStatusResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(VendorOrderStatusResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- VendorOrderStatusResponseResult$new()$fromJSON(jsonlite::toJSON(VendorOrderStatusResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
