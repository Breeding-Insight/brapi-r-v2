...
#' @docType class
#' @title VariantSetsSearchRequest
#'
#' @description VariantSetsSearchRequest Class
#'
...
#' @export
VariantSetsSearchRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(
        `page`=NULL, `pageSize`=NULL, `studyDbIds`=NULL, `studyNames`=NULL, `callSetDbIds`=NULL, `variantDbIds`=NULL, `variantSetDbIds`=NULL, ...
    ) {
    ...
    toJSON = function() {
      VariantSetsSearchRequestObject <- list()
      if (!is.null(self$`page`)) {
        VariantSetsSearchRequestObject[['page']] <-
          self$`page`
      }
      if (!is.null(self$`pageSize`)) {
        VariantSetsSearchRequestObject[['pageSize']] <-
          self$`pageSize`
      }
      if (!is.null(self$`studyDbIds`)) {
        VariantSetsSearchRequestObject[['studyDbIds']] <-
          self$`studyDbIds`
      }
      if (!is.null(self$`studyNames`)) {
        VariantSetsSearchRequestObject[['studyNames']] <-
          self$`studyNames`
      }
      if (!is.null(self$`callSetDbIds`)) {
        VariantSetsSearchRequestObject[['callSetDbIds']] <-
          self$`callSetDbIds`
      }
      if (!is.null(self$`variantDbIds`)) {
        VariantSetsSearchRequestObject[['variantDbIds']] <-
          self$`variantDbIds`
      }
      if (!is.null(self$`variantSetDbIds`)) {
        VariantSetsSearchRequestObject[['variantSetDbIds']] <-
          self$`variantSetDbIds`
      }

      VariantSetsSearchRequestObject
    },
    fromJSON = function(VariantSetsSearchRequestJson) {
      VariantSetsSearchRequestObject <- jsonlite::fromJSON(VariantSetsSearchRequestJson)
      if (!is.null(VariantSetsSearchRequestObject$`page`)) {
        self$`page` <- VariantSetsSearchRequestObject$`page`
      }
      if (!is.null(VariantSetsSearchRequestObject$`pageSize`)) {
        self$`pageSize` <- VariantSetsSearchRequestObject$`pageSize`
      }
      if (!is.null(VariantSetsSearchRequestObject$`studyDbIds`)) {
        self$`studyDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestObject$`studyDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsSearchRequestObject$`studyNames`)) {
        self$`studyNames` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestObject$`studyNames`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsSearchRequestObject$`callSetDbIds`)) {
        self$`callSetDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestObject$`callSetDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsSearchRequestObject$`variantDbIds`)) {
        self$`variantDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestObject$`variantDbIds`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(VariantSetsSearchRequestObject$`variantSetDbIds`)) {
        self$`variantSetDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestObject$`variantSetDbIds`, "array[character]", loadNamespace("openapi"))
      }
      self
    },
    ...
    fromJSONString = function(VariantSetsSearchRequestJson) {
      VariantSetsSearchRequestObject <- jsonlite::fromJSON(VariantSetsSearchRequestJson)
      self$`page` <- VariantSetsSearchRequestObject$`page`
      self$`pageSize` <- VariantSetsSearchRequestObject$`pageSize`
      self$`studyDbIds` <- ApiClient$new()$deserializeObj(VariantSetsSearchRequestObject$`studyDbIds`, "array[character]", loadNamespace("openapi"))
