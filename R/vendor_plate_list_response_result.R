...
#' @docType class
#' @title VendorPlateListResponseResult
#'
#' @description VendorPlateListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{VendorPlate} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VendorPlateListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      VendorPlateListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        VendorPlateListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      VendorPlateListResponseResultObject
    },
    fromJSON = function(VendorPlateListResponseResultJson) {
      VendorPlateListResponseResultObject <- jsonlite::fromJSON(VendorPlateListResponseResultJson)
      if (!is.null(VendorPlateListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(VendorPlateListResponseResultObject$`data`, "array[VendorPlate]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(VendorPlateListResponseResultJson) {
      VendorPlateListResponseResultObject <- jsonlite::fromJSON(VendorPlateListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(VendorPlateListResponseResultObject$`data`, "array[VendorPlate]", loadNamespace("openapi"))
      self
    }
