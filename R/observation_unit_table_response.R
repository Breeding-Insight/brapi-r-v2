...
#'
#' @description ObservationUnitTableResponse Class
#'
...
#'
#' @field result  \link{ObservationUnitTable} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationUnitTableResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationUnitTableResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ObservationUnitTableResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ObservationUnitTableResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ObservationUnitTableResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ObservationUnitTableResponseObject
    },
    fromJSON = function(ObservationUnitTableResponseJson) {
      ObservationUnitTableResponseObject <- jsonlite::fromJSON(ObservationUnitTableResponseJson)
      if (!is.null(ObservationUnitTableResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ObservationUnitTableResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationUnitTableResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ObservationUnitTableResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ObservationUnitTableResponseObject$`result`)) {
        resultObject <- ObservationUnitTable$new()
        resultObject$fromJSON(jsonlite::toJSON(ObservationUnitTableResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ObservationUnitTableResponseJson) {
      ObservationUnitTableResponseObject <- jsonlite::fromJSON(ObservationUnitTableResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ObservationUnitTableResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ObservationUnitTableResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ObservationUnitTable$new()$fromJSON(jsonlite::toJSON(ObservationUnitTableResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
