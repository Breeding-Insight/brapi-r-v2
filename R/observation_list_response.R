...
#'
#' @description ObservationListResponse Class
#'
...
#'
#' @field result  \link{ObservationListResponseResult} 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ObservationListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ObservationListResponseObject <- list()
      if (!is.null(self$`@context`)) {
        ObservationListResponseObject[['@context']] <-
          self$`@context`
      }
      if (!is.null(self$`metadata`)) {
        ObservationListResponseObject[['metadata']] <-
          self$`metadata`$toJSON()
      }
      if (!is.null(self$`result`)) {
        ObservationListResponseObject[['result']] <-
          self$`result`$toJSON()
      }

      ObservationListResponseObject
    },
    fromJSON = function(ObservationListResponseJson) {
      ObservationListResponseObject <- jsonlite::fromJSON(ObservationListResponseJson)
      if (!is.null(ObservationListResponseObject$`@context`)) {
        self$`@context` <- ApiClient$new()$deserializeObj(ObservationListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      }
      if (!is.null(ObservationListResponseObject$`metadata`)) {
        metadataObject <- Metadata$new()
        metadataObject$fromJSON(jsonlite::toJSON(ObservationListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
        self$`metadata` <- metadataObject
      }
      if (!is.null(ObservationListResponseObject$`result`)) {
        resultObject <- ObservationListResponseResult$new()
        resultObject$fromJSON(jsonlite::toJSON(ObservationListResponseObject$result, auto_unbox = TRUE, digits = NA))
    ...
    fromJSONString = function(ObservationListResponseJson) {
      ObservationListResponseObject <- jsonlite::fromJSON(ObservationListResponseJson)
      self$`@context` <- ApiClient$new()$deserializeObj(ObservationListResponseObject$`@context`, "array[character]", loadNamespace("openapi"))
      self$`metadata` <- Metadata$new()$fromJSON(jsonlite::toJSON(ObservationListResponseObject$metadata, auto_unbox = TRUE, digits = NA))
      self$`result` <- ObservationListResponseResult$new()$fromJSON(jsonlite::toJSON(ObservationListResponseObject$result, auto_unbox = TRUE, digits = NA))
      self
    }
  )
)
