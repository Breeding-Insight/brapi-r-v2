...
#' @docType class
#' @title SeasonListResponseResult
#'
#' @description SeasonListResponseResult Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field data  list( \link{Season} ) 
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SeasonListResponseResult <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SeasonListResponseResultObject <- list()
      if (!is.null(self$`data`)) {
        SeasonListResponseResultObject[['data']] <-
          lapply(self$`data`, function(x) x$toJSON())
      }

      SeasonListResponseResultObject
    },
    fromJSON = function(SeasonListResponseResultJson) {
      SeasonListResponseResultObject <- jsonlite::fromJSON(SeasonListResponseResultJson)
      if (!is.null(SeasonListResponseResultObject$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(SeasonListResponseResultObject$`data`, "array[Season]", loadNamespace("openapi"))
      }
      self
    },
...
',
    ...
    fromJSONString = function(SeasonListResponseResultJson) {
      SeasonListResponseResultObject <- jsonlite::fromJSON(SeasonListResponseResultJson)
      self$`data` <- ApiClient$new()$deserializeObj(SeasonListResponseResultObject$`data`, "array[Season]", loadNamespace("openapi"))
      self
    }
